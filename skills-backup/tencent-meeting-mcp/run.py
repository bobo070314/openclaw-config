#!/usr/bin/env python3
"""
tencent-meeting-mcp v0.2.0 — 腾讯会议MCP协议集成 - 通过MCP协议调用腾讯会议API，管理会议、录制和参会者
...
def main():
    parser = argparse.ArgumentParser(description="腾讯会议MCP协议集成 - 通过MCP协议调用腾讯会议API，管理会议、录制和参会者")
