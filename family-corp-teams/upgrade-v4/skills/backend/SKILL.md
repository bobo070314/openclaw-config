...
# Backend Skill
# backend Department Skill

## Description
Python/Node.js/Go 后端Skills

## Metadata
- version: 1.0
- author: IGP backend team
- category: department
- tags: [backend, department, skill]
- department: backend
