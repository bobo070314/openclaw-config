...
from v5_code_repair_upgrade import IncrementalScanner
...
if __name__ == "__main__":
    ...
    try: test_scan_changes(); _ok += 1; _r.append(f"  PASS: scan_changes")
    except Exception as _e: _r.append(f"  FAIL: scan_changes: {_e}")
