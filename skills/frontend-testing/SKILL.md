...
## Overview
前端测试策略 - Vitest/Jest 单元测试、组件测试和集成测试最佳实践

## Category
testing

## When to Use
Trigger when user needs help with frontend testing tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about frontend testing
