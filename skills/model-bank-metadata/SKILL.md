...
## Overview
模型库元数据管理 - AI模型元数据注册、版本跟踪、性能基准和配置管理

## Category
devsecops

## When to Use
Trigger when user needs help with model bank metadata tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about model bank metadata
