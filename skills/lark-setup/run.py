#!/usr/bin/env python3
"""
lark-setup v0.2.0 — 飞书(Lark)应用配置 - 创建飞书应用、配置权限、获取凭证、Webhook 设置
...
VERSION = "0.2.0"
SKILL_NAME = "lark-setup"

# No custom functions — pure skeleton skill (declarative knowledge in SKILL.md)


def main():
    parser = argparse.ArgumentParser(description="飞书(Lark)应用配置 - 创建飞书应用、配置权限、获取凭证、Webhook 设置")
