#!/usr/bin/env python3
"""
review-checklist v0.2.0 — 代码审查清单 - PR Review 的系统化检查项，覆盖安全/性能/可维护性
...
VERSION = "0.2.0"
SKILL_NAME = "review-checklist"

# No custom functions — pure skeleton skill (declarative knowledge in SKILL.md)


def main():
    parser = argparse.ArgumentParser(description="代码审查清单 - PR Review 的系统化检查项，覆盖安全/性能/可维护性")
