...
## Overview
前端数据获取架构 - SWR/React Query模式、缓存策略、乐观更新和错误处理

## Category
frontend

## When to Use
Trigger when user needs help with data fetching architecture tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about data fetching architecture
