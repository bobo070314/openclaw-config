#!/usr/bin/env python3
"""
how-to-write-component v0.2.0 — 组件编写指南 - React 组件设计模式、Props类型、状态管理和可复用性
...
VERSION = "0.2.0"
SKILL_NAME = "how-to-write-component"

# No custom functions — pure skeleton skill (declarative knowledge in SKILL.md)


def main():
    parser = argparse.ArgumentParser(description="组件编写指南 - React 组件设计模式、Props类型、状态管理和可复用性")
