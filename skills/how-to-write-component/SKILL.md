...
## Overview
组件编写指南 - React 组件设计模式、Props类型、状态管理和可复用性

## Category
frontend

## When to Use
Trigger when user needs help with how to write component tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about how to write component
