...
## Overview
类人代码审查 - AI模拟人类审查风格，关注逻辑、可读性和架构而非格式

## Category
devsecops

## When to Use
Trigger when user needs help with human like code review tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about human like code review
