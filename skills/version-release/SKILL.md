...
## Overview
版本发布流程 - Semantic Versioning、Release Notes生成、Git Tag和CI/CD发布

## Category
devsecops

## When to Use
Trigger when user needs help with version release tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about version release
