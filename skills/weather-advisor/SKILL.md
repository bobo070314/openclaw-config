...
## Overview
天气咨询助手 - 查询实时天气/预报、穿衣建议、出行提醒和极端天气预警

## Category
productivity

## When to Use
Trigger when user needs help with weather advisor tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about weather advisor
