...
## Overview
AI Provider 接入文档生成 - 为新的AI模型供应商生成标准化的接入配置文档

## Category
devsecops

## When to Use
Trigger when user needs help with add provider doc tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about add provider doc
