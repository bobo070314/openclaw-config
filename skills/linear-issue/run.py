#!/usr/bin/env python3
"""
linear-issue v0.2.0 — Linear Issue 操作 - 创建/更新/搜索 Issue，关联PR和状态流转
...
VERSION = "0.2.0"
SKILL_NAME = "linear-issue"

# No custom functions — pure skeleton skill (declarative knowledge in SKILL.md)


def main():
    parser = argparse.ArgumentParser(description="Linear Issue 操作 - 创建/更新/搜索 Issue，关联PR和状态流转")
