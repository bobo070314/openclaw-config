...
## Overview
Linear Issue 操作 - 创建/更新/搜索 Issue，关联PR和状态流转

## Category
productivity

## When to Use
Trigger when user needs help with linear issue tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about linear issue
