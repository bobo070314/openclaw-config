...
## Overview
IMAP/SMTP 邮件收发 - 邮件读取/发送/搜索、附件处理和文件夹管理

## Category
productivity

## When to Use
Trigger when user needs help with imap smtp email tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about imap smtp email
