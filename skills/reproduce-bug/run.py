#!/usr/bin/env python3
"""
reproduce-bug v0.2.0 — Bug 复现流程 - 系统化Bug报告分析、环境复现、最小复现用例和根因定位
...
VERSION = "0.2.0"
SKILL_NAME = "reproduce-bug"

# No custom functions — pure skeleton skill (declarative knowledge in SKILL.md)


def main():
    parser = argparse.ArgumentParser(description="Bug 复现流程 - 系统化Bug报告分析、环境复现、最小复现用例和根因定位")
