#!/usr/bin/env python3
"""
conventions v0.2.0 — 代码规范约定 - 项目级命名约定、目录结构、Git提交规范和代码风格指南
...
VERSION = "0.2.0"
SKILL_NAME = "conventions"

# No custom functions — pure skeleton skill (declarative knowledge in SKILL.md)


def main():
    parser = argparse.ArgumentParser(description="代码规范约定 - 项目级命名约定、目录结构、Git提交规范和代码风格指南")
