#!/usr/bin/env python3
"""
debug-package v0.2.0 — Node.js 包调试工具 - 快速定位 node_modules 问题，符号链接修复、版本冲突检测
...
VERSION = "0.2.0"
SKILL_NAME = "debug-package"

# No custom functions — pure skeleton skill (declarative knowledge in SKILL.md)


def main():
    parser = argparse.ArgumentParser(description="Node.js 包调试工具 - 快速定位 node_modules 问题，符号链接修复、版本冲突检测")
