...
## Overview
异构Agent协作 - 多Agent系统编排、任务分配、消息路由和结果聚合

## Category
devsecops

## When to Use
Trigger when user needs help with heterogeneous agent tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about heterogeneous agent
