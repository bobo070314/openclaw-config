...
## Overview
tRPC 路由设计 - tRPC Router/Procedure 模式、中间件链和类型安全API

## Category
devsecops

## When to Use
Trigger when user needs help with trpc router tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about trpc router
