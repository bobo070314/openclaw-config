...
## Overview
Agent 执行链路追踪 - 记录Agent调用链、耗时分析、错误定位和性能优化

## Category
devsecops

## When to Use
Trigger when user needs help with agent tracing tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about agent tracing
