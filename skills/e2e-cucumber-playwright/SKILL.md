...
## Overview
E2E BDD 测试 - Cucumber + Playwright 端到端测试，Gherkin语法和CI集成

## Category
testing

## When to Use
Trigger when user needs help with e2e cucumber playwright tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about e2e cucumber playwright
...
## Related Skills
- Browse other skills under `testing` category
