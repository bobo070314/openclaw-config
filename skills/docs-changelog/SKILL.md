...
## Overview
更新日志自动生成 - 基于Git提交记录生成CHANGELOG.md，遵循Keep a Changelog规范

## Category
devsecops

## When to Use
Trigger when user needs help with docs changelog tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about docs changelog
