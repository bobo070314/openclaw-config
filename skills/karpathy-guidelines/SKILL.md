...
## Overview
Karpathy 编程哲学 - 遵循Andrej Karpathy的软件工程原则和最佳实践

## Category
devsecops

## When to Use
Trigger when user needs help with karpathy guidelines tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about karpathy guidelines
