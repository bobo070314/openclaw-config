#!/usr/bin/env python3
"""
cli v0.2.0 — OpenClaw CLI 工具接口 - 包装 openclaw 命令行，支持 session 管理、配置查询和技能调用
...
def main():
    parser = argparse.ArgumentParser(description="OpenClaw CLI 工具接口 - 包装 openclaw 命令行，支持 session 管理、配置查询和技能调用")
