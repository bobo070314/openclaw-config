...
## Overview
Node.js OAuth 集成 - OAuth2.0 客户端实现、Token管理和多Provider支持

## Category
devsecops

## When to Use
Trigger when user needs help with node add oauth tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about node add oauth
