#!/usr/bin/env python3
"""
create-skill v0.2.0 — 技能工厂，Context Snapshot自举，一键生成SKILL.md+_meta.json+run.sh+run.bat
...
def main():
    parser = argparse.ArgumentParser(description="技能工厂，Context Snapshot自举，一键生成SKILL.md+_meta.json+run.sh+run.bat")
