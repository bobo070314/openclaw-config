...
## Overview
状态管理数据结构 - Zustand/Redux Store设计、数据规范化和持久化策略

## Category
frontend

## When to Use
Trigger when user needs help with store data structures tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about store data structures
