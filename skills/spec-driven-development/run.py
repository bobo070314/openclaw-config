#!/usr/bin/env python3
"""
spec-driven-development v0.2.0 — 规格驱动开发 - 基于Spec文档的开发流程，OpenAPI/AsyncAPI规范和契约测试
...
def main():
    parser = argparse.ArgumentParser(description="规格驱动开发 - 基于Spec文档的开发流程，OpenAPI/AsyncAPI规范和契约测试")
