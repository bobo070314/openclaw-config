#!/usr/bin/env python3
"""
document-converter v0.2.0 — 文档格式转换 - PDF/Word/Markdown/HTML 互相转换，支持批量处理
...
def main():
    parser = argparse.ArgumentParser(description="文档格式转换 - PDF/Word/Markdown/HTML 互相转换，支持批量处理")
