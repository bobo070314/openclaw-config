...
## Overview
SPA 路由设计 - React Router/Next.js 路由架构、懒加载和权限路由

## Category
frontend

## When to Use
Trigger when user needs help with spa routes tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about spa routes
