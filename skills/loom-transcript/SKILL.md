...
## Overview
Loom 视频转录 - 提取Loom视频字幕/转录文本，生成摘要和时间戳标注

## Category
productivity

## When to Use
Trigger when user needs help with loom transcript tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about loom transcript
