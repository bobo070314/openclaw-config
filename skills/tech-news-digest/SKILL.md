...
## Overview
技术新闻摘要 - 聚合HackerNews/DevTo/GitHub Trending等，生成每日技术简报

## Category
productivity

## When to Use
Trigger when user needs help with tech news digest tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about tech news digest
...
## Related Skills
- Browse other skills under `productivity` category
