#!/usr/bin/env python3
"""
tech-news-digest v0.2.0 — 技术新闻摘要 - 聚合HackerNews/DevTo/GitHub Trending等，生成每日技术简报
...
VERSION = "0.2.0"
SKILL_NAME = "tech-news-digest"

# No custom functions — pure skeleton skill (declarative knowledge in SKILL.md)


def main():
    parser = argparse.ArgumentParser(description="技术新闻摘要 - 聚合HackerNews/DevTo/GitHub Trending等，生成每日技术简报")
