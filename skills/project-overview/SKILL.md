...
## Overview
项目概览生成 - 自动分析代码库生成项目架构图、技术栈和模块依赖

## Category
devsecops

## When to Use
Trigger when user needs help with project overview tasks or concepts.

## Workflow

### 1. Understand
- Parse what the user is asking about project overview
