...
import { a as getResolvedLoggerSettings } from "./logger-BfNItX-e.js";
...
import { t as danger } from "./globals-Cjirhr4c.js";
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-CwmOK6NP.js";
import { a as getBundledChannelSetupPlugin } from "./bundled-Ewhkq8Bo.js";
import { r as replaceConfigFile } from "./config-CxwD7EO_.js";
import { c as formatUnknownChannelMessage, l as formatUnsupportedChannelActionMessage } from "./error-format-DbPRORpk.js";
...
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-CK5ins3w2.js";
import "./plugins-Ys7IxLOo.js";
import "./message-channel-CtiNqfW0.js";
import "./logging-DotGwuOD.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-Cligc0CD.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-B7WkObDZ.js";
import { r as resolveMessageChannelSelection } from "./channel-selection-CPoRizHU.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-ou1qRqD0.js";
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-CzTgqOVc.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-Bbs3f-tM.js";
import { n as resolveLogFile } from "./log-tail-5Q275syc.js";
...
import { t as applyAgentBindings } from "./agents.bindings-B7JZR_Ic.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-CyD8lj4X.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-CAH-S1DN.js";
import { t as channelsListCommand } from "./list-BqABdQG4.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-CsFB2bjt.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-Zuyay3LG.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-YofKmZKO.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-CDBpuCvB.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-BqcOc4x1.js").then(({ listRawChannelPluginCatalogEntries }) => listRawChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-Bma7vHEV.js"), loadOnboardChannels()]);
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-OMwkDywY.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-BMM0KOGa.js");
