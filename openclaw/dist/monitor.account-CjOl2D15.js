...
import { u as normalizeAgentId$1 } from "./session-key-BsbwBJwv.js";
...
import { s as formatChannelProgressDraftLineForEntry, u as isChannelProgressDraftWorkToolName } from "./streaming-Dgx_j8xT.js";
...
import { E as toInboundMediaFacts, y as buildChannelInboundEventContext } from "./kernel-BROH42tr.js";
import "./history-Digw4nIX.js";
import { t as createReplyPrefixContext } from "./reply-prefix-DCiv8POf.js";
...
import { i as installRequestBodyLimitGuard } from "./http-body-Z3mhnRNk.js";
import "./ssrf-runtime-CV6TBXbQ.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute, t as ensureConfiguredBindingRouteReady } from "./binding-routing-DlasBIGx.js";
...
import { c as readWebhookBodyOrReject, r as applyBasicWebhookRequestGuards } from "./webhook-request-guards-Dm3cs_53.js";
import "./webhook-ingress-Btd-EgwJ.js";
import { _ as requestFeishuApi, d as extractReplyText, g as readString, h as parseCommentContentElements, l as resolveFeishuRuntimeAccount, m as normalizeString, p as isRecord$1, s as resolveFeishuAccount, u as encodeQuery, v as buildFeishuCommentTarget, y as normalizeCommentFileType } from "./accounts-Dh85-Sao.js";
import { i as resolveReceiveIdType } from "./targets-D8WHkfH3.js";
import { c as decodeFeishuCardAction, o as buildFeishuCardActionTextFallback, s as createFeishuCardInteractionEnvelope } from "./send-result-BYO9Dg0R.js";
import { t as buildFeishuConversationId } from "./conversation-id-CR2hVtVF.js";
import { a as resolveFeishuGroupConversationIngressAccess, c as resolveFeishuReplyPolicy, i as resolveFeishuGroupConfig, n as normalizeFeishuAllowEntry, o as resolveFeishuGroupSenderActivationIngressAccess, r as resolveFeishuDmIngressAccess, t as hasExplicitFeishuGroupConfig } from "./policy-C5lvEFI7.js";
import { t as getFeishuRuntime } from "./runtime-BP4XWQ9i.js";
import { a as getFeishuUserAgent, i as createFeishuWSClient, n as createEventDispatcher, r as createFeishuClient } from "./client-M0Rewgvz.js";
import { c as getChatInfo, i as createCommentTypingReactionLifecycle, t as deliverCommentThreadText } from "./drive-K-XN-Z0j.js";
import { t as createFeishuThreadBindingManager } from "./thread-bindings-BH6wpcAc.js";
import "./runtime-api-CrmB5t8j.js";
import { _ as normalizeFeishuExternalKey, a as sendCardFeishu, c as sendStructuredCardFeishu, d as isFeishuBroadcastMention, f as isMentionForwardRequest, g as shouldSuppressFeishuTextForVoiceMedia, h as sendMediaFeishu, i as resolveFeishuCardTemplate, l as parsePostContent, m as saveMessageResourceFeishu, n as getMessageFeishu, p as isFeishuGroupChatType, r as listFeishuThreadMessages, s as sendMessageFeishu, u as extractMentionTargets } from "./send-owe5moMW.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-aDMyKQWu.js";
import { a as clearFeishuBotIdentityState, c as httpServers, d as wsClients, f as fetchBotIdentityForMonitor, i as botOpenIds, l as recordWebhookStatus, n as FEISHU_WEBHOOK_MAX_BODY_BYTES, o as closeTrackedFeishuHttpServer, r as botNames, s as feishuWebhookRateLimiter, t as FEISHU_WEBHOOK_BODY_TIMEOUT_MS, u as setFeishuBotIdentityState } from "./monitor.state-DZKzun7t.js";
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-C6waGgF1.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-C6waGgF1.js");
