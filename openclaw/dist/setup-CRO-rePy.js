...
const agentWorkspaceModuleLoader = createLazyImportLoader(() => import("./workspace-DZCB2HR4.js"));
const configIOModuleLoader = createLazyImportLoader(() => import("./config/config.js"));
const configLoggingModuleLoader = createLazyImportLoader(() => import("./logging-DGlH-53u.js"));
...
async function resolveDefaultSessionTranscriptsDir() {
	const { resolveSessionTranscriptsDir } = await import("./sessions-CTK-5nEK.js");
