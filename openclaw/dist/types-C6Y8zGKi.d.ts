import { i as OpenClawConfig, pt as TalkProviderConfig, sn as CliBackendConfig, t as ConfigFileSnapshot, xn as SilentReplyConversationType } from "./types.openclaw-BhmF31_h.js";
...
import { G as TtsConfig, K as TtsMode, U as ResolvedTtsPersona, W as TtsAutoMode, Z as TtsProvider } from "./types.slack-DZ_yZ9_T.js";
...
import { d as PluginKind, f as UnifiedModelCatalogEntry, g as PluginConfigUiHint, p as UnifiedModelCatalogKind, t as PluginManifestRecord } from "./manifest-registry-CGMXWseL.js";
import { t as JsonSchemaObject } from "./json-schema.types-z_ZXZBRr.js";
import { t as PluginMetadataRegistryView } from "./plugin-metadata-snapshot.types-Cs3GQbx7.js";
import { t as ConfigWriteAfterWrite } from "./runtime-snapshot-D97dcZO_.js";
import { C as ConfigReplaceResult, g as ConfigMutationBase } from "./config-CJlUoTqd.js";
import { y as resolveStateDir } from "./paths-P5i_LQjg.js";
...
import { i as MsgContext, n as InboundSourceModality, o as CommandTurnContext, p as InboundEventKind, r as MentionSource, s as CommandTurnKind, t as FinalizedMsgContext } from "./templating-C0ehoyWm.js";
import { c as OAuthCredential, i as AuthProfileCredential, s as AuthProfileStore, t as ApiKeyCredential } from "./types-Cjzcf7VM.js";
...
import { P as MessageReceipt } from "./types-DVN-wM7I.js";
...
import { _ as chunkTextWithMode, g as chunkText, h as chunkMarkdownTextWithMode, m as chunkMarkdownText, n as ChannelOutboundAdapter, p as chunkByNewline, v as resolveChunkMode, y as resolveTextChunkLimit } from "./outbound.types-BbYrqFJk.js";
import { t as OperatorScope } from "./operator-scopes-Phea7r7e.js";
import { t as ChannelPlugin$1 } from "./types.plugin-CTcdBrrg.js";
...
import { a as SessionContextBudgetStatus, c as SessionSystemPromptReport, n as GroupKeyResolution, o as SessionEntry, s as SessionScope$1, t as CliSessionBinding } from "./types-CznwT7G6.js";
import { i as updateSessionStore, l as ResolvedSessionMaintenanceConfig, s as loadSessionStore } from "./store-DXpTmQP2.js";
import { d as ElevatedLevel, f as ReasoningLevel, g as VerboseLevel, h as TraceLevel, m as ThinkingCatalogEntry, p as ThinkLevel, s as CommandNormalizeOptions, u as ShouldHandleTextCommandsParams } from "./commands-registry.types-CrHvzjUV.js";
import { Dt as PluginHookToolKind, Et as PluginHookToolInputKind, Gt as PluginNextTurnInjectionEnqueueResult, J as PluginHookHandlerMap, N as PluginHookBeforeToolCallEvent, Tt as PluginHookToolContext, Wt as PluginNextTurnInjection, _n as ReplyDispatchKind, an as PluginHookBeforeToolCallResult, bn as ReplyFollowupAdmissionBarrierTimeoutPolicy, gn as ReplyDispatchBeforeDeliver, ln as PluginHookBeforeAgentStartResult, qt as PluginJsonValue, rn as PluginApprovalResolution, tt as PluginHookName, vn as ReplyDispatchRuntimeInfo, yn as ReplyDispatcher } from "./hook-types-B1sEtxPP.js";
...
import { Ai as AuthStorage, Ci as ModelRegistry$1 } from "./index-Bp761AFF.js";
import { s as LogLevel } from "./subsystem-CfQVin8T.js";
import { C as ResolvedProviderAuth } from "./model-auth-BQESTSNw.js";
import { o as resolveStorePath, r as resolveSessionFilePath } from "./session-key-DBehYhCk.js";
import { a as onSessionTranscriptUpdate } from "./session-accessor-BWQ-aMBo.js";
...
import { N as resolveAgentDir, P as resolveAgentWorkspaceDir } from "./agent-scope-tngK3W8P.js";
import { a as createAckReactionHandle, c as shouldAckReaction, d as resolveAgentIdentity, f as resolveEffectiveMessagesConfig, o as removeAckReactionAfterReply, p as resolveHumanDelayConfig, s as removeAckReactionHandleAfterReply } from "./ack-reactions-DO89muZf.js";
...
import { _ as ImageGenerationSourceImage, c as ImageGenerationOutputFormat, f as ImageGenerationProviderOptions, h as ImageGenerationResolution, i as ImageGenerationNormalization, l as ImageGenerationProvider, n as ImageGenerationBackground, p as ImageGenerationQuality, r as ImageGenerationIgnoredOverride, t as GeneratedImageAsset } from "./types-BudWc37X.js";
import { d as VideoGenerationResolution, n as VideoGenerationIgnoredOverride, o as VideoGenerationNormalization, p as VideoGenerationSourceAsset, s as VideoGenerationProvider, t as GeneratedVideoAsset } from "./types-C1lgmnxf.js";
import { c as MusicGenerationProvider, f as MusicGenerationSourceImage, o as MusicGenerationNormalization, r as MusicGenerationIgnoredOverride, s as MusicGenerationOutputFormat, t as GeneratedMusicAsset } from "./types-DYLqX5_2.js";
import { n as RuntimeWebSearchMetadata, t as RuntimeWebFetchMetadata } from "./runtime-web-tools.types-BgJBzqWL.js";
import { n as GatewayRequestHandler, x as SecretInputMode } from "./types-DtMuoX76.js";
...
import { a as MediaUnderstandingRuntime } from "./runtime-types-C8o6YQxO.js";
import { r as EmbeddingProviderAdapter } from "./embedding-providers-p4CDqhzG.js";
import { f as MemoryPluginRuntime, o as MemoryFlushPlanResolver, p as MemoryPromptSectionBuilder, r as MemoryCorpusSupplement, s as MemoryPluginCapability } from "./memory-state-DblHNwL5.js";
import { i as MemoryEmbeddingProviderAdapter } from "./memory-embedding-providers-CHSoM01A.js";
import { Zt as TalkTransport, a as DiagnosticEventPayload, i as DiagnosticEventMetadata, o as DiagnosticEventPrivateData, r as DiagnosticEventInput } from "./diagnostic-events-CZW3N020.js";
import { o as TranscriptSourceProvider$1 } from "./provider-types-DV81mVnY.js";
...
import { a as ResponsePrefixContext, s as TypingCallbacks } from "./reply-prefix-StLAg320.js";
import { n as ReadChannelAllowFromStoreForAccount$1, r as UpsertChannelPairingRequestForAccount$1 } from "./pairing-store.types-D_vZ2p2g.js";
import { a as MatchesMentionWithExplicit$1, i as MatchesMentionPatterns$1, t as BuildMentionRegexes$1 } from "./mentions.types-Dq3ibg1D.js";
import { n as RecordInboundSession$1, t as InboundLastRouteUpdate } from "./session.types-CJv8Z18t.js";
import { c as SessionBindingRecord } from "./session-binding.types-BbT2v6Ty.js";
import { t as hasControlCommand } from "./command-detection-CL82OO2g.js";
import { t as ResolveMarkdownTableMode } from "./markdown-tables.types-BkD2Oh58.js";
import { t as convertMarkdownTables } from "./tables-BBMGs0qO.js";
import { i as buildAgentSessionKey, o as resolveAgentRoute } from "./resolve-route-F-MMa3FL.js";
import { t as buildPairingReply } from "./pairing-messages-B8y1Svz7.js";
...
import { n as resolveChannelGroupPolicy, r as resolveChannelGroupRequireMention } from "./group-policy-DmOYumUq.js";
import { n as createInboundDebouncer, r as resolveInboundDebounceMs } from "./inbound-debounce-ZSgONWf_.js";
import { r as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-pUtyEXB1.js";
import { a as OutboundDeliveryQueuePolicy, n as DurableFinalDeliveryRequirement, r as DurableFinalDeliveryRequirements, t as DeliverOutboundPayloadsParams } from "./deliver-BqRlmiaw.js";
import { i as createChannelReplyPipeline, n as CreateChannelReplyPipelineParams } from "./reply-pipeline-NhagcxSt.js";
...
//#endregion
export { OpenClawPluginService as $, getBeforeToolCallPolicyDiagnosticState as $a, ProviderResolveSyntheticAuthContext as $c, OpenClawAgentToolResult as $i, PluginRuntime as $n, DetachedTaskLifecycleRuntime as $o, CommandSessionMetadataChange as $r, WebFetchProviderToolDefinition as $s, ProviderModelSelectedContext as $t, OpenClawPluginDefinition as A, AgentHarnessCompactParams as Aa, ClientToolDefinition as Ac, CodexAppServerToolResultEvent as Ai, ProviderResolvePromptOverlayContext as An, ContextEngineRuntimeSettingsUnavailableError as Ao, ConversationFacts as Ar, SpeechVoiceOption as As, ProviderAuthOptionBag as At, OpenClawPluginModule as B, EmbeddedRunAttemptParams as Ba, resolveSimpleCompletionSelectionForAgent as Bc, CliBackendResolveExecutionArgsContext as Bi, ProviderTransportTurnState as Bn, LlmCompleteCaller as Bo, formatInboundEnvelope as Br, ChannelIngressQueueClaim as Bs, ProviderCatalogResult as Bt, OpenClawPluginApi as C, RealtimeTranscriptionProviderResolveConfigContext as Ca, formatFastModeCurrentStatus as Cc, PluginSessionTurnUnscheduleByTagParams as Ci, ProviderReplaySanitizeMode as Cn, ContextEngineOperation as Co, AccessFacts as Cr, SpeechProviderResolveTalkConfigContext as Cs, PluginTranscriptsSourceProviderEntry as Ct, OpenClawPluginCliRegistrar as D, AgentHarness as Da, BlockReplyChunking as Dc, CodexAppServerExtensionContext as Di, ProviderResolveAuthProfileIdContext as Dn, ContextEngineRuntimeMode as Do, ChannelTurnRecordOptions as Dr, SpeechSynthesisStreamResult as Ds, ProviderAuthKind as Dt, OpenClawPluginCliContext as E, RealtimeTranscriptionSessionCreateRequest as Ea, resolveFastModeForElapsed as Ec, PluginTrustedToolPolicyRegistration as Ei, ProviderReplayToolCallIdMode as En, ContextEngineRuntimeContext as Eo, ChannelTurnDroppedHistoryOptions as Er, SpeechSynthesisStreamRequest as Es, ProviderAuthDoctorHintContext as Et, OpenClawPluginHttpRouteHandler as F, AgentHarnessSideQuestionParams as Fa, PreparedSimpleCompletionModelForAgent as Fc, CliBackendNormalizeConfigContext as Fi, ProviderRuntimeProviderConfig as Fn, SubagentEndReason as Fo, SupplementalContextFacts as Fr, OpenClawPluginHookOptions as Fs, ProviderBuiltInModelSuppressionResult as Ft, OpenClawPluginNodeInvokePolicyApprovalRuntime as G, isReplaySafeToolCall as Ga, ProviderThinkingProfile as Gc, PluginTextTransforms as Gi, RealtimeTranscriptionProviderPlugin as Gn, PluginRuntimeCore as Go, DispatchReplyWithBufferedBlockDispatcher$1 as Gr, ChannelIngressQueuePruneOptions as Gs, ProviderDiscoveryOrder as Gt, OpenClawPluginNodeHostCommand as H, PreemptiveCompactionRoute as Ha, provider_runtime_d_exports as Hc, CliBackendThinkingLevel as Hi, ProviderValidateReplayTurnsContext as Hn, LlmCompleteParams as Ho, resolveEnvelopeFormatOptions as Hr, ChannelIngressQueueCompletedRecord as Hs, ProviderCreateStreamFnContext as Ht, OpenClawPluginHttpRouteMatch as I, AgentHarnessSideQuestionResult as Ia, SimpleCompletionModelOptions as Ic, CliBackendPlugin as Ii, ProviderSanitizeReplayHistoryContext as In, SubagentSpawnPreparation as Io, ChannelBotLoopProtectionFacts as Ir, OpenClawPluginToolContext as Is, ProviderCacheTtlEligibilityContext as It, OpenClawPluginNodeInvokeTransportResult as J, BeforeToolCallPolicyDiagnosticState as Ja, ProviderSystemPromptContribution as Jc, AgentToolResultMiddlewareEvent as Ji, TranscriptSourceProvider as Jn, BoundTaskRunsRuntime as Jo, ReplyDispatcherWithTypingOptions as Jr, PluginWebSearchProviderEntry as Js, ProviderExtraParamsForTransportResult as Jt, OpenClawPluginNodeInvokePolicyContext as K, AgentRuntimePlan as Ka, ProviderRuntimeModel as Kc, AgentToolResultMiddleware as Ki, RealtimeVoiceProviderPlugin as Kn, RuntimeLogger as Ko, DispatchReplyWithDispatcher as Kr, ChannelIngressQueueRecord as Ks, ProviderDiscoveryResult as Kt, OpenClawPluginHttpRouteParams as L, AgentHarnessSupport as La, completeWithPreparedSimpleCompletionModel as Lc, CliBackendPrepareExecutionContext as Li, ProviderSystemPromptContributionContext as Ln, TranscriptRewriteReplacement as Lo, recordChannelBotPairLoopAndCheckSuppression as Lr, OpenClawPluginToolFactory as Ls, ProviderCapabilities as Lt, OpenClawPluginGatewayRuntimeScopeSurface as M, AgentHarnessDeliveryDefaults as Ma, ExecToolDefaults as Mc, CliBackendAuthEpochMode as Mi, ProviderResolveUsageAuthContext as Mn, ContextEngineSelectionSource as Mo, InboundMediaFacts as Mr, TtsDirectiveParseResult as Ms, ProviderBuildMissingAuthMessageContext as Mt, OpenClawPluginHostedMediaResolver as N, AgentHarnessResetParams as Na, AgentSimpleCompletionSelection as Nc, CliBackendExecutionMode as Ni, ProviderResolveWebSocketSessionPolicyContext as Nn, IngestBatchResult as No, PreparedChannelTurn as Nr, ResolvedProviderRuntimeAuth as Ns, ProviderBuildUnknownModelHintContext as Nt, OpenClawPluginCommandDefinition as O, AgentHarnessAttemptParams as Oa, EmbeddedBlockChunker as Oc, CodexAppServerExtensionFactory as Oi, ProviderResolveDynamicModelContext as On, ContextEngineRuntimeReasonCode as Oo, ChannelTurnResult as Or, SpeechSynthesisTarget as Os, ProviderAuthMethod as Ot, OpenClawPluginHttpRouteAuth as P, AgentHarnessResultClassification as Pa, PreparedSimpleCompletionModel as Pc, CliBackendNativeToolMode as Pi, ProviderResolvedUsageAuth as Pn, IngestResult as Po, RunChannelTurnParams as Pr, OpenClawPluginActiveModelContext as Ps, ProviderBuiltInModelSuppressionContext as Pt, OpenClawPluginSecurityAuditContext as Q, finalizeToolTerminalPresentation as Qa, ProviderResolveExternalOAuthProfilesContext as Qc, AgentToolResultMiddlewareRuntime as Qi, CreatePluginRuntimeOptions as Qn, DetachedTaskFinalizeParams as Qo, GetReplyFromConfig as Qr, WebFetchProviderPlugin as Qs, ProviderFollowupFallbackRouteResult as Qt, OpenClawPluginHttpRouteUpgradeHandler as R, AgentHarnessSupportContext as Ra, prepareSimpleCompletionModel as Rc, CliBackendPreparedExecution as Ri, ProviderToolSchemaDiagnostic as Rn, TranscriptRewriteRequest as Ro, EnvelopeFormatOptions as Rr, OpenClawPluginToolOptions as Rs, ProviderCatalogContext as Rt, OpenClawPluginAgentEventsApi as S, RealtimeTranscriptionProviderId as Sa, formatFastModeCommandOptions as Sc, PluginSessionTurnScheduleParams as Si, ProviderReplayPolicyContext as Sn, ContextEngineMaintenanceResult as So, resolveChannelInboundSupplementalContext as Sr, SpeechProviderResolveConfigContext as Ss, PluginTextTransformRegistration as St, OpenClawPluginCliCommandDescriptor as T, RealtimeTranscriptionSessionCallbacks as Ta, formatFastModeStatusValue as Tc, PluginToolMetadataRegistration as Ti, ProviderReplaySessionState as Tn, ContextEnginePromptCacheInfo as To, ChannelTurnAdmission as Tr, SpeechSynthesisRequest as Ts, ProviderAuthContext as Tt, OpenClawPluginNodeInvokeApprovalDecision as U, NormalizedUsage as Ua, ProviderDefaultThinkingPolicyContext as Uc, CliBundleMcpMode as Ui, ProviderWebSocketSessionPolicy as Un, LlmCompleteResult as Uo, finalizeInboundContext as Ur, ChannelIngressQueueEnqueueResult as Us, ProviderDeferSyntheticProfileAuthContext as Ut, OpenClawPluginNodeCliFeatureOptions as V, EmbeddedRunAttemptResult as Va, augmentModelCatalogWithProviderPlugins as Vc, CliBackendSideQuestionToolMode as Vi, ProviderUsageAuthToken as Vn, LlmCompleteMessage as Vo, formatInboundFromLabel as Vr, ChannelIngressQueueClaimRef as Vs, ProviderCreateEmbeddingProviderContext as Vt, OpenClawPluginNodeInvokePolicy as W, normalizeUsage as Wa, ProviderThinkingPolicyContext as Wc, PluginTextReplacement as Wi, ProviderWrapStreamFnContext as Wn, LlmCompleteUsage as Wo, settleReplyDispatcher as Wr, ChannelIngressQueueFailedRecord as Ws, ProviderDiscoveryContext as Wt, OpenClawPluginRunContextApi as X, HookContext as Xa, ProviderExternalOAuthProfile as Xc, AgentToolResultMiddlewareOptions as Xi, UnifiedModelCatalogProviderPlugin as Xn, PluginRuntimeTaskRuns as Xo, createReplyDispatcherWithTyping as Xr, WebFetchProviderContext as Xs, ProviderFetchUsageSnapshotContext as Xt, OpenClawPluginReloadRegistration as Y, DeferredPluginToolApproval as Ya, ProviderExternalAuthProfile as Yc, AgentToolResultMiddlewareHarness as Yi, UnifiedModelCatalogProviderContext as Yn, PluginRuntimeTaskFlows as Yo, createReplyDispatcher as Yr, WebFetchCredentialResolutionSource as Ys, ProviderFailoverErrorContext as Yt, OpenClawPluginSecurityAuditCollector as Z, ToolOutcomeObserver as Za, ProviderResolveExternalAuthProfilesContext as Zc, AgentToolResultMiddlewareResult as Zi, VideoGenerationProviderPlugin as Zn, PluginRuntimeTasks as Zo, DispatchFromConfigResult as Zr, WebFetchProviderId as Zs, ProviderFollowupFallbackRouteContext as Zt, MigrationSummary as _, RealtimeVoiceTool as _a, PromptMode as _c, PluginSessionAttachmentResult as _i, ProviderPrepareRuntimeAuthContext as _n, CompactResult as _o, FinalizeChannelInboundContextResult as _r, SpeechProviderConfiguredContext as _s, PluginRealtimeVoiceProviderEntry as _t, ImageGenerationProviderPlugin as a, RealtimeVoiceBridgeCallbacks as aa, WebSearchProviderSetupContext as ac, ProviderResolveConfigApiKeyContext as ai, MessagingToolSourceReplyPayload as al, ProviderNormalizeToolSchemasContext as an, wrapToolWithBeforeToolCallHook as ao, hasVisibleChannelTurnDispatch as ar, TaskRunView as as, PluginCommandContext as at, OpenClawGatewayDiscoveryService as b, RealtimeTranscriptionProviderConfig as ba, FastModeAutoProgressState as bc, PluginSessionSchedulerJobHandle as bi, ProviderReasoningOutputModeContext as bn, ContextEngineHostRequirements as bo, filterChannelInboundSupplementalContext as br, SpeechProviderPrepareSynthesisContext as bs, PluginSetupAutoEnableProbe as bt, MigrationDetection as c, RealtimeVoiceBrowserSession as ca, WebSearchRuntimeMetadataContext as cc, PluginAgentEventSubscriptionRegistration as ci, normalizeHeartbeatToolResponse as cl, ProviderPlugin as cn, AgentHarnessTaskRuntimeScope as co, DurableInboundReplyDeliveryParams as cr, TtsConfigResolutionContext as cs, PluginCommandResult as ct, MigrationItemKind as d, RealtimeVoiceProviderCapabilities as da, GenerateImageParams as dc, PluginRunContextPatch as di, ProviderPluginWizard as dn, ContextEngineFactoryContext as do, BuildChannelInboundEventContextAsyncParams as dr, normalizeTtsAutoMode as ds, PluginEmbeddingProvider as dt, REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ as ea, WebFetchRuntimeMetadataContext as ec, CommandContext as ei, ProviderSyntheticAuthResult as el, ProviderModernModelPolicyContext as en, hasBeforeToolCallPolicy as eo, SubagentRunParams as er, TaskFlowDetail as es, OpenClawPluginServiceContext as et, MigrationItemStatus as f, RealtimeVoiceProviderConfig as fa, GenerateImageRuntimeResult as fc, PluginRuntimeLifecycleRegistration as fi, ProviderPluginWizardModelPicker as fn, registerContextEngine as fo, BuildChannelInboundEventContextParams as fr, SpeechDirectiveTokenParseContext as fs, PluginInteractiveHandlerRegistration as ft, MigrationProviderPreparation as g, RealtimeVoiceRole as ga, RunEmbeddedAgentParams as gc, PluginSessionAttachmentParams as gi, ProviderPrepareExtraParamsContext as gn, BootstrapResult as go, FinalizeChannelInboundContextParams as gr, SpeechProviderConfig as gs, PluginRealtimeTranscriptionProviderEntry as gt, MigrationProviderPlugin as h, RealtimeVoiceProviderResolveConfigContext as ha, EmbeddedRunTrigger as hc, PluginSessionActionResult as hi, ProviderPrepareDynamicModelContext as hn, AssembleResult as ho, FinalizeChannelInboundContextAsyncParams as hr, SpeechModelOverridePolicy as hs, PluginLogger as ht, AgentPromptSurfaceKind as i, RealtimeVoiceBridge as ia, WebSearchProviderPlugin as ic, ProviderNormalizeConfigContext as ii, MessagingToolSend as il, ProviderNormalizeResolvedModelContext as in, setBeforeToolCallDiagnosticsEnabled as io, hasFinalChannelTurnDispatch as ir, TaskRunDetail as is, OpenClawPluginSessionWorkflowApi as it, OpenClawPluginGatewayMethod as j, AgentHarnessCompactResult as ja, ExecElevatedDefaults as jc, CodexAppServerToolResultHandlerResult as ji, ProviderResolveTransportTurnStateContext as jn, ContextEngineRuntimeSettingsUnsupportedError as jo, DispatchedChannelTurnResult as jr, TtsDirectiveOverrides as js, ProviderAuthResult as jt, OpenClawPluginConfigSchema as k, AgentHarnessAttemptResult as ka, AgentStreamParams as kc, CodexAppServerExtensionRuntime as ki, ProviderResolveNonInteractiveApiKeyParams as kn, ContextEngineRuntimeSettings as ko, CommandFacts as kr, SpeechTelephonySynthesisRequest as ks, ProviderAuthMethodNonInteractiveContext as kt, MigrationItem as l, RealtimeVoiceBrowserSessionCreateRequest as la, GenerateVideoParams as lc, PluginControlUiDescriptor as li, ProviderPluginCatalog as ln, resolveEmbeddedAgentRuntime as lo, DurableInboundReplyDeliveryResult as lr, resolveEffectiveTtsConfig as ls, PluginConfigMigration as lt, MigrationProviderContext as m, RealtimeVoiceProviderId as ma, CurrentInboundPromptContext as mc, PluginSessionActionRegistration as mi, ProviderPreferRuntimeResolvedModelContext as mn, resolveContextEngineOwnerPluginId as mo, ChannelInboundSupplementalResolutionOptions as mr, SpeechListVoicesRequest as ms, PluginInteractiveRegistration as mt, AgentPromptGuidance as n, RealtimeVoiceAudioFormat as na, WebSearchProviderContext as nc, ProcessToolDefaults as ni, EmbeddedAgentRunMeta as nl, ProviderNonInteractiveApiKeyResult as nn, requestDeferredPluginToolApproval as no, kernel_d_exports as nr, TaskRunAggregateSummary as ns, OpenClawPluginSessionControlsApi as nt, MediaUnderstandingProviderPlugin as o, RealtimeVoiceBridgeCreateRequest as oa, WebSearchProviderToolDefinition as oc, PluginAgentEventEmitParams as oi, HEARTBEAT_RESPONSE_TOOL_NAME as ol, ProviderNormalizeTransportContext as on, consumeAdjustedParamsForToolCall as oo, resolveChannelTurnDispatchCounts as or, ResolvedTtsConfig as os, PluginCommandDiagnosticsSession as ot, MigrationPlan as p, RealtimeVoiceProviderConfiguredContext as pa, resolveAgentTimeoutMs as pc, PluginSessionActionContext as pi, ProviderPluginWizardSetup as pn, resolveContextEngine as po, BuiltChannelInboundEventContext as pr, SpeechDirectiveTokenParseResult as ps, PluginInteractiveHandlerResult as pt, OpenClawPluginNodeInvokePolicyResult as q, BuildAgentRuntimePlanParams as qa, ProviderRuntimePluginHandle as qc, AgentToolResultMiddlewareContext as qi, SpeechProviderPlugin as qn, BoundTaskFlowsRuntime as qo, ReplyDispatcherOptions as qr, PluginWebFetchProviderEntry as qs, ProviderExtraParamsForTransportContext as qt, AgentPromptGuidanceEntry as r, RealtimeVoiceBargeInOptions as ra, WebSearchProviderId as rc, ProviderApplyConfigDefaultsContext as ri, EmbeddedAgentRunResult as rl, ProviderNormalizeModelIdContext as rn, runBeforeToolCallHook as ro, recordDroppedChannelInboundHistory as rr, TaskRunCancelResult as rs, OpenClawPluginSessionStateApi as rt, MigrationApplyResult as s, RealtimeVoiceBridgeEvent as sa, WebSearchProviderToolExecutionContext as sc, PluginAgentEventEmitResult as si, HeartbeatToolResponse as sl, ProviderOAuthProfileIdRepair as sn, consumePreExecutionBlockedToolCall as so, DurableInboundReplyDeliveryOptions as sr, ResolvedTtsModelOverrides as ss, PluginCommandHandler as st, AGENT_PROMPT_SURFACE_KINDS as t, REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ as ta, WebSearchCredentialResolutionSource as tc, CommandHandler as ti, EmbeddedAgentCompactResult as tl, ProviderNonInteractiveApiKeyCredentialParams as tn, isToolWrappedWithBeforeToolCallHook as to, SubagentRunResult as tr, TaskFlowView as ts, OpenClawPluginSessionApi as tt, MigrationItemAction as u, RealtimeVoiceCloseReason as ua, GenerateVideoRuntimeResult as uc, PluginRunContextGetParams as ui, ProviderPluginDiscovery as un, ContextEngineFactory as uo, deliverInboundReplyWithMessageSendContext as ur, TTS_AUTO_MODES as us, PluginConfigValidation as ut, MusicGenerationProviderPlugin as v, RealtimeVoiceToolCallEvent as va, AgentInternalEvent as vc, PluginSessionExtensionProjection as vi, ProviderPreparedRuntimeAuth as vn, ContextEngine as vo, buildChannelInboundEventContext as vr, SpeechProviderId as vs, PluginRegistrationMode as vt, OpenClawPluginChannelRegistration as w, RealtimeTranscriptionSession as wa, formatFastModeSourceSuffix as wc, PluginSessionTurnUnscheduleByTagResult as wi, ProviderReplaySessionEntry as wn, ContextEngineProjection as wo, AssembledChannelTurn as wr, SpeechProviderResolveTalkOverridesContext as ws, ProviderAugmentModelCatalogContext as wt, OpenClawPluginAgentApi as x, RealtimeTranscriptionProviderConfiguredContext as xa, formatFastModeAutoProgressText as xc, PluginSessionSchedulerJobRegistration as xi, ProviderReplayPolicy as xn, ContextEngineInfo as xo, finalizeChannelInboundContext as xr, SpeechProviderPreparedSynthesis as xs, PluginSpeechProviderEntry as xt, OpenClawGatewayDiscoveryAdvertiseContext as y, RealtimeVoiceToolResultOptions as ya, resolveFastModeState as yc, PluginSessionExtensionRegistration as yi, ProviderReasoningOutputMode as yn, ContextEngineHostCapability as yo, filterChannelInboundQuoteContext as yr, SpeechProviderOverrides as ys, PluginSetupAutoEnableContext as yt, OpenClawPluginLifecycleApi as z, CompactEmbeddedAgentSessionParams as za, prepareSimpleCompletionModelForAgent as zc, CliBackendResolveExecutionArgs as zi, ProviderTransformSystemPromptContext as zn, TranscriptRewriteResult as zo, formatAgentEnvelope as zr, ChannelIngressQueue as zs, ProviderCatalogOrder as zt };