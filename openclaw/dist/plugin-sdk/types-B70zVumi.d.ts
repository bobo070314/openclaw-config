...
import { a as CommandTurnContext, f as InboundEventKind, i as MsgContext, n as InboundSourceModality, o as CommandTurnKind, r as MentionSource, t as FinalizedMsgContext } from "./templating-Bx-yYzyQ.js";
import { In as SilentReplyConversationType, i as OpenClawConfig, pt as TalkProviderConfig, sn as CliBackendConfig, t as ConfigFileSnapshot } from "./types.openclaw-CXiJ86ZN.js";
...
import { G as TtsConfig, K as TtsMode, U as ResolvedTtsPersona, W as TtsAutoMode, Z as TtsProvider } from "./types.slack-ufl8lnSw.js";
...
import { a as AuthProfileFailureReason, c as OAuthCredential, i as AuthProfileCredential, o as AuthProfileIdRepairResult, r as AuthProfileBlockedSource, s as AuthProfileStore, t as ApiKeyCredential } from "./types-yaJ7N7xg.js";
import { f as MediaUnderstandingProvider } from "./types-BgiVYSXb.js";
...
import { d as UnifiedModelCatalogEntry, f as UnifiedModelCatalogKind, h as PluginConfigUiHint, u as PluginKind } from "./manifest-registry-DpBX4rfo.js";
import { t as JsonSchemaObject } from "./json-schema.types-z_ZXZBRr.js";
import { P as MessageReceipt } from "./types-CCjJtcMb.js";
import { _ as chunkTextWithMode, g as chunkText, h as chunkMarkdownTextWithMode, m as chunkMarkdownText, n as ChannelOutboundAdapter, p as chunkByNewline, v as resolveChunkMode, y as resolveTextChunkLimit } from "./outbound.types-D8j53lhL.js";
import { i as WizardPrompter } from "./prompts-DgKIGa-v.js";
import { t as OperatorScope } from "./operator-scopes-Phea7r7e.js";
import { t as ChannelPlugin$1 } from "./types.plugin-BLJArf-_.js";
import { n as PluginMetadataSnapshot, t as PluginMetadataRegistryView } from "./plugin-metadata-snapshot.types-_fTWKzGy.js";
import { t as ConfigWriteAfterWrite } from "./runtime-snapshot-Cp6HPqwS.js";
import { n as ConfigReplaceResult, t as ConfigMutationBase } from "./config-BjEFKyqy.js";
...
import { a as SessionEntry, i as SessionContextBudgetStatus, n as GroupKeyResolution, s as SessionSystemPromptReport, t as CliSessionBinding } from "./types-CUUb7tbP.js";
...
import { Ai as AuthStorage, Ci as ModelRegistry$1 } from "./index-DjU32k76.js";
import { s as LogLevel } from "./subsystem-n4Y4vCcQ.js";
import { t as OpenClawAgentDatabase } from "./openclaw-agent-db-B-F-AnOy.js";
import { t as ProviderAuthEvidence } from "./provider-env-vars-Ds4p-9h7.js";
import { i as resolveSessionFilePath, s as resolveStorePath } from "./sessions-C99VWO-T.js";
...
import { N as resolveAgentDir, P as resolveAgentWorkspaceDir } from "./agent-scope-DdEyuwEO.js";
import { a as createAckReactionHandle, c as shouldAckReaction, d as resolveAgentIdentity, f as resolveEffectiveMessagesConfig, o as removeAckReactionAfterReply, p as resolveHumanDelayConfig, s as removeAckReactionHandleAfterReply } from "./ack-reactions-f7Q6Q2-R.js";
...
import { _ as ImageGenerationSourceImage, c as ImageGenerationOutputFormat, f as ImageGenerationProviderOptions, h as ImageGenerationResolution, i as ImageGenerationNormalization, l as ImageGenerationProvider, n as ImageGenerationBackground, p as ImageGenerationQuality, r as ImageGenerationIgnoredOverride, t as GeneratedImageAsset } from "./types-DQfRKZ5p.js";
import { d as VideoGenerationResolution, n as VideoGenerationIgnoredOverride, o as VideoGenerationNormalization, p as VideoGenerationSourceAsset, s as VideoGenerationProvider, t as GeneratedVideoAsset } from "./types-PF_3icEY.js";
import { c as MusicGenerationProvider, f as MusicGenerationSourceImage, o as MusicGenerationNormalization, r as MusicGenerationIgnoredOverride, s as MusicGenerationOutputFormat, t as GeneratedMusicAsset } from "./types-CTx0T-F7.js";
import { n as RuntimeWebSearchMetadata, t as RuntimeWebFetchMetadata } from "./runtime-web-tools.types-BgJBzqWL.js";
import { C as SecretInputMode, n as GatewayRequestHandler, v as AgentEventPayload, x as onAgentEvent, y as AgentEventStream } from "./types-B2lbWzCt.js";
...
import { a as MediaUnderstandingRuntime } from "./runtime-types-CEMUecEU.js";
import { r as EmbeddingProviderAdapter } from "./embedding-providers-CnqofmYA.js";
import { d as MemoryPromptSectionBuilder, o as MemoryFlushPlanResolver, r as MemoryCorpusSupplement, s as MemoryPluginCapability, u as MemoryPluginRuntime } from "./memory-state-FIOhoe_D.js";
import { i as MemoryEmbeddingProviderAdapter } from "./memory-embedding-providers-B3znAj7i.js";
import { Zt as TalkTransport, a as DiagnosticEventPayload, i as DiagnosticEventMetadata, o as DiagnosticEventPrivateData, r as DiagnosticEventInput } from "./diagnostic-events-CV6zqTi6.js";
import { o as TranscriptSourceProvider$1 } from "./provider-types-D_gEXOgS.js";
...
import { a as ResponsePrefixContext, s as TypingCallbacks } from "./reply-prefix-YNDborrp.js";
import { n as ReadChannelAllowFromStoreForAccount$1, r as UpsertChannelPairingRequestForAccount$1 } from "./pairing-store.types-CSIWZfN9.js";
import { a as MatchesMentionWithExplicit$1, i as MatchesMentionPatterns$1, t as BuildMentionRegexes$1 } from "./mentions.types-DA1bBndp.js";
import { n as RecordInboundSession$1, t as InboundLastRouteUpdate } from "./session.types-o_o2gWOV.js";
import { t as hasControlCommand } from "./command-detection-GI56KNQA.js";
import { t as ResolveMarkdownTableMode } from "./markdown-tables.types-BA_GwnYc.js";
import { t as convertMarkdownTables } from "./tables-BBMGs0qO.js";
import { i as buildAgentSessionKey, o as resolveAgentRoute } from "./resolve-route-DzQxke2K.js";
import { t as buildPairingReply } from "./pairing-messages-CqNOuov_.js";
...
import { n as resolveChannelGroupPolicy, r as resolveChannelGroupRequireMention } from "./group-policy-cNjxjcPv.js";
import { n as createInboundDebouncer, r as resolveInboundDebounceMs } from "./inbound-debounce-CckR20yP.js";
import { r as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-pUtyEXB1.js";
import { a as OutboundDeliveryQueuePolicy, n as DurableFinalDeliveryRequirement, r as DurableFinalDeliveryRequirements, t as DeliverOutboundPayloadsParams } from "./deliver-BWhZNy0t.js";
import { i as createChannelReplyPipeline, n as CreateChannelReplyPipelineParams } from "./reply-pipeline-DVDMLOhm.js";
...
type EmbeddedRunAttemptBase = Omit<RunEmbeddedAgentParams, "provider" | "model" | "authProfileId" | "authProfileIdSource" | "thinkLevel" | "fastMode" | "lane" | "enqueue">;
...
//#endregion
export { OpenClawPluginService as $, requestDeferredPluginToolApproval as $a, resolveProviderEntryApiKeyProfileReference as $c, REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ as $i, resetProviderAuthAliasMapCacheForTest as $l, PluginRuntime as $n, TaskRunCancelResult as $o, CommandSessionMetadataChange as $r, WebSearchProviderContext as $s, ProviderModelSelectedContext as $t, OpenClawPluginDefinition as A, AgentHarnessDeliveryDefaults as Aa, PreparedSimpleCompletionModelForAgent as Ac, CliBackendAuthEpochMode as Ai, loadAuthProfileStoreWithoutExternalProfiles as Al, ProviderResolvePromptOverlayContext as An, IngestResult as Ao, ConversationFacts as Ar, OpenClawPluginActiveModelContext as As, ProviderAuthOptionBag as At, OpenClawPluginModule as B, PreemptiveCompactionRoute as Ba, applyAuthHeaderOverride as Bc, CliBackendThinkingLevel as Bi, upsertAuthProfile as Bl, ProviderTransportTurnState as Bn, LlmCompleteUsage as Bo, formatInboundEnvelope as Br, ChannelIngressQueueEnqueueResult as Bs, ProviderCatalogResult as Bt, OpenClawPluginApi as C, RealtimeTranscriptionSessionCallbacks as Ca, EmbeddedBlockChunker as Cc, PluginToolMetadataRegistration as Ci, ensureAuthProfileStore as Cl, ProviderReplaySanitizeMode as Cn, ContextEngineRuntimeMode as Co, AccessFacts as Cr, SpeechSynthesisStreamResult as Cs, PluginTranscriptsSourceProviderEntry as Ct, MessagingToolSend as Cu, OpenClawPluginCliRegistrar as D, AgentHarnessAttemptResult as Da, ExecToolDefaults as Dc, CodexAppServerExtensionRuntime as Di, loadAuthProfileStore as Dl, ProviderResolveAuthProfileIdContext as Dn, ContextEngineRuntimeSettingsUnsupportedError as Do, ChannelTurnRecordOptions as Dr, TtsDirectiveOverrides as Ds, ProviderAuthKind as Dt, normalizeHeartbeatToolResponse as Du, OpenClawPluginCliContext as E, AgentHarnessAttemptParams as Ea, ExecElevatedDefaults as Ec, CodexAppServerExtensionFactory as Ei, findPersistedAuthProfileCredential as El, ProviderReplayToolCallIdMode as En, ContextEngineRuntimeSettingsUnavailableError as Eo, ChannelTurnDroppedHistoryOptions as Er, SpeechVoiceOption as Es, ProviderAuthDoctorHintContext as Et, HeartbeatToolResponse as Eu, OpenClawPluginHttpRouteHandler as F, AgentHarnessSupport as Fa, resolveSimpleCompletionSelectionForAgent as Fc, CliBackendPrepareExecutionContext as Fi, repairOAuthProfileIdMismatch as Fl, ProviderRuntimeProviderConfig as Fn, TranscriptRewriteResult as Fo, SupplementalContextFacts as Fr, TaskRecord as Fs, ProviderBuiltInModelSuppressionResult as Ft, OpenClawPluginNodeInvokePolicyApprovalRuntime as G, BuildAgentRuntimePlanParams as Ga, getCustomProviderApiKey as Gc, AgentToolResultMiddlewareContext as Gi, resolveApiKeyForProfile as Gl, RealtimeTranscriptionProviderPlugin as Gn, PluginRuntimeTaskFlows as Go, DispatchReplyWithBufferedBlockDispatcher$1 as Gr, PluginWebSearchProviderEntry as Gs, ProviderDiscoveryOrder as Gt, OpenClawPluginNodeHostCommand as H, normalizeUsage as Ha, canUseProfileAsProviderEntryApiKey as Hc, PluginTextReplacement as Hi, dedupeProfileIds as Hl, ProviderValidateReplayTurnsContext as Hn, RuntimeLogger as Ho, resolveEnvelopeFormatOptions as Hr, ChannelIngressQueuePruneOptions as Hs, ProviderCreateStreamFnContext as Ht, OpenClawPluginHttpRouteMatch as I, AgentHarnessSupportContext as Ia, ModelAuthMode as Ic, CliBackendPreparedExecution as Ii, suggestOAuthProfileIdForLegacyDefault as Il, ProviderSanitizeReplayHistoryContext as In, LlmCompleteCaller as Io, ChannelBotLoopProtectionFacts as Ir, ChannelIngressQueue as Is, ProviderCacheTtlEligibilityContext as It, OpenClawPluginNodeInvokeTransportResult as J, ToolOutcomeObserver as Ja, hasSyntheticLocalProviderAuthConfig as Jc, AgentToolResultMiddlewareOptions as Ji, resolveAuthProfileDisplayLabel as Jl, TranscriptSourceProvider as Jn, DetachedTaskFinalizeParams as Jo, ReplyDispatcherWithTypingOptions as Jr, WebFetchProviderId as Js, ProviderExtraParamsForTransportResult as Jt, OpenClawPluginNodeInvokePolicyContext as K, BeforeToolCallPolicyDiagnosticState as Ka, hasAvailableAuthForProvider as Kc, AgentToolResultMiddlewareEvent as Ki, ExternalCliAuthDiscovery as Kl, RealtimeVoiceProviderPlugin as Kn, PluginRuntimeTaskRuns as Ko, DispatchReplyWithDispatcher as Kr, WebFetchCredentialResolutionSource as Ks, ProviderDiscoveryResult as Kt, OpenClawPluginHttpRouteParams as L, CompactEmbeddedAgentSessionParams as La, ProviderCredentialPrecedence as Lc, CliBackendResolveExecutionArgs as Li, markAuthProfileSuccess as Ll, ProviderSystemPromptContributionContext as Ln, LlmCompleteMessage as Lo, recordChannelBotPairLoopAndCheckSuppression as Lr, ChannelIngressQueueClaim as Ls, ProviderCapabilities as Lt, OpenClawPluginGatewayRuntimeScopeSurface as M, AgentHarnessResultClassification as Ma, completeWithPreparedSimpleCompletionModel as Mc, CliBackendNativeToolMode as Mi, resolvePersistedAuthProfileOwnerAgentDir as Ml, ProviderResolveUsageAuthContext as Mn, SubagentSpawnPreparation as Mo, InboundMediaFacts as Mr, OpenClawPluginToolContext as Ms, ProviderBuildMissingAuthMessageContext as Mt, OpenClawPluginHostedMediaResolver as N, AgentHarnessSideQuestionParams as Na, prepareSimpleCompletionModel as Nc, CliBackendNormalizeConfigContext as Ni, saveAuthProfileStore as Nl, ProviderResolveWebSocketSessionPolicyContext as Nn, TranscriptRewriteReplacement as No, PreparedChannelTurn as Nr, OpenClawPluginToolFactory as Ns, ProviderBuildUnknownModelHintContext as Nt, OpenClawPluginCommandDefinition as O, AgentHarnessCompactParams as Oa, AgentSimpleCompletionSelection as Oc, CodexAppServerToolResultEvent as Oi, loadAuthProfileStoreForRuntime as Ol, ProviderResolveDynamicModelContext as On, ContextEngineSelectionSource as Oo, ChannelTurnResult as Or, TtsDirectiveParseResult as Os, ProviderAuthMethod as Ot, OpenClawPluginHttpRouteAuth as P, AgentHarnessSideQuestionResult as Pa, prepareSimpleCompletionModelForAgent as Pc, CliBackendPlugin as Pi, updateAuthProfileStoreWithLock as Pl, ProviderResolvedUsageAuth as Pn, TranscriptRewriteRequest as Po, RunChannelTurnParams as Pr, OpenClawPluginToolOptions as Ps, ProviderBuiltInModelSuppressionContext as Pt, OpenClawPluginSecurityAuditContext as Q, isToolWrappedWithBeforeToolCallHook as Qa, resolveProviderEntryApiKeyBinding as Qc, REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ as Qi, ProviderAuthAliasLookupParams as Ql, CreatePluginRuntimeOptions as Qn, TaskRunAggregateSummary as Qo, GetReplyFromConfig as Qr, WebSearchCredentialResolutionSource as Qs, ProviderFollowupFallbackRouteResult as Qt, OpenClawPluginHttpRouteUpgradeHandler as R, EmbeddedRunAttemptParams as Ra, ProviderEntryApiKeyBindingResolution as Rc, CliBackendResolveExecutionArgsContext as Ri, removeProviderAuthProfilesWithLock as Rl, ProviderToolSchemaDiagnostic as Rn, LlmCompleteParams as Ro, EnvelopeFormatOptions as Rr, ChannelIngressQueueClaimRef as Rs, ProviderCatalogContext as Rt, OpenClawPluginAgentEventsApi as S, RealtimeTranscriptionSession as Sa, BlockReplyChunking as Sc, PluginSessionTurnUnscheduleByTagResult as Si, clearRuntimeAuthProfileStoreSnapshots as Sl, ProviderReplayPolicyContext as Sn, ContextEngineRuntimeContext as So, resolveChannelInboundSupplementalContext as Sr, SpeechSynthesisStreamRequest as Ss, PluginTextTransformRegistration as St, EmbeddedAgentRunMeta as Su, OpenClawPluginCliCommandDescriptor as T, AgentHarness as Ta, ClientToolDefinition as Tc, CodexAppServerExtensionContext as Ti, ensureAuthProfileStoreWithoutExternalProfiles as Tl, ProviderReplaySessionState as Tn, ContextEngineRuntimeSettings as To, ChannelTurnAdmission as Tr, SpeechTelephonySynthesisRequest as Ts, ProviderAuthContext as Tt, HEARTBEAT_RESPONSE_TOOL_NAME as Tu, OpenClawPluginNodeInvokeApprovalDecision as U, isReplaySafeToolCall as Ua, createRuntimeProviderAuthLookup as Uc, PluginTextTransforms as Ui, listProfilesForProvider as Ul, ProviderWebSocketSessionPolicy as Un, BoundTaskFlowsRuntime as Uo, finalizeInboundContext as Ur, ChannelIngressQueueRecord as Us, ProviderDeferSyntheticProfileAuthContext as Ut, OpenClawPluginNodeCliFeatureOptions as V, NormalizedUsage as Va, applyLocalNoAuthHeaderOverride as Vc, CliBundleMcpMode as Vi, upsertAuthProfileWithLock as Vl, ProviderUsageAuthToken as Vn, PluginRuntimeCore as Vo, formatInboundFromLabel as Vr, ChannelIngressQueueFailedRecord as Vs, ProviderCreateEmbeddingProviderContext as Vt, OpenClawPluginNodeInvokePolicy as W, AgentRuntimePlan as Wa, getApiKeyForModel as Wc, AgentToolResultMiddleware as Wi, refreshOAuthCredentialForRuntime as Wl, ProviderWrapStreamFnContext as Wn, BoundTaskRunsRuntime as Wo, settleReplyDispatcher as Wr, PluginWebFetchProviderEntry as Ws, ProviderDiscoveryContext as Wt, OpenClawPluginRunContextApi as X, getBeforeToolCallPolicyDiagnosticState as Xa, resolveApiKeyForProvider as Xc, AgentToolResultMiddlewareRuntime as Xi, resolveAuthProfileEligibility as Xl, UnifiedModelCatalogProviderPlugin as Xn, TaskFlowDetail as Xo, createReplyDispatcherWithTyping as Xr, WebFetchProviderToolDefinition as Xs, ProviderFetchUsageSnapshotContext as Xt, OpenClawPluginReloadRegistration as Y, finalizeToolTerminalPresentation as Ya, hasUsableCustomProviderApiKey as Yc, AgentToolResultMiddlewareResult as Yi, AuthProfileEligibilityReasonCode as Yl, UnifiedModelCatalogProviderContext as Yn, DetachedTaskLifecycleRuntime as Yo, createReplyDispatcher as Yr, WebFetchProviderPlugin as Ys, ProviderFailoverErrorContext as Yt, OpenClawPluginSecurityAuditCollector as Z, hasBeforeToolCallPolicy as Za, resolveModelAuthMode as Zc, OpenClawAgentToolResult as Zi, resolveAuthProfileOrder as Zl, VideoGenerationProviderPlugin as Zn, TaskFlowView as Zo, DispatchFromConfigResult as Zr, WebFetchRuntimeMetadataContext as Zs, ProviderFollowupFallbackRouteContext as Zt, MigrationSummary as _, RealtimeVoiceToolResultOptions as _a, formatFastModeCommandOptions as _c, PluginSessionExtensionRegistration as _i, resolveProfileUnusableUntilForDisplay as _l, ProviderPrepareRuntimeAuthContext as _n, ContextEngineInfo as _o, FinalizeChannelInboundContextResult as _r, SpeechProviderPreparedSynthesis as _s, PluginRealtimeVoiceProviderEntry as _t, ProviderResolveExternalAuthProfilesContext as _u, ImageGenerationProviderPlugin as a, RealtimeVoiceBridgeEvent as aa, WebSearchRuntimeMetadataContext as ac, PluginAgentEventEmitResult as ai, formatMissingAuthError as al, ProviderNormalizeToolSchemasContext as an, AgentHarnessTaskRuntimeScope as ao, hasVisibleChannelTurnDispatch as ar, resolveEffectiveTtsConfig as as, PluginCommandContext as at, hasUsableOAuthCredential as au, OpenClawGatewayDiscoveryService as b, RealtimeTranscriptionProviderId as ba, formatFastModeStatusValue as bc, PluginSessionTurnScheduleParams as bi, getSoonestCooldownExpiry as bl, ProviderReasoningOutputModeContext as bn, ContextEngineProjection as bo, filterChannelInboundSupplementalContext as br, SpeechProviderResolveTalkOverridesContext as bs, PluginSetupAutoEnableProbe as bt, ProviderSyntheticAuthResult as bu, MigrationDetection as c, RealtimeVoiceCloseReason as ca, GenerateImageParams as cc, PluginRunContextGetParams as ci, requireApiKey as cl, ProviderPlugin as cn, ContextEngineFactoryContext as co, DurableInboundReplyDeliveryParams as cr, SpeechDirectiveTokenParseContext as cs, PluginCommandResult as ct, augmentModelCatalogWithProviderPlugins as cu, MigrationItemKind as d, RealtimeVoiceProviderConfiguredContext as da, RunEmbeddedAgentParams as dc, PluginSessionActionContext as di, resolveEnvApiKey as dl, ProviderPluginWizard as dn, AssembleResult as do, BuildChannelInboundEventContextAsyncParams as dr, SpeechModelOverridePolicy as ds, PluginEmbeddingProvider as dt, ProviderThinkingProfile as du, RealtimeVoiceAudioFormat as ea, WebSearchProviderId as ec, ProcessToolDefaults as ei, resolveUsableCustomProviderApiKey as el, ProviderModernModelPolicyContext as en, runBeforeToolCallHook as eo, SubagentRunParams as er, TaskRunDetail as es, OpenClawPluginServiceContext as et, resolveProviderAuthAliasMap as eu, MigrationItemStatus as f, RealtimeVoiceProviderId as fa, PromptMode as fc, PluginSessionActionRegistration as fi, calculateAuthProfileCooldownMs as fl, ProviderPluginWizardModelPicker as fn, BootstrapResult as fo, BuildChannelInboundEventContextParams as fr, SpeechProviderConfig as fs, PluginInteractiveHandlerRegistration as ft, ProviderRuntimeModel as fu, MigrationProviderPreparation as g, RealtimeVoiceToolCallEvent as ga, formatFastModeAutoProgressText as gc, PluginSessionExtensionProjection as gi, markAuthProfileFailure as gl, ProviderPrepareExtraParamsContext as gn, ContextEngineHostRequirements as go, FinalizeChannelInboundContextParams as gr, SpeechProviderPrepareSynthesisContext as gs, PluginRealtimeTranscriptionProviderEntry as gt, ProviderExternalOAuthProfile as gu, MigrationProviderPlugin as h, RealtimeVoiceTool as ha, FastModeAutoProgressState as hc, PluginSessionAttachmentResult as hi, markAuthProfileCooldown as hl, ProviderPrepareDynamicModelContext as hn, ContextEngineHostCapability as ho, FinalizeChannelInboundContextAsyncParams as hr, SpeechProviderOverrides as hs, PluginLogger as ht, ProviderExternalAuthProfile as hu, AgentPromptSurfaceKind as i, RealtimeVoiceBridgeCreateRequest as ia, WebSearchProviderToolExecutionContext as ic, PluginAgentEventEmitParams as ii, ResolvedProviderAuth as il, ProviderNormalizeResolvedModelContext as in, consumePreExecutionBlockedToolCall as io, hasFinalChannelTurnDispatch as ir, TtsConfigResolutionContext as is, OpenClawPluginSessionWorkflowApi as it, TokenExpiryState as iu, OpenClawPluginGatewayMethod as j, AgentHarnessResetParams as ja, SimpleCompletionModelOptions as jc, CliBackendExecutionMode as ji, replaceRuntimeAuthProfileStoreSnapshots as jl, ProviderResolveTransportTurnStateContext as jn, SubagentEndReason as jo, DispatchedChannelTurnResult as jr, OpenClawPluginHookOptions as js, ProviderAuthResult as jt, OpenClawPluginConfigSchema as k, AgentHarnessCompactResult as ka, PreparedSimpleCompletionModel as kc, CodexAppServerToolResultHandlerResult as ki, loadAuthProfileStoreForSecretsRuntime as kl, ProviderResolveNonInteractiveApiKeyParams as kn, IngestBatchResult as ko, CommandFacts as kr, ResolvedProviderRuntimeAuth as ks, ProviderAuthMethodNonInteractiveContext as kt, MigrationItem as l, RealtimeVoiceProviderCapabilities as la, GenerateImageRuntimeResult as lc, PluginRunContextPatch as li, resolveAwsSdkEnvVarName as ll, ProviderPluginCatalog as ln, registerContextEngine as lo, DurableInboundReplyDeliveryResult as lr, SpeechDirectiveTokenParseResult as ls, PluginConfigMigration as lt, ProviderDefaultThinkingPolicyContext as lu, MigrationProviderContext as m, RealtimeVoiceRole as ma, resolveFastModeState as mc, PluginSessionAttachmentParams as mi, markAuthProfileBlockedUntil as ml, ProviderPreferRuntimeResolvedModelContext as mn, ContextEngine as mo, ChannelInboundSupplementalResolutionOptions as mr, SpeechProviderId as ms, PluginInteractiveRegistration as mt, ProviderSystemPromptContribution as mu, AgentPromptGuidance as n, RealtimeVoiceBridge as na, WebSearchProviderSetupContext as nc, ProviderNormalizeConfigContext as ni, MissingProviderAuthError as nl, ProviderNonInteractiveApiKeyResult as nn, wrapToolWithBeforeToolCallHook as no, kernel_d_exports as nr, ResolvedTtsConfig as ns, OpenClawPluginSessionControlsApi as nt, AuthCredentialReasonCode as nu, MediaUnderstandingProviderPlugin as o, RealtimeVoiceBrowserSession as oa, GenerateVideoParams as oc, PluginAgentEventSubscriptionRegistration as oi, isMissingProviderAuthError as ol, ProviderNormalizeTransportContext as on, resolveEmbeddedAgentRuntime as oo, resolveChannelTurnDispatchCounts as or, TTS_AUTO_MODES as os, PluginCommandDiagnosticsSession as ot, CLAUDE_CLI_PROFILE_ID as ou, MigrationPlan as p, RealtimeVoiceProviderResolveConfigContext as pa, AgentInternalEvent as pc, PluginSessionActionResult as pi, clearAuthProfileCooldown as pl, ProviderPluginWizardSetup as pn, CompactResult as po, BuiltChannelInboundEventContext as pr, SpeechProviderConfiguredContext as ps, PluginInteractiveHandlerResult as pt, ProviderRuntimePluginHandle as pu, OpenClawPluginNodeInvokePolicyResult as q, DeferredPluginToolApproval as qa, hasRuntimeAvailableProviderAuth as qc, AgentToolResultMiddlewareHarness as qi, formatAuthDoctorHint as ql, SpeechProviderPlugin as qn, PluginRuntimeTasks as qo, ReplyDispatcherOptions as qr, WebFetchProviderContext as qs, ProviderExtraParamsForTransportContext as qt, AgentPromptGuidanceEntry as r, RealtimeVoiceBridgeCallbacks as ra, WebSearchProviderToolDefinition as rc, ProviderResolveConfigApiKeyContext as ri, ProviderAuthError as rl, ProviderNormalizeModelIdContext as rn, consumeAdjustedParamsForToolCall as ro, recordDroppedChannelInboundHistory as rr, ResolvedTtsModelOverrides as rs, OpenClawPluginSessionStateApi as rt, DEFAULT_OAUTH_REFRESH_MARGIN_MS as ru, MigrationApplyResult as s, RealtimeVoiceBrowserSessionCreateRequest as sa, GenerateVideoRuntimeResult as sc, PluginControlUiDescriptor as si, isProviderAuthError as sl, ProviderOAuthProfileIdRepair as sn, ContextEngineFactory as so, DurableInboundReplyDeliveryOptions as sr, normalizeTtsAutoMode as ss, PluginCommandHandler as st, CODEX_CLI_PROFILE_ID as su, AGENT_PROMPT_SURFACE_KINDS as t, RealtimeVoiceBargeInOptions as ta, WebSearchProviderPlugin as tc, ProviderApplyConfigDefaultsContext as ti, shouldPreferExplicitConfigApiKeyAuth as tl, ProviderNonInteractiveApiKeyCredentialParams as tn, setBeforeToolCallDiagnosticsEnabled as to, SubagentRunResult as tr, TaskRunView as ts, OpenClawPluginSessionApi as tt, resolveProviderIdForAuth as tu, MigrationItemAction as u, RealtimeVoiceProviderConfig as ua, EmbeddedRunTrigger as uc, PluginRuntimeLifecycleRegistration as ui, EnvApiKeyResult as ul, ProviderPluginDiscovery as un, resolveContextEngineOwnerPluginId as uo, deliverInboundReplyWithMessageSendContext as ur, SpeechListVoicesRequest as us, PluginConfigValidation as ut, ProviderThinkingPolicyContext as uu, MusicGenerationProviderPlugin as v, RealtimeTranscriptionProviderConfig as va, formatFastModeCurrentStatus as vc, PluginSessionSchedulerJobHandle as vi, resolveProfilesUnavailableReason as vl, ProviderPreparedRuntimeAuth as vn, ContextEngineMaintenanceResult as vo, buildChannelInboundEventContext as vr, SpeechProviderResolveConfigContext as vs, PluginRegistrationMode as vt, ProviderResolveExternalOAuthProfilesContext as vu, OpenClawPluginChannelRegistration as w, RealtimeTranscriptionSessionCreateRequest as wa, AgentStreamParams as wc, PluginTrustedToolPolicyRegistration as wi, ensureAuthProfileStoreForLocalUpdate as wl, ProviderReplaySessionEntry as wn, ContextEngineRuntimeReasonCode as wo, AssembledChannelTurn as wr, SpeechSynthesisTarget as ws, ProviderAugmentModelCatalogContext as wt, MessagingToolSourceReplyPayload as wu, OpenClawPluginAgentApi as x, RealtimeTranscriptionProviderResolveConfigContext as xa, resolveFastModeForElapsed as xc, PluginSessionTurnUnscheduleByTagParams as xi, isProfileInCooldown as xl, ProviderReplayPolicy as xn, ContextEnginePromptCacheInfo as xo, finalizeChannelInboundContext as xr, SpeechSynthesisRequest as xs, PluginSpeechProviderEntry as xt, EmbeddedAgentCompactResult as xu, OpenClawGatewayDiscoveryAdvertiseContext as y, RealtimeTranscriptionProviderConfiguredContext as ya, formatFastModeSourceSuffix as yc, PluginSessionSchedulerJobRegistration as yi, clearExpiredCooldowns as yl, ProviderReasoningOutputMode as yn, ContextEngineOperation as yo, filterChannelInboundQuoteContext as yr, SpeechProviderResolveTalkConfigContext as ys, PluginSetupAutoEnableContext as yt, ProviderResolveSyntheticAuthContext as yu, OpenClawPluginLifecycleApi as z, EmbeddedRunAttemptResult as za, RuntimeProviderAuthLookup as zc, CliBackendSideQuestionToolMode as zi, setAuthProfileOrder as zl, ProviderTransformSystemPromptContext as zn, LlmCompleteResult as zo, formatAgentEnvelope as zr, ChannelIngressQueueCompletedRecord as zs, ProviderCatalogOrder as zt };