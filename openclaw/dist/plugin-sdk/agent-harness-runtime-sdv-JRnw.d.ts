import { o as ChannelAgentTool } from "./types.core-BMp7ngzJ.js";
import { l as ImageContent } from "./types-Boa_mcGH.js";
import { f as AgentToolResult, l as AgentTool, p as AgentToolUpdateCallback, s as AgentMessage } from "./types-BoFHdU9q.js";
import { a as SourceReplyDeliveryMode, s as PromptImageOrderEntry } from "./types-DNy-f8Hr.js";
import { f as InboundEventKind } from "./templating-Bx-yYzyQ.js";
...
import { s as AuthProfileStore } from "./types-yaJ7N7xg.js";
import { t as OperatorScope } from "./operator-scopes-Phea7r7e.js";
import { P as PluginHookContextWindowSource, X as PluginHookLlmInputEvent, Z as PluginHookLlmOutputEvent, d as PluginHookAgentEndEvent, f as PluginHookBeforeAgentFinalizeEvent, ln as PluginHookBeforeAgentStartResult, u as PluginHookAgentContext } from "./hook-types-Dik-Ur77.js";
import { $a as requestDeferredPluginToolApproval, Ba as PreemptiveCompactionRoute, Cu as MessagingToolSend, Dc as ExecToolDefaults, Ei as CodexAppServerExtensionFactory, Fo as TranscriptRewriteResult, Ga as BuildAgentRuntimePlanParams, Gi as AgentToolResultMiddlewareContext, Ic as ModelAuthMode, Ja as ToolOutcomeObserver, Ki as AgentToolResultMiddlewareEvent, Oi as CodexAppServerToolResultEvent, Ra as EmbeddedRunAttemptParams, So as ContextEngineRuntimeContext, Ti as CodexAppServerExtensionContext, To as ContextEngineRuntimeSettings, Va as NormalizedUsage, Wa as AgentRuntimePlan, Wi as AgentToolResultMiddleware, Zi as OpenClawAgentToolResult, do as AssembleResult, ei as ProcessToolDefaults, fu as ProviderRuntimeModel, mo as ContextEngine, po as CompactResult, pu as ProviderRuntimePluginHandle, uc as EmbeddedRunTrigger, xo as ContextEnginePromptCacheInfo, za as EmbeddedRunAttemptResult } from "./types-B70zVumi.js";
...
import { Dr as ToolDefinition } from "./index-DjU32k76.js";
...
import { t as getGlobalHookRunner } from "./hook-runner-global-D9LO-GhJ.js";
import { P as SandboxContext } from "./sandbox-q5iI20B_.js";
import { n as ContextEngineHostSupport } from "./host-compat-B61TJKuX.js";
...
//#endregion
export { normalizeProviderToolSchemas as $, assembleHarnessContextEngine as A, formatToolAggregate as At, runAgentHarnessAfterCompactionHook as B, buildAgentHookContextChannelFields as Bt, PreemptiveCompactionDecision as C, extractToolErrorMessage as Ct, compactContextEngineWithSafetyTimeout as D, isToolResultError as Dt, shouldPreemptivelyCompactBeforePrompt as E, sanitizeToolResult as Et, isActiveHarnessContextEngine as F, callGatewayTool as Ft, resolveSessionWriteLockAcquireTimeoutMs as G, buildNativeHookRelayCommand as Gt, appendSessionTranscriptMessage as H, NativeHookRelayProcessResponse as Ht, runHarnessContextEngineMaintenance as I, classifyEmbeddedAgentRunResultForModelFallback as It, resolveBootstrapContextForRun as J, registerNativeHookRelay as Jt, resolveSessionWriteLockOptions as K, hasNativeHookRelayInvocation as Kt, createAgentToolResultMiddlewareRunner as L, buildAgentRuntimePlan as Lt, buildHarnessContextEngineRuntimeContext as M, resolveNodeIdFromList as Mt, buildHarnessContextEngineRuntimeContextFromUsage as N, selectDefaultNodeFromList as Nt, compactWithSafetyTimeout as O, isMessagingTool as Ot, finalizeHarnessContextEngineTurn as P, NodeListNode as Pt, resolveWritableSandboxBindHostRoots as Q, LoadCodexBundleMcpThreadConfigParams as Qt, createCodexAppServerToolResultExtensionRunner as R, log as Rt, PREEMPTIVE_OVERFLOW_ERROR_TEXT as S, extractMessagingToolSendResult as St, formatPrePromptPrecheckLog as T, filterToolResultMediaUrls as Tt, SessionWriteLockAcquireTimeoutConfig as U, NativeHookRelayProvider as Ut, runAgentHarnessBeforeCompactionHook as V, NativeHookRelayEvent as Vt, acquireSessionWriteLock as W, NativeHookRelayRegistrationHandle as Wt, hasSandboxBindContainerPathAliases as X, testing as Xt, resolveBootstrapFilesForRun as Y, resolveNativeHookRelayDeferredToolApproval as Yt, hasSandboxBindReadonlyHostShadows as Z, CodexBundleMcpThreadConfig as Zt, runAgentHarnessLlmInputHook as _, buildSkillWorkshopPromptSection as _t, classifyAgentHarnessTerminalOutcome as a, RuntimeToolInputSchemaJson as at, runAgentHarnessBeforeMessageWriteHook as b, supportsModelTools as bt, inferToolMetaFromArgs as c, disposeRegisteredAgentHarnesses as ct, awaitAgentEndSideEffects as d, createOpenClawCodingTools as dt, logAgentRuntimeToolDiagnostics as et, runAgentEndSideEffects as f, getPluginToolMeta as ft, runAgentHarnessBeforeAgentFinalizeHook as g, SKILL_WORKSHOP_TOOL_NAME as gt, runAgentHarnessAgentEndHook as h, resolveAttemptFsWorkspaceOnly as ht, ToolProgressDetailMode as i, inspectRuntimeToolInputSchemas as it, bootstrapHarnessContextEngine as j, listNodes as jt, resolveCompactionTimeoutMs as k, isMessagingToolSendAction as kt, loadCodexBundleMcpThreadConfig as l, applyEmbeddedAttemptToolsAllow as lt, getAgentHarnessHookRunner as m, resolveAttemptSpawnWorkspaceDir as mt, AgentHarnessTerminalOutcomeInput as n, RuntimeToolSchemaDiagnostic as nt, detectAndLoadAgentHarnessPromptImages as o, RuntimeToolInputSchemaProjection as ot, awaitAgentHarnessAgentEndHook as p, buildEmbeddedAttemptToolRunContext as pt, buildBootstrapContextForFiles as q, invokeNativeHookRelay as qt, TOOL_PROGRESS_OUTPUT_MAX_CHARS as r, filterProviderNormalizableTools as rt, formatToolProgressOutput as s, projectRuntimeToolInputSchema as st, AgentHarnessTerminalOutcomeClassification as t, normalizeAgentRuntimeTools as tt, queueAgentHarnessMessage as u, resolveEmbeddedAttemptToolConstructionPlan as ut, runAgentHarnessLlmOutputHook as v, getChannelAgentToolMeta as vt, estimateRenderedLlmBoundaryTokenPressure as w, extractToolResultMediaArtifact as wt, LlmBoundaryTokenPressure as x, extractMessagingToolSend as xt, runAgentHarnessAfterToolCallHook as y, isAgentToolReplaySafe as yt, resolveAgentHarnessBeforePromptBuildResult as z, runAgentCleanupStep as zt };