...
import { t as createOperatorApprovalsGatewayClient } from "./operator-approvals-client-XaFrnmEE.js";
...
function createChannelNativeApprovalRuntime(adapter) {
	...
	const routeReporter = createApprovalNativeRouteReporter({
		...
		requestGateway: async (method, params) => {
			const { callGatewayLeastPrivilege } = await import("./call-YvNwFPLB.js");
