...
import { a as getPositiveIntFlagValue, c as hasFlag, i as getFlagValue, j as isValueToken, r as getCommandPositionalsWithRootOptions, s as getVerboseFlag } from "./argv-YFvW08kO.js";
import { t as resolveCliArgvInvocation } from "./argv-invocation-DdUznDDI.js";
import { t as createLazyImportLoader } from "./lazy-promise-BONnzNfb.js";
import { n as defaultRuntime } from "./runtime-B4lgFmsS.js";
import { v as tryParseLogLevel } from "./logger-BfNItX-e.js";
import { i as cliCommandCatalog, r as matchesCommandPath, t as resolveCliCommandPathPolicy } from "./command-path-policy-Cc8RHm5e.js";
import { i as parseStrictPositiveIntOrUndefined } from "./helpers-gBVG4H2O.js";
import { n as ensureCliExecutionBootstrap, r as resolveCliExecutionStartupContext, t as applyCliExecutionStartupPresentation } from "./command-execution-startup-D6B3lsbh.js";
...
const configCliLoader = createLazyImportLoader(() => import("./config-cli-C90tN-xd.js"));
const agentsListCommandLoader = createLazyImportLoader(() => import("./agents.commands.list-IT9U34V-.js"));
const modelsListCommandLoader = createLazyImportLoader(() => import("./list.list-command-BB5vObeT.js"));
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command-DihYX4EW.js"));
const tasksJsonCommandLoader = createLazyImportLoader(() => import("./tasks-json-CMZXID2g.js"));
...
const routedCommandDefinitions = {
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-BuB9LG4h.js");
			...
			const { statusCommand } = await import("./status-B7D0NBSZ.js");
	...
	"gateway-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runDaemonStatus } = await import("./status-BVLma055.js");
	...
	sessions: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { sessionsCommand } = await import("./sessions-CE6fN9cA.js");
	...
	"channels-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsListCommand } = await import("./list-QQoV5aa_.js");
	...
	"channels-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsStatusCommand } = await import("./status-Cw5jcTXu.js");
	...
	"plugins-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runPluginsListCommand } = await import("./plugins-list-command-DtCwApbO.js");
