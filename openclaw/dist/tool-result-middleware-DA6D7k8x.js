...
import { p as resolvePluginControlPlaneFingerprint } from "./current-plugin-metadata-snapshot-nGeSY76G.js";
import "./defaults-mDjiWzE5.js";
import { u as resolveProviderRuntimePlugin } from "./provider-hook-runtime-kjUY4t_q.js";
import { o as normalizeProviderId } from "./model-selection-normalize-BvNI1t-G.js";
import "./model-selection-60FiczuZ.js";
import { ht as generateSummary$1 } from "./sessions-BY13LxNc.js";
import { a as buildStageSplitPlan, i as buildOversizedFallbackPlan, l as sanitizeCompactionMessages, o as buildSummaryChunks, r as buildHistoryPrunePlan, s as computeAdaptiveChunkRatio } from "./compaction-planning-C7Ri_F3c.js";
import { l as isTimeoutError } from "./failover-error-3to6iVLf.js";
import { n as retryAsync } from "./retry-DLCr-g6e.js";
import { f as isGoogleModelApi } from "./embedded-agent-helpers-CHJLXFE8.js";
import { a as isMessagingToolSendAction } from "./embedded-agent-messaging-DrnnQY0n.js";
import { r as isDeliveredMessagingToolResult, t as hasMessagingDeliveryReceipt, v as isToolResultError } from "./embedded-agent-message-tool-source-reply-BNDmht0w.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-BsKCzJ3C.js");
