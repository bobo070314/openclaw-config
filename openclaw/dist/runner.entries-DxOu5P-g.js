...
import { t as buildRandomTempFilePath } from "./temp-download-BQUCJ5GJ.js";
import { n as createConfigScopedPromiseLoader } from "./plugin-cache-primitives-BaxqicKH.js";
import { l as resolveEffectivePluginActivationState, n as createPluginActivationSource, s as normalizePluginsConfig } from "./config-state-BffrOAI6.js";
...
import { i as runExec } from "./exec-DCJt2ylI.js";
import { a as loadManifestContractSnapshot } from "./manifest-contract-eligibility-B1geeVF9.js";
import { n as resolveBundledPluginCompatibleLoadValues } from "./activation-context-40N66Jdc.js";
...
import { a as mergeModelProviderRequestOverrides, d as sanitizeConfiguredProviderRequest, u as sanitizeConfiguredModelProviderRequest } from "./provider-request-config-s_yn8lQ_.js";
import { n as CUSTOM_LOCAL_AUTH_MARKER } from "./model-auth-markers-B2ymkRS2.js";
import { a as convertHeicToJpeg } from "./image-ops-D2XDf2Zy.js";
import { c as runFfmpeg } from "./media-services-BQZ53ZrV.js";
import { t as parseMediaContentLength } from "./content-length-DZY9SBS5.js";
import { i as readRemoteMediaBuffer, n as MediaFetchError } from "./fetch-BW9kEN7m.js";
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-CYWsER5a.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-DjdsAoVF.js";
import { n as normalizeMediaProviderId, t as normalizeMediaExecutionProviderId } from "./provider-id-DSbuCFIb.js";
import { t as describeImageWithModel } from "./image-runtime-CcCWeR-q.js";
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, n as DEFAULT_MAX_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-DdoeP7fs.js";
import { c as resolveTimeoutMs, n as resolveMaxBytes, o as resolvePrompt, r as resolveMaxChars } from "./resolve-CHFYLkHe.js";
import { n as resolveOpenAiAudioAuthModelApi } from "./openai-audio-api-BEkNYRPi.js";
import { n as providerOperationRetryConfig } from "./operation-retry-Dww31c40.js";
import "./temp-path-DZCQ-PXp.js";
import { n as executeWithApiKeyRotation, t as collectProviderApiKeysForExecution } from "./api-key-rotation-Dr6Vqwow.js";
import { t as applyTemplate } from "./templating-CLmjS51i.js";
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-Cs4HXql4.js";
...
async function loadModelAuth() {
	cachedModelAuth ??= await import("./model-auth-Cbeftk9T.js");
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-CMxFFxzV.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio",
			workspaceDir: params.workspaceDir
