...
import { m as loadPluginRegistrySnapshotWithMetadata } from "./plugin-registry-CvH_tnL6.js";
...
import { b as resolveProviderEnvAuthLookupMaps, y as listProviderEnvAuthLookupKeys } from "./model-auth-markers-B2ymkRS2.js";
...
import { l as hasSyntheticLocalProviderAuthConfig, u as hasUsableCustomProviderApiKey } from "./model-auth-GMzbnR3o.js";
import { i as formatTokenK, m as createModelCatalogProviderAliasCanonicalizer, n as ensureFlagCompatibility, p as canonicalizeModelCatalogProviderAlias } from "./shared-BSu_bkyn.js";
import { n as loadModelsConfigWithSource } from "./load-config-OppVS1K-.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-GxAZQLGM.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-BZLvhrsi.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-D9My0e2X.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-CuqqHze8.js"),
		import("./agent-scope-BxpxzPcu.js"),
		import("./workspace-DZCB2HR4.js")
	]);
