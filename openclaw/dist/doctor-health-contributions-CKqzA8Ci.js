import { a as isLegacyParentWritableUpdateDoctorPass } from "./update-phase-R4P7QlcR.js";
...
const loadAgentScopeModule = async () => await import("./agent-scope-BxpxzPcu.js");
const loadCommandFormatModule = async () => await import("./command-format-DYZniLoK.js");
const loadConfigModule = async () => await import("./config/config.js");
const loadDoctorCoreChecksModule = async () => await import("./doctor-core-checks-DxblfrQ7.js");
const loadDoctorStateIntegrityModule = async () => await import("./doctor-state-integrity-BbdG0V0k.js");
const loadHealthCheckRegistryModule = async () => await import("./health-check-registry-BzU8tXic.js");
const loadModelCatalogModule = async () => await import("./model-catalog-BQZlAOIC.js");
const loadModelSelectionModule = async () => await import("./model-selection-BQVGL39u.js");
const loadNoteModule = async () => await import("./terminal-core/note.js");
const loadOnboardHelpersModule = async () => await import("./onboard-helpers-CaUKBdIp.js");
const loadSecretTypesModule = async () => await import("./types.secrets-DnhZK1oK.js");
...
async function runStructuredDoctorHealthContribution(params) {
	...
	const { resolveAgentWorkspaceDir, resolveDefaultAgentId } = await import("./agent-scope-BxpxzPcu.js");
...
async function runGatewayConfigHealth(ctx) {
	...
	const { hasAmbiguousGatewayAuthModeConfig } = await import("./auth-mode-policy-DjkK_fKf.js");
...
async function runAuthProfileHealth(ctx) {
	const { maybeRepairLegacyFlatAuthProfileStores, maybeRepairCanonicalApiKeyFieldAlias } = await import("./doctor-auth-flat-profiles-CpceGud9.js");
	const { maybeRepairLegacyOAuthProfileIds } = await import("./doctor-auth-legacy-oauth-DAwsJiWd.js");
	const { maybeRepairLegacyOAuthSidecarProfiles } = await import("./doctor-auth-oauth-sidecar-Co-UJMgh.js");
	const { noteAuthProfileHealth, noteLegacyCodexProviderOverride } = await import("./doctor-auth-WpBFGA5B.js");
	const { buildGatewayConnectionDetails } = await import("./call-YvNwFPLB.js");
	const { note } = await loadNoteModule();
...
async function runGatewayAuthHealth(ctx) {
	...
	const { resolveGatewayAuth } = await import("./auth-Crh2BkYe.js");
	const { resolveGatewayAuthToken } = await import("./auth-token-resolution-BNmNQitV.js");
	const { note } = await loadNoteModule();
	...
	if (gatewayTokenRef && gatewayTokenRef.source === "exec") {
		const { getSkippedExecRefStaticError } = await import("./exec-resolution-policy-CqhJ8P9N.js");
...
async function runCommandOwnerHealth(ctx) {
	const { noteCommandOwnerHealth } = await import("./doctor-command-owner-CkVmZUDE.js");
	noteCommandOwnerHealth(ctx.cfg);
}
async function runStructuredHealthRepairs(ctx) {
	if (!ctx.prompter.shouldRepair) return;
	const { registerBundledHealthChecks } = await import("./bundled-health-checks-D0iMERAC.js");
...
async function runClaudeCliHealth(ctx) {
	const { noteClaudeCliHealth } = await import("./doctor-claude-cli-ChpbooEt.js");
	noteClaudeCliHealth(ctx.cfg);
}
async function runCoreContributionHealthRepair(ctx, checkIds) {
	if (!ctx.prompter.shouldRepair || checkIds.length === 0) return;
	const { CORE_HEALTH_CHECKS } = await import("./doctor-core-checks-DxblfrQ7.js");
	const { runDoctorHealthRepairs } = await import("./doctor-repair-flow-BfHI6ZCN.js");
	const { resolveAgentWorkspaceDir, resolveDefaultAgentId } = await import("./agent-scope-BxpxzPcu.js");
...
async function runLegacyStateHealth(ctx) {
	const { detectLegacyStateMigrations, runLegacyStateMigrations } = await import("./doctor-state-migrations-BwmU2HXc.js");
	const { note } = await loadNoteModule();
...
async function runLegacyPluginManifestHealth(ctx) {
	const { maybeRepairLegacyPluginManifestContracts } = await import("./doctor-plugin-manifests-Cwf7-DSY.js");
...
async function runPluginRegistryHealth(ctx) {
	const { maybeRepairPluginRegistryState } = await import("./doctor-plugin-registry-E7baaGKr.js");
...
async function runReleaseConfiguredPluginInstallsHealth(ctx) {
	...
	if (!ctx.prompter.shouldRepair) return;
	const { maybeRunConfiguredPluginInstallReleaseStep } = await import("./release-configured-plugin-installs-BCbHXL-f.js");
	const { note } = await loadNoteModule();
...
async function runDiskSpaceHealth(ctx) {
	const { noteDiskSpace } = await import("./doctor-disk-space-BmBuzNOB.js");
...
async function runCodexSessionRouteHealth(ctx) {
	const { maybeRepairCodexSessionRoutes } = await import("./codex-route-warnings-CBzhLU-r.js");
	const { note } = await loadNoteModule();
...
async function runSessionLocksHealth(ctx) {
	const { noteSessionLockHealth } = await import("./doctor-session-locks-3XwqopSO.js");
...
async function runSessionTranscriptsHealth(ctx) {
	const { noteSessionTranscriptHealth } = await import("./doctor-session-transcripts-DEo8jukR.js");
	await noteSessionTranscriptHealth({ shouldRepair: ctx.prompter.shouldRepair });
}
async function runSessionSnapshotsHealth(ctx) {
	const { noteSessionSnapshotHealth } = await import("./doctor-session-snapshots-4-cM5FjF.js");
...
async function runConfigAuditScrubHealth(ctx) {
	const { maybeScrubConfigAuditLog } = await import("./doctor-config-audit-scrub-BZpOSl10.js");
	await maybeScrubConfigAuditLog({ shouldRepair: ctx.prompter.shouldRepair });
}
async function runLegacyCronHealth(ctx) {
	const { maybeRepairLegacyCronStore, noteLegacyWhatsAppCrontabHealthCheck } = await import("./cron-BPwqOmBa.js");
...
async function runSandboxHealth(ctx) {
	const { maybeRepairSandboxImages, maybeRepairSandboxRegistryFiles, noteSandboxScopeWarnings } = await import("./doctor-sandbox-CTqEeC8a.js");
...
async function runGatewayServicesHealth(ctx) {
	const { maybeRepairGatewayServiceConfig, maybeScanExtraGatewayServices } = await import("./doctor-gateway-services-z19H1pSI.js");
	const { noteMacLaunchAgentOverrides, noteMacLaunchctlGatewayEnvOverrides, noteMacStaleOpenClawUpdateLaunchdJobs } = await import("./doctor-platform-notes-A-Md97fz.js");
...
async function runStartupChannelMaintenanceHealth(ctx) {
	const { maybeRunDoctorStartupChannelMaintenance } = await import("./doctor-startup-channel-maintenance-BPAezdO9.js");
...
async function runSecurityHealth(ctx) {
	const { noteInstallPolicyHealth } = await import("./doctor-install-policy-BKKV5DZm.js");
	const { noteSecurityWarnings } = await import("./doctor-security-CH9TQG5e.js");
...
async function runBrowserHealth(ctx) {
	const { noteChromeMcpBrowserReadiness } = await import("./doctor-browser-DQ4bQcRh.js");
...
async function runOpenAIOAuthTlsHealth(ctx) {
	const { noteOpenAIOAuthTlsPrerequisites } = await import("./provider-openai-chatgpt-oauth-tls-Cjkl6xAv.js");
...
async function runToolResultCapHealth(ctx) {
	...
	const { normalizeAgentId } = await import("./session-key-CbREDl8p.js");
	const targets = [];
	...
	const { resolveContextWindowInfo } = await import("./context-window-guard-B3KbYHR_.js");
	const { resolveDefaultModelForAgent, modelKey } = await loadModelSelectionModule();
	const { buildToolResultCapDoctorAdvice } = await import("./doctor-tool-result-cap-advice-Dgn2HWDR.js");
	const { note } = await loadNoteModule();
...
async function runSystemdLingerHealth(ctx) {
	...
	const { resolveGatewayService } = await import("./service-ChpSO-b_.js");
	const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-BgS1G9CQ.js");
	const { note } = await loadNoteModule();
...
async function hasActiveGatewayExecCredential(ctx, mode = resolveDoctorMode(ctx.cfg)) {
	const { resolveSecretInputRef } = await loadSecretTypesModule();
	const { gatewaySecretInputPathCanWin } = await import("./credentials-secret-inputs-CpHi5CpB.js");
...
async function runWorkspaceStatusHealth(ctx) {
	...
	if (ctx.cfg.gateway?.mode !== "remote") try {
		const { gatherDaemonStatus } = await import("./status.gather-DEf2A7ZL.js");
	...
	const { noteWorkspaceStatus } = await import("./doctor-workspace-status-BFdVXpbd.js");
	noteWorkspaceStatus(ctx.cfg, { pluginVersionDrift });
}
async function runSkillsHealth(ctx) {
	const { maybeRepairSkillReadiness } = await import("./doctor-skills-uatE-SyY.js");
...
async function runBootstrapSizeHealth(ctx) {
	const { noteBootstrapFileSize } = await import("./doctor-bootstrap-size-_SWgG7wk.js");
	await noteBootstrapFileSize(ctx.cfg);
}
async function runHeartbeatTemplateRepairHealth(ctx) {
	const { maybeRepairHeartbeatTemplate } = await import("./doctor-heartbeat-template-repair-tWZSwTds.js");
...
async function runShellCompletionHealth(ctx) {
	const { doctorShellCompletion } = await import("./doctor-completion-tI9RdsIM.js");
...
async function runGatewayHealthChecks(ctx) {
	...
	const { checkGatewayHealth, probeGatewayMemoryStatus } = await import("./doctor-gateway-health-BxyJycIT.js");
...
async function runWhatsappResponsivenessHealth(ctx) {
	const { noteWhatsappResponsivenessHealth } = await import("./doctor-whatsapp-responsiveness-Do2E1_v1.js");
...
async function runMemorySearchHealthContribution(ctx) {
	const { maybeRepairMemoryRecallHealth, noteMemoryRecallHealth, noteMemorySearchHealth } = await import("./doctor-memory-search-D0vqCTRc.js");
...
async function runDevicePairingHealth(ctx) {
	const { noteDevicePairingHealth } = await import("./doctor-device-pairing-4xS6vV5T.js");
...
async function runGatewayDaemonHealth(ctx) {
	const { maybeRepairGatewayDaemon } = await import("./doctor-gateway-daemon-flow-CJl9QJEq.js");
...
async function runWriteConfigHealth(ctx) {
	...
	const { logConfigUpdated } = await import("./logging-DGlH-53u.js");
	const { shortenHomePath } = await import("./utils-CvJzoiWJ.js");
...
async function runWorkspaceSuggestionsHealth(ctx) {
	...
	const { MEMORY_SYSTEM_PROMPT, shouldSuggestMemorySystem } = await import("./doctor-workspace-wmLOQPN4.js");
	const { note } = await loadNoteModule();
	const workspaceDir = resolveAgentWorkspaceDir(ctx.cfg, resolveDefaultAgentId(ctx.cfg));
