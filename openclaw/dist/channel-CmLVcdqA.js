...
import { c as hasConfiguredSecretInput } from "./types.secrets-BHLVnd7g.js";
...
import { i as createActionGate } from "./common-DjVgHKFa.js";
import { i as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-5wam5y3m.js";
...
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-DSBgt6Pg.js";
...
import { E as projectConfigAccountIdWarningCollector, g as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-D-OhAP34.js";
...
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-BbMLtT3s.js";
...
import "./account-resolution-CLvtZSY6.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-DNhqI-OE.js";
import { d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-CMNeqAe_.js";
...
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, n as inspectFeishuCredentials, p as isRecord$1, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-Dh85-Sao.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-D8WHkfH3.js";
import { n as createFeishuSendReceipt } from "./send-result-BYO9Dg0R.js";
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-CR2hVtVF.js";
import { i as listFeishuDirectoryPeers, r as listFeishuDirectoryGroups, t as buildFeishuPresentationCard } from "./presentation-card-DDLhVKby.js";
import { t as messageActionTargetAliases } from "./security-audit-DlIRs8RN.js";
import { s as resolveFeishuGroupToolPolicy } from "./policy-C5lvEFI7.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-BptaDDIf.js";
import { t as collectFeishuSecurityAuditFindings } from "./security-audit-shared-zcJ9AR28.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-C_lqqab5.js";
...
const loadAppRegistrationModule = async () => {
	appRegistrationModulePromise ??= import("./app-registration-DX59NC-8.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, accountId, configured }) => {
			...
			if (configured && account.configured) try {
				const { probeFeishu } = await import("./probe-BfbN2sTI.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-Cd252Uyr.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-DUclyxiv.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-XZz81NqF.js");
