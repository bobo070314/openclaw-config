...
import { a as repairOpenClawStateDatabaseSchema, c as resolveOpenClawStateSqlitePath, f as requireNodeSqlite, g as getNodeSqliteKysely, h as executeSqliteQueryTakeFirstSync, m as executeSqliteQuerySync, o as runOpenClawStateWriteTransaction, r as detectOpenClawStateDatabaseSchemaMigrations } from "./openclaw-state-db-CTUHxhwv.js";
import { l as resolveLegacyInstalledPluginIndexStorePath } from "./installed-plugin-index-record-reader-CkT3b8X-.js";
...
import { d as normalizeMainKey, i as buildAgentMainSessionKey, n as DEFAULT_MAIN_KEY, t as DEFAULT_AGENT_ID, u as normalizeAgentId } from "./session-key-BsbwBJwv.js";
import { c as resolveDefaultAgentId } from "./agent-scope-config-ChfGvhEr.js";
import "./installed-plugin-index-UYExs-Ey.js";
import { c as writePersistedInstalledPluginIndexSync, i as readPersistedInstalledPluginIndexSync, n as parseInstalledPluginIndex } from "./installed-plugin-index-store-DB_pS-jS.js";
import "./fs-safe-advanced-CBe_wA_B.js";
import { c as listBundledChannelLegacySessionSurfaces, l as listBundledChannelLegacyStateMigrationDetectors } from "./bundled-Ewhkq8Bo.js";
import { i as MAX_PLUGIN_STATE_ENTRIES_PER_PLUGIN, n as createPluginStateKeyedStore, o as countPluginStateLiveEntries } from "./plugin-state-store-B1MIwA_5.js";
...
import { s as writeAcpSessionMetaForMigration } from "./session-meta-CKXLc--x.js";
import { o as listPluginDoctorStateMigrationEntries } from "./doctor-contract-registry-CPH8HFC5.js";
...
async function autoMigrateLegacyState(params) {
	...
	if (!detected.sessions.hasLegacy && !detected.agentDir.hasLegacy && !detected.channelPlans.hasLegacy && !detected.pluginPlans?.hasLegacy && !detected.pluginStateSidecar.hasLegacy && !detected.pluginInstallIndex.hasLegacy && !detected.debugProxyCaptureSidecar.hasLegacy && !detected.stateSchema.hasLegacy && !detected.taskStateSidecars.hasLegacy && !detected.deliveryQueues.hasLegacy && !detected.execApprovals.hasLegacy) {
		const changes = [
			...stateDirResult.changes,
			...stateSchema.changes,
			...orphanKeys.changes,
