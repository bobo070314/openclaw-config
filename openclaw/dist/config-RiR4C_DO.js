...
import { f as normalizeResolvedSecretInputString, s as coerceSecretRef } from "./types.secrets-BHLVnd7g.js";
...
import "./secret-input-runtime-BQyYelLg.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-CSvjGECF.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-DB8tSKUw.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-CMaNb3Jh.js";
...
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-JO-xsXsi.js";
import { s as repairCurrentTokenStorageMetaDeviceId } from "./storage-BNBVixWW.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-DonDe6r6.js"), import("./logging-Dm9J8oK_.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-BBeerSkg.js").then((credentialsReadModule) => ({
