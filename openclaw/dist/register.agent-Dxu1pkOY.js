...
function loadAgentsBindModule() {
	return agentsBindModulePromise ??= import("./agents.commands.bind-DYyZ0DOf.js");
}
async function loadAgentsAddCommand() {
	return (await import("./agents.commands.add-9bq6ZKr2.js")).agentsAddCommand;
}
...
async function loadAgentsDeleteCommand() {
	return (await import("./agents.commands.delete-C_hJIRsH.js")).agentsDeleteCommand;
}
async function loadAgentsSetIdentityCommand() {
	return (await import("./agents.commands.identity-CN-vato-.js")).agentsSetIdentityCommand;
}
async function loadAgentsListCommand() {
	return (await import("./agents.commands.list-IT9U34V-.js")).agentsListCommand;
}
async function loadAgentsActionRuntime() {
	const [{ defaultRuntime }, { runCommandWithRuntime }] = await Promise.all([import("./runtime-Dc6wmxIA.js"), import("./cli-utils-Dkfop93D.js")]);
	return {
		defaultRuntime,
