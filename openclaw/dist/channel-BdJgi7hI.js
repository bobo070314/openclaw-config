...
import { b as readStringParam, g as readPositiveIntegerParam, i as createActionGate, t as ToolAuthorizationError } from "./common-DjVgHKFa.js";
import { l as createScopedDmSecurityResolver, t as adaptScopedAccountAccessor } from "./channel-config-helpers-5wam5y3m.js";
...
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-DSBgt6Pg.js";
import "./channel-core-scnA8FBt.js";
import "./routing-DuwrFDdF.js";
import { _ as createAllowlistProviderOpenWarningCollector, w as projectAccountConfigWarningCollector } from "./channel-policy-D-OhAP34.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-C10M9lAe.js";
...
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-CHYA76Y_.js";
import "./approval-delivery-runtime-CRuiQpiO.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-DLWtIqHq.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-BaDJBoeh.js";
import { r as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-C_6zCwmP.js";
import "./approval-native-runtime-Cb6xv145.js";
import { r as loadSessionStore } from "./session-store-runtime-DIo09ING.js";
import { w as createChannelMessageAdapterFromOutbound } from "./channel-outbound-CHb-uDxw.js";
import "./conversation-runtime-DyYrGZ1v.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-DNhqI-OE.js";
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-CMNeqAe_.js";
import "./channel-status-DMvqj2bH.js";
import "./channel-actions-Cwo0Wl2P.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-Cr6y6rdp.js";
import { t as extractToolSend } from "./tool-send-DlIp2cBO.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-CSvjGECF.js";
import { a as resolveMatrixAccountConfig } from "./account-config-CMaNb3Jh.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-C9f6yQUC.js";
import { n as normalizeMatrixUserId } from "./allowlist-CS0HW79e.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-hqLno00F.js";
import { a as isMatrixExecApprovalAuthorizedSender, c as shouldHandleMatrixApprovalRequest, d as matrixApprovalAuth, i as isMatrixApprovalClientEnabled, l as shouldSuppressLocalMatrixExecApprovalPrompt, n as getMatrixExecApprovalApprovers, o as isMatrixExecApprovalClientEnabled, r as isMatrixAnyApprovalClientEnabled, s as resolveMatrixExecApprovalTarget, t as getMatrixApprovalApprovers, u as getMatrixApprovalAuthApprovers } from "./exec-approvals-dwIGKofC.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-DgMwb7e1.js";
import { t as formatMatrixErrorMessage } from "./errors-M9uRMVNP.js";
import { n as matrixConfigAdapter, t as MatrixChannelConfigSchema } from "./config-schema-BCSnsPTQ.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-D7rUAuk7.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-BxZTi7wY.js";
import { d as setMatrixThreadBindingIdleTimeoutBySessionKey, p as setMatrixThreadBindingMaxAgeBySessionKey } from "./thread-bindings-shared-DF7nA-WP.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-Dx9ENtzL.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-C5yx_-4D.js";
import { n as matrixSetupAdapter, t as createMatrixSetupWizardProxy } from "./setup-core-mmoqIn0y.js";
...
import { n as resolveMatrixInboundConversation } from "./thread-binding-api-Cr1tKWcY.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-BkOO_VZZ.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-dGjwpVVL.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-BDw91omh.js"), "matrixChannelRuntime");
let matrixDoctorModulePromise = null;
const loadMatrixDoctorModule = async () => {
	matrixDoctorModulePromise ??= import("./doctor-C5u-Fb23.js");
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-BvcEcYVM.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
