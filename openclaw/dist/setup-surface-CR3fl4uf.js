...
import { Q as splitSetupEntries, f as createStandardChannelSetupStatus, g as createTopLevelChannelGroupPolicySetter, m as createTopLevelChannelDmPolicy, p as createTopLevelChannelAllowFromSetter, v as mergeAllowFromEntries } from "./setup-wizard-helpers-BbMLtT3s.js";
import "./setup-DGGLn4oX.js";
import "./setup-tools-BLDFCyWU.js";
import { g as saveDelegatedTokens, h as resolveMSTeamsCredentials, p as hasConfiguredMSTeamsCredentials } from "./graph-users-D0PtP01u.js";
import { c as resolveMSTeamsUserAllowlist, o as parseMSTeamsTeamEntry, s as resolveMSTeamsChannelAllowlist } from "./resolve-allowlist-Dd275_UJ.js";
import { r as formatUnknownError } from "./errors-DUs0RP-_.js";
	...
	finalize: async (params) => {
		...
		if (finalCreds?.type === "secret") {
			if (await params.prompter.confirm({
				...
				try {
					const { loginMSTeamsDelegated } = await import("./oauth-SJozAfRn.js");
