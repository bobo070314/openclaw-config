...
import { n as appendExactAssistantMessageToSessionTranscript } from "./transcript-D8-u9kVs.js";
import { t as SessionManager } from "./session-manager-C696L9Rp.js";
...
import { _ as isFailoverErrorMessage, r as classifyFailoverReason } from "./errors-BmvajW3H.js";
import { d as resolveFailoverStatus, o as isFailoverError, t as FailoverError } from "./failover-error-3to6iVLf.js";
...
import { a as finalizeHarnessContextEngineTurn, d as runAgentEndSideEffects, l as waitForDeferredTurnMaintenanceForSession, n as bootstrapHarnessContextEngine, s as runHarnessContextEngineMaintenance, u as awaitAgentEndSideEffects } from "./context-engine-lifecycle-CuZ0qH-C.js";
...
import { a as runAgentHarnessLlmInputHook, o as runAgentHarnessLlmOutputHook, s as buildAgentHookContext } from "./lifecycle-hook-helpers-v00PVIlh.js";
import { t as buildEmbeddedRunPayloads } from "./payloads-DMxgzxEO.js";
...
import { d as loadCliSessionHistoryMessages, m as buildAgentHookConversationMessages, n as claudeCliSessionTranscriptHasContent, u as loadCliSessionContextEngineMessages } from "./attempt-execution.helpers-CPpoqxHr.js";
...
async function runCliAgentInternal(params) {
	...
	if (params.cleanupCliLiveSessionOnRunEnd === true) try {
		const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-DsRO-yZ4.js");
