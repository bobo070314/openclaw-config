...
import { f as requireNodeSqlite } from "./openclaw-state-db-CTUHxhwv.js";
...
import { c as MEMORY_INDEX_META_TABLE, l as MEMORY_INDEX_SOURCES_TABLE, o as MEMORY_INDEX_CHUNKS_TABLE } from "./engine-storage-vGzu0B21.js";
...
import { i as isProbeReachable, m as pickGatewaySelfPresence } from "./helpers-D_HE2QVs.js";
import { existsSync } from "node:fs";
//#region src/commands/status.scan.shared.ts
const gatewayProbeModuleLoader = createLazyImportLoader(() => import("./status.gateway-probe-9yMyh5Xc.js"));
const probeGatewayModuleLoader = createLazyImportLoader(() => import("./probe-BLiWRGcA.js"));
const gatewayCallModuleLoader$1 = createLazyImportLoader(() => import("./call-YvNwFPLB.js"));
...
const statusAgentLocalModuleLoader = createLazyImportLoader(() => import("./status.agent-local-CvuC7Avn.js"));
const statusUpdateModuleLoader = createLazyImportLoader(() => import("./status.update-BCcR748i.js"));
const statusScanRuntimeModuleLoader = createLazyImportLoader(() => import("./status.scan.runtime.js"));
const gatewayCallModuleLoader = createLazyImportLoader(() => import("./call-YvNwFPLB.js"));
const statusSummaryModuleLoader = createLazyImportLoader(() => import("./status.summary-D-rTfm-U.js"));
const channelPluginIdsModuleLoader = createLazyImportLoader(() => import("./channel-plugin-ids-AUD18jaV.js"));
const configModuleLoader = createLazyImportLoader(() => import("./config/config.js"));
const commandConfigResolutionModuleLoader = createLazyImportLoader(() => import("./command-config-resolution-DrUDhFSo.js"));
const commandSecretTargetsModuleLoader = createLazyImportLoader(() => import("./command-secret-targets-BNebu9NL.js"));
