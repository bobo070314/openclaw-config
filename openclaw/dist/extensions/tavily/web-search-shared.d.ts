import { ic as WebSearchProviderPlugin } from "../../types-C6Y8zGKi.js";
...
declare const TAVILY_GENERIC_SEARCH_DESCRIPTION = "Search the web using Tavily. Returns structured results with snippets. Use tavily_search for Tavily-specific options like search depth, topic filtering, or AI answers.";
declare const TAVILY_GENERIC_SEARCH_SCHEMA: {
  type: string;
  properties: {
    query: {
      type: string;
