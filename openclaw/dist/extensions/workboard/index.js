...
import { n as dispatchAndStartWorkboardCards, r as WorkboardStore, t as registerWorkboardGatewayMethods } from "../../runtime-api-Dn_bRFCP.js";
...
var workboard_default = definePluginEntry({
	...
	register(api) {
		...
		api.registerCli(async ({ program }) => {
			const { registerWorkboardCli } = await import("../../cli--tptQFmK.js");
