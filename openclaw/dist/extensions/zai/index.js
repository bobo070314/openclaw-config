...
import { s as createPayloadPatchStreamWrapper, u as defaultToolStreamExtraParams, x as createToolStreamWrapper } from "../../provider-stream-shared-Bs5t-g_E.js";
...
import { t as fetchZaiUsage } from "../../provider-usage-CC7YmuGM.js";
import { l as buildZaiModelDefinition, u as resolveZaiBaseUrl } from "../../model-definitions-B7gQmjzX.js";
import { t as detectZaiEndpoint } from "../../detect-Dm_PAtOj.js";
import { t as zaiMediaUnderstandingProvider } from "../../media-understanding-provider-Dlpt14bB.js";
import { i as resolveZaiModelId, n as applyZaiConfig, r as applyZaiProviderConfig } from "../../onboard-pycqVAmj.js";
...
function isGlm52ModelId(modelId) {
	return normalizeLowercaseStringOrEmpty(modelId).startsWith("glm-5.2");
}
function mapThinkingLevelToZaiReasoningEffort(thinkingLevel) {
	switch (thinkingLevel) {
		case "low":
		case "medium":
		case "high":
		case "adaptive": return "high";
		case "xhigh":
		case "max": return "max";
		default: return;
	}
...
function wrapZaiStreamFn(ctx) {
	...
	const reasoningEffort = isGlm52ModelId(ctx.modelId) ? mapThinkingLevelToZaiReasoningEffort(ctx.thinkingLevel) : void 0;
	if (!isDisabledThinkingLevel(ctx.thinkingLevel) && !preserveThinking && !reasoningEffort) return streamFn;
...
var zai_default = definePluginEntry({
	...
	register(api) {
		api.registerProvider({
			...
			resolveThinkingProfile: (ctx) => isGlm52ModelId(ctx.modelId) ? {
				levels: [
					{
						id: "off",
						label: "off"
