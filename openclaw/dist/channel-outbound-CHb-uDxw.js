...
import "./ingress-queue-BAbyGuUg.js";
...
import "./session-context-BYC_aE0G.js";
...
import { c as resolveTextChunkLimit } from "./chunk-DiJVRejw.js";
import "./payloads-C-1aoWCs.js";
...
import "./reply-pipeline-CxqO6kKd.js";
import "./draft-stream-controls-B_BxuUDs.js";
import "./identity-CIhfgOHt.js";
...
function createChannelProgressDraftCompositor(params) {
	...
	const noteProgress = async (line, options) => {
		if (!params.active || (finalReplyStarted || finalReplyDelivered) && !options?.allowAfterFinal) return false;
...
const loadChannelMessageRuntimeModule = async () => {
	channelMessageRuntimeModulePromise ??= import("./runtime-wQIoJuV9.js");
...
const deliverInboundReplyWithMessageSendContext = async (...args) => {
	return await (await import("./kernel-B12DCyDW.js")).deliverInboundReplyWithMessageSendContext(...args);
};
