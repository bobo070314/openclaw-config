...
import { t as addGatewayRunCommand } from "./run-command-DijIGjvd.js";
...
const gatewayStatusModuleLoader = createLazyImportLoader(() => import("./gateway-status-D65u9ccE.js"));
const gatewayHealthModuleLoader = createLazyImportLoader(() => import("./health-BBqJUcXW.js"));
const bonjourDiscoveryModuleLoader = createLazyImportLoader(() => import("./bonjour-discovery-C0z7a7lQ.js"));
const wideAreaDnsModuleLoader = createLazyImportLoader(() => import("./widearea-dns-Rk3wSeTy.js"));
const healthStyleModuleLoader = createLazyImportLoader(() => import("./terminal-core/health-style.js"));
const usageFormatModuleLoader = createLazyImportLoader(() => import("./usage-format-tComkyHs.js"));
const stabilityBundleModuleLoader = createLazyImportLoader(() => import("./diagnostic-stability-bundle-CJvjWs0j.js"));
const supportExportModuleLoader = createLazyImportLoader(() => import("./diagnostic-support-export-DnoxhH4E.js"));
const daemonStatusGatherModuleLoader = createLazyImportLoader(() => import("./status.gather-DEf2A7ZL.js"));
...
async function callGatewayCli(method, opts, params) {
	return (await import("./call-D3Sgd1wM.js")).callGatewayCli(method, opts, params);
}
async function runGatewayCommand(action, label, opts) {
	try {
		...
		if (opts?.json) {
			const { formatGatewayClientRequestErrorJson, formatGatewayTransportErrorJson } = await import("./call-YvNwFPLB.js");
