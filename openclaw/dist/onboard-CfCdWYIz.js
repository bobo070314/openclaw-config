...
import { d as isValidEnvSecretRefId, g as resolveSecretInputRef } from "./types.secrets-BHLVnd7g.js";
...
import { u as readConfigFileSnapshot } from "./io-CwmOK6NP.js";
import { r as replaceConfigFile } from "./config-CxwD7EO_.js";
import { t as randomToken } from "./random-token-B1woZa_H.js";
import { r as formatInvalidPortOption } from "./error-format-DbPRORpk.js";
...
import { c as normalizeGatewayTokenInput, m as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-DAQ_zJF-.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-BFmQLfmA.js";
import { n as applySkipBootstrapConfig, t as applyLocalSetupWorkspaceConfig } from "./onboard-config-D4Jd0SHc.js";
import { t as createNonInteractiveLoggingPrompter } from "./non-interactive-prompter-DLCGsi38.js";
import { t as runSetupWizard } from "./setup-CQ2weZ63.js";
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-BRYOP5bg.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
		workspaceDir,
		env: process.env
	});
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-DVnNuiwG.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-DKoSRDBX.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-BBqJUcXW.js");
...
async function runNonInteractiveMigrationImport(params) {
	...
	const { detectSetupMigrationSources, runSetupMigrationImport } = await import("./setup.migration-import-UmXRvEMd.js");
