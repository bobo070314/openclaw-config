...
import { u as peekSystemEvents } from "./system-events-B4uVi8eM.js";
import { o as resolveCronJobsStorePath } from "./store-KOfgF9QY.js";
import { n as listGatewayAgentsBasic } from "./agent-list-DSzIvnaf.js";
...
import { t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-Bn41wS2z.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-BWKHPe8B.js";
//#region src/commands/status.summary.ts
const RECENT_SESSION_LIMIT = 10;
const channelSummaryModuleLoader = createLazyImportLoader(() => import("./channel-summary-BRpvZOyq.js"));
const channelPluginIdsModuleLoader = createLazyImportLoader(() => import("./channel-plugin-ids-AUD18jaV.js"));
const linkChannelModuleLoader = createLazyImportLoader(() => import("./status.link-channel-D0BmJ2bU.js"));
const taskRegistryMaintenanceModuleLoader = createLazyImportLoader(() => import("./task-registry.maintenance-oc6FgV59.js"));
const staticModelCatalogResolverLoader = createLazyImportLoader(async () => {
	const modelCatalog = await import("./model.static-catalog-E2koVar9.js");
	return {
