...
import { l as isSecretRef } from "./types.secrets-BHLVnd7g.js";
import { n as defaultRuntime } from "./runtime-B4lgFmsS.js";
import { t as createSubsystemLogger } from "./subsystem-BTVUlTIB.js";
import { s as normalizePluginsConfig } from "./config-state-BffrOAI6.js";
import { a as markAutoFallbackPrimaryProbe, h as resolveEffectiveModelFallbacks, i as hasLegacyAutoFallbackWithoutOrigin, m as resolveAutoFallbackPrimaryProbe, n as entryMatchesAutoFallbackPrimaryProbe, t as clearAutoFallbackPrimaryProbeSelection, v as resolveSessionAgentId, w as hasSessionAutoModelFallbackProvenance } from "./agent-scope-CESPhp3L.js";
import { a as isSubagentSessionKey } from "./session-key-utils-C7uT9A4s.js";
import { c as isUnscopedSessionKeySentinel, f as resolveAgentIdFromSessionKey, g as scopeLegacySessionKeyToAgent, s as classifySessionKeyShape, u as normalizeAgentId } from "./session-key-BsbwBJwv.js";
import { t as resolveEffectiveAgentSkillFilter } from "./agent-filter-BozWIaIt.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-ChfGvhEr.js";
import { d as readConfigFileSnapshotForWrite, i as getRuntimeConfig } from "./io-CwmOK6NP.js";
...
import { g as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-3cYUSC_N.js";
...
import { s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-B1geeVF9.js";
...
import { o as resolveMessageChannel, t as isDeliverableMessageChannel } from "./message-channel-normalize-B2zqLi2s.js";
import "./message-channel-CtiNqfW0.js";
import { r as mergeSessionEntry } from "./types-CoDcFuoc.js";
import { m as patchSessionEntry } from "./session-accessor-ArmkJJUW.js";
...
import { n as isStoredCredentialCompatibleWithAuthProvider } from "./order-BFHwZMUJ.js";
import { _ as resolveConfiguredModelRef, b as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog } from "./model-selection-shared-DXdzMPOG.js";
import { r as normalizeConfiguredProviderCatalogModelId } from "./model-ref-shared-D-17n3br.js";
import { a as normalizeModelRef, i as modelKey, o as normalizeProviderId } from "./model-selection-normalize-BvNI1t-G.js";
...
import { t as loadManifestModelCatalog } from "./model-catalog-C5hjklw2.js";
...
import { W as createTrajectoryRuntimeRecorder, t as resolveAvailableAgentHarnessPolicy } from "./selection-BfRwHcjH.js";
import { s as normalizeSpawnedRunMetadata } from "./subagent-spawn-plan-BXrUwsl9.js";
import { _ as formatAgentInternalEventsForPrompt, g as formatAgentInternalEventsForPlainPrompt } from "./subagent-announce-delivery-PPEx8SZk.js";
import { t as buildOutboundSessionContext } from "./session-context-BYC_aE0G.js";
import { r as resolveMessageChannelSelection } from "./channel-selection-CPoRizHU.js";
import { o as runWithModelFallback, p as LiveSessionModelSwitchError } from "./model-fallback-CTRdAq5q.js";
import { n as resolveSession } from "./session-5Ip-5ray.js";
import { t as getAgentRuntimeCommandSecretTargetIds } from "./command-secret-targets-B2DBte9W.js";
...
import { n as mergeEmbeddedAgentRunResultForModelFallbackExhaustion, t as classifyEmbeddedAgentRunResultForModelFallback } from "./result-fallback-classifier-DyAgXETt.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-DS7hml6X.js";
import "./live-model-switch-CzmDv9nJ.js";
import { r as resolveInlineAgentImageAttachments } from "./agent-turn-attachments-Dr1HdexD.js";
import { r as createChatRunEntry } from "./server-chat-state-COF_MGQr.js";
import { t as clearSessionAuthProfileOverride } from "./session-override-DjCHXj1I.js";
import { t as NodeRegistry } from "./node-registry-BZLqTDQ7.js";
import { r as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-DgPXdJKV.js";
import { n as applyVerboseOverride } from "./level-overrides-ZOPbDJud.js";
import { t as resolveAgentRunContext } from "./run-context-CGH9NsZ9.js";
...
const acpPolicyRuntimeLoader = createLazyImportLoader(() => import("./policy-D7h0en27.js"));
const acpRuntimeErrorsRuntimeLoader = createLazyImportLoader(() => import("./errors-CpHXxWAS.js"));
...
const cliCompactionRuntimeLoader = createLazyImportLoader(() => import("./cli-compaction-D-tEg7Y-.js"));
const transcriptResolveRuntimeLoader = createLazyImportLoader(() => import("./transcript-resolve.runtime.js"));
const cliDepsRuntimeLoader = createLazyImportLoader(() => import("./deps-CGe5oXyi.js"));
const execDefaultsRuntimeLoader = createLazyImportLoader(() => import("./exec-defaults-BHWfQL44.js"));
const skillsRuntimeLoader = createLazyImportLoader(async () => {
	const [remote, sessionSnapshot] = await Promise.all([import("./remote-BTzRL3Fg.js"), import("./session-snapshot-7CBzE6k9.js")]);
	return {
