...
import { d as writeStorageMeta, l as resolveMatrixStoragePaths, r as maybeMigrateLegacyStorage } from "./storage-BNBVixWW.js";
import "./config-RiR4C_DO.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-DonDe6r6.js"), import("./logging-Dm9J8oK_.js")]).then(([sdkModule, loggingModule]) => ({
