...
import { r as loadCrestodianOverview, t as formatCrestodianOverview } from "./overview-D6HVbtsj.js";
import { r as resolveCrestodianOperation } from "./dialogue-PHlMVz39.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-CEbLQgzi.js")).runCrestodianTui;
	opts.onReady?.();
