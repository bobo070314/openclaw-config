...
import { r as isMockedFetch, t as fetchWithRuntimeDispatcher } from "./runtime-fetch-XsbYKq6O.js";
...
async function captureGuardedFetchExchange(params) {
	...
	const { captureHttpExchange, isDebugProxyGlobalFetchPatchInstalled } = await import("./runtime-B8vNArbK.js");
