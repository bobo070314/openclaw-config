...
import { _ as resolveGatewaySessionStoreTargetWithStore, d as migrateAndPruneGatewaySessionStoreKey, i as filterAndSortSessionEntries, p as resolveDeletedAgentIdFromSessionKey, s as listSessionsFromStore } from "./session-utils-B4hOl7Zv.js";
...
async function resolveSessionKeyFromResolveParams(params) {
	...
	if (hasKey) {
		...
		if (!legacyKey) return noSessionFoundResult({
			p,
			message: `No session found: ${key}`
		});
