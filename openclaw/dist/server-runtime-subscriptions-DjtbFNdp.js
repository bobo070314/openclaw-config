...
function startGatewayEventSubscriptions(params) {
	...
	const getAgentEventHandler = () => {
		agentEventHandlerPromise ??= Promise.all([import("./server-chat-B2RxD6QV.js"), import("./server-session-key-ClO6jKTy.js")]).then(([{ createAgentEventHandler }, { resolveSessionKeyForRun }]) => createAgentEventHandler({
	...
	const getSessionEventsModule = () => {
		sessionEventsModulePromise ??= import("./server-session-events-BiHWi5AI.js");
