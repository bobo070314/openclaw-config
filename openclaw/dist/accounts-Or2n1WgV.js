...
import { f as normalizeResolvedSecretInputString, p as normalizeSecretInputString } from "./types.secrets-BHLVnd7g.js";
...
import { C as resolveChannelStreamingChunkMode, S as resolveChannelStreamingBlockEnabled, m as resolveChannelPreviewStreamMode, x as resolveChannelStreamingBlockCoalesce } from "./streaming-Dgx_j8xT.js";
...
function resolveMattermostReplyDeliveryBarrierTimeoutMs(params) {
	if (!params.isDirect) return;
	...
	const maxDelayMs = params.dmRetryOptions?.maxDelayMs ?? 1e4;
	const timeoutMs = params.dmRetryOptions?.timeoutMs ?? 3e4;
	const perDeliveryTimeoutMs = (maxRetries + 1) * timeoutMs + maxRetries * maxDelayMs + DM_REPLY_DELIVERY_BARRIER_SLACK_MS;
...
//#endregion
export { readMattermostError as _, MattermostPostSchema as a, updateMattermostPost as b, createMattermostPost as c, fetchMattermostChannelByName as d, fetchMattermostMe as f, normalizeMattermostBaseUrl as g, fetchMattermostUserTeams as h, resolveMattermostReplyToMode as i, deleteMattermostPost as l, fetchMattermostUserByUsername as m, resolveDefaultMattermostAccountId as n, createMattermostClient as o, fetchMattermostUser as p, resolveMattermostAccount as r, createMattermostDirectChannelWithRetry as s, listMattermostAccountIds as t, fetchMattermostChannel as u, resolveMattermostReplyDeliveryBarrierTimeoutMs as v, uploadMattermostFile as x, sendMattermostTyping as y };
