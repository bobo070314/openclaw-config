...
import { B as MANAGED_MEMORY_DREAMING_CRON_TAG, G as resolveMemoryDeepDreamingConfig, V as MEMORY_DREAMING_SYSTEM_EVENT_TEXT, W as resolveMemoryCorePluginConfig, Y as resolveMemoryDreamingWorkspaces, z as MANAGED_MEMORY_DREAMING_CRON_NAME } from "./dreaming-BRPVM_Jj.js";
import { l as peekSystemEventEntries } from "./system-events-B4uVi8eM.js";
...
import { n as normalizeTrimmedString, t as includesSystemEventToken } from "./dreaming-shared-Dy45FnmC.js";
...
async function runShortTermDreamingPromotionIfTriggered(params) {
	...
	const [{ writeDeepDreamingReport }, { appendFallbackNarrativeEntry, generateAndAppendDreamNarrative, runDetachedDreamNarrative }, { runDreamingSweepPhases }, { applyShortTermPromotions, repairShortTermPromotionArtifacts, rankShortTermPromotionCandidates }] = await Promise.all([
		import("./dreaming-markdown-CVzYIDtr.js"),
		import("./dreaming-narrative-Cx_WHc2w.js"),
		import("./dreaming-phases-BVCJDtbj.js"),
		import("./short-term-promotion-BNT6DeIB.js")
	]);
