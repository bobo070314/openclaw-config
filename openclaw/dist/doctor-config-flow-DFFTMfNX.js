...
import { c as isRecord$1 } from "./utils-BmpsSbZo.js";
import { h as parseLegacySecretRefEnvMarker, i as LEGACY_SECRETREF_ENV_MARKER_PREFIX } from "./types.secrets-BHLVnd7g.js";
...
import { i as setPathExistingStrict } from "./path-utils-BMoAjY_I.js";
import { n as discoverConfigSecretTargets } from "./target-registry-BEVFToEa.js";
import { R as resolveNormalizedProviderModelMaxTokens } from "./io-CwmOK6NP.js";
import { _ as collectConfiguredModelRefs } from "./gateway-startup-speech-providers-BrMRI0Fu.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-BIKs-96s.js";
import { r as getBundledChannelPlugin, s as hasBundledChannelPackageSetupFeature } from "./bundled-Ewhkq8Bo.js";
import { n as formatConfigIssueLines } from "./issue-format-RCKTtsD6.js";
import { r as normalizeTalkSection } from "./talk-BEX_7hGR.js";
import { c as callGateway } from "./call-I2mAoaxp.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-BLr0xI7e.js";
...
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-DdXA2GS7.js";
import { a as legacyRuntimeModelAliasRequiresRuntimePolicy, i as migrateLegacyXSearchConfig, o as listLegacyRuntimeModelProviderAliases, r as migrateLegacyWebSearchConfig, s as migrateLegacyRuntimeModelRef } from "./legacy-config-migrations-BjIXqVub.js";
import { c as mergeMissing, r as isLegacyModelsAddCodexMetadataModel } from "./legacy-config-migrations.runtime.models-B9r-S49F.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-4gGu1Uzn.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-Cs5HKly-.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-C6Js2Qi7.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-DNjXO86M.js");
	...
	const { collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-nRvOooFg.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-T3F8--mV.js");
	...
	const { repairHooksTokenReuseGatewayAuth } = await import("./hooks-token-reuse-repair-D2QKBYC6.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-BiD9PCC_.js");
		...
		const { collectDoctorPreviewNotes } = await import("./preview-warnings-BSiLKROL.js");
