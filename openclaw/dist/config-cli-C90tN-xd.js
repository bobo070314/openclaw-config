...
import { d as isValidEnvSecretRefId, g as resolveSecretInputRef, s as coerceSecretRef } from "./types.secrets-BHLVnd7g.js";
...
import { a as isValidFileSecretRefId, i as isValidExecSecretRefId, l as secretRefKey, o as isValidSecretProviderAlias, r as formatExecSecretRefIdValidationMessage, u as validateExecSecretRefId } from "./ref-contract-DdmKY2cF.js";
import { a as resolveSecretRefValue, l as resolveSecretProviderIntegrationConfig, s as isPluginIntegrationSecretProviderConfig } from "./resolve-BVr8MotQ.js";
import { n as normalizeAgentModelRefForConfig, t as normalizeAgentModelMapForConfig } from "./model-input-CIqVjBTV.js";
import { T as SecretProviderSchema } from "./zod-schema.core-BStpLG1W.js";
...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-BEVFToEa.js";
import { n as info, o as success, s as warn, t as danger } from "./globals-Cjirhr4c.js";
import { K as AUTO_MANAGED_CONFIG_META_PATHS, S as collectUnsupportedSecretRefPolicyIssues, T as validateConfigObjectRawWithPlugins, u as readConfigFileSnapshot } from "./io-CwmOK6NP.js";
...
import { s as formatStrictJsonParseFailure } from "./error-format-DbPRORpk.js";
import { n as formatPluginPackagingRuntimeOutputRecoveryHint } from "./config-recovery-hints-CfZXUgMZ.js";
...
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-DI5GlGOE.js";
import { n as setCommandJsonMode } from "./json-mode-1tPcGdTw.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-D8wtn5hA.js");
