...
import { p as InboundEventKind } from "./templating-C0ehoyWm.js";
import { s as AuthProfileStore } from "./types-Cjzcf7VM.js";
import { o as ChannelAgentTool } from "./types.core-CrBFyVDB.js";
import { t as OperatorScope } from "./operator-scopes-Phea7r7e.js";
import { P as PluginHookContextWindowSource, X as PluginHookLlmInputEvent, Z as PluginHookLlmOutputEvent, d as PluginHookAgentEndEvent, f as PluginHookBeforeAgentFinalizeEvent, ln as PluginHookBeforeAgentStartResult, u as PluginHookAgentContext } from "./hook-types-B1sEtxPP.js";
import { $i as OpenClawAgentToolResult, Ai as CodexAppServerToolResultEvent, Ba as EmbeddedRunAttemptParams, Di as CodexAppServerExtensionContext, Eo as ContextEngineRuntimeContext, Ha as PreemptiveCompactionRoute, Ji as AgentToolResultMiddlewareEvent, Ka as AgentRuntimePlan, Kc as ProviderRuntimeModel, Ki as AgentToolResultMiddleware, Mc as ExecToolDefaults, Oi as CodexAppServerExtensionFactory, To as ContextEnginePromptCacheInfo, Ua as NormalizedUsage, Va as EmbeddedRunAttemptResult, Za as ToolOutcomeObserver, _o as CompactResult, hc as EmbeddedRunTrigger, ho as AssembleResult, il as MessagingToolSend, ko as ContextEngineRuntimeSettings, ni as ProcessToolDefaults, no as requestDeferredPluginToolApproval, qa as BuildAgentRuntimePlanParams, qc as ProviderRuntimePluginHandle, qi as AgentToolResultMiddlewareContext, vo as ContextEngine, zo as TranscriptRewriteResult } from "./types-C6Y8zGKi.js";
...
import { Dr as ToolDefinition } from "./index-Bp761AFF.js";
import { t as SubsystemLogger } from "./subsystem-CfQVin8T.js";
import { t as ModelAuthMode } from "./model-auth-BQESTSNw.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-B6JyVY7U.js";
import { P as SandboxContext } from "./sandbox-BWNwJa-S.js";
import { c as EmbeddedAgentQueueMessageOptions } from "./runs-CpE0Keno.js";
import { n as ContextEngineHostSupport } from "./host-compat-CEUda-Q5.js";
import { t as BundleMcpDiagnostic } from "./bundle-mcp-DABlFCpS.js";
import { t as PluginToolMcpMeta } from "./tools-BmxaoHNF.js";
