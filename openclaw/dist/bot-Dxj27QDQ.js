...
import { a as formatUncaughtError, i as formatErrorMessage } from "./errors-DNvW4XW_.js";
...
import { r as getChildLogger } from "./logger-BfNItX-e.js";
import { t as createSubsystemLogger } from "./subsystem-BTVUlTIB.js";
import { n as normalizeAccountId } from "./account-id-5IgE9UKY.js";
import { h as sanitizeAgentId, i as buildAgentMainSessionKey, m as resolveThreadSessionKeys } from "./session-key-BsbwBJwv.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-config-ChfGvhEr.js";
import { a as shouldLogVerbose, r as logVerbose, s as warn, t as danger } from "./globals-Cjirhr4c.js";
import { i as getRuntimeConfig } from "./io-CwmOK6NP.js";
import { i as getRuntimeConfigSnapshot } from "./runtime-snapshot-D93_HOsR.js";
import { t as mutateConfigFile } from "./config-CxwD7EO_.js";
import { u as fireAndForgetHook } from "./hook-runner-global-Bm5WihiA.js";
import { c as isReplyPayloadNonTerminalToolErrorWarning, o as getReplyPayloadTtsSupplement, r as buildTtsSupplementMediaPayload, s as isFastModeAutoProgressPayload } from "./reply-payload-DHGEQ5Iy.js";
import { t as createDedupeCache } from "./dedupe-DnzL4okR.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-eGNEjFJ2.js";
import { s as resolveSessionTranscriptPathInDir, u as resolveStorePath } from "./paths-BcGVZo_k.js";
...
import { j as appendSessionTranscriptMessage, z as resolveAndPersistSessionFile } from "./session-accessor-ArmkJJUW.js";
...
import { n as resolveThinkingDefaultWithRuntimeCatalog } from "./model-thinking-default-CJ6WM7K-.js";
...
import { n as isAbortRequestText } from "./abort-primitives-aPROyEVZ.js";
import { t as hasControlCommand } from "./command-detection-Disuyxxo.js";
import { d as stripReasoningTagsFromText, g as isInsideCode, h as findCodeRegions } from "./assistant-visible-text-BHMfGmSN.js";
...
import { i as toInternalMessageReceivedContext } from "./message-hook-mappers-DsSZ9hKY.js";
...
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy-DPWbhdfw.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-CuA-4bFM.js";
import { n as firstDefined } from "./allow-from-o-cfFFcK.js";
import { n as MediaFetchError } from "./fetch-BW9kEN7m.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-DjdsAoVF.js";
import { t as resolveAckReaction } from "./identity-Ds4isHGf.js";
import { t as deriveDurableFinalDeliveryRequirements } from "./capabilities-tytC94t4.js";
import { A as resolveTranscriptBackedChannelFinalText, D as resolveChannelStreamingPreviewToolProgress, S as resolveChannelStreamingBlockEnabled, d as isPotentialTruncatedFinal, i as buildChannelProgressDraftLineForEntry, j as selectLongerFinalText, r as buildChannelProgressDraftLine } from "./streaming-Dgx_j8xT.js";
...
import { h as resolveChannelConfigWrites } from "./channel-config-helpers-5wam5y3m.js";
import { s as formatReasoningMessage } from "./embedded-agent-utils-BTlpSKRO.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-Dajvsx8b.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-zb2mAAVM.js";
...
import "./runtime-config-snapshot-DnN2-p07.js";
...
import { c as parseCommandArgs, i as formatCommandArgMenuTitle, n as buildCommandTextFromArgs, o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-CVJMMTFc.js";
import { i as matchesMentionWithExplicit, n as buildMentionRegexes, t as CURRENT_MESSAGE_MARKER } from "./mentions-DUXOWff4.js";
import { n as resolveStoredModelOverride } from "./stored-model-override-BHFUrpM3.js";
import { o as normalizeTelegramApiRoot, r as resolveTelegramTransport } from "./fetch-CtzRXgnh.js";
import { a as isRecoverableTelegramNetworkError, c as isTelegramEditTargetMissingError, h as readTelegramRetryAfterMs, l as isTelegramMessageHasNoTextError, m as isTelegramServerError, p as isTelegramRateLimitError } from "./request-timeouts-BV2GIZUu.js";
...
import { t as resolveMarkdownTableMode } from "./markdown-tables-DMVr06Lu.js";
import { a as readChannelAllowFromStore, d as upsertChannelPairingRequest } from "./pairing-store-Bgc-ubwP.js";
import "./channel-policy-D-OhAP34.js";
import "./reply-history-DDmYe8Zf.js";
import { m as parseExecApprovalCommandText } from "./exec-approval-reply-BtzijiyX.js";
import "./approval-reply-runtime-YkJDP7ay.js";
import { i as patchSessionEntry, n as listSessionEntries, o as updateSessionStoreEntry, r as loadSessionStore, t as getSessionEntry } from "./session-store-runtime-DIo09ING.js";
import { t as resolveChannelContextVisibilityMode } from "./context-visibility-J_Lhn2al.js";
import { n as resolveNativeCommandsEnabled, r as resolveNativeSkillsEnabled, t as isNativeCommandsExplicitlyDisabled } from "./commands-C5vOa8f-.js";
import "./config-mutation-gFjxOw0w.js";
import { t as listSkillCommandsForAgents } from "./chat-commands-520jUhKl.js";
import { n as isBtwRequestText } from "./btw-command-McMuk4HY.js";
import { t as generateConversationLabel } from "./conversation-label-generator-Bi9LiAM_.js";
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./reply-dispatch-runtime-BXxV22cN.js";
import "./reply-chunking-Cr021qOs.js";
import { f as runChannelInboundEvent } from "./inbound-reply-dispatch-DqkVwhLL.js";
import { a as resolveChannelDraftStreamingChunking, c as createMessageReceiveContext, i as createChannelProgressDraftCompositor } from "./channel-outbound-CHb-uDxw.js";
...
import "./model-session-runtime-CHNcJIyy.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute } from "./binding-routing-DlasBIGx.js";
import "./conversation-runtime-DyYrGZ1v.js";
import "./agent-runtime-Dq0mxT36.js";
import { i as createInteractiveConversationBindingHelpers, r as dispatchPluginInteractiveHandler } from "./plugin-runtime-BrqvMehl.js";
import "./agent-harness-runtime-DmXrkZSs.js";
import "./hook-runtime-BtvhROj6.js";
import "./markdown-table-runtime--F-ImkZt.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-wTaAtwnT.js";
import { t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-BZpcaBLu.js";
import { n as formatModelsAvailableHeader } from "./commands-models-COlM4qCS.js";
import "./command-auth-native-IFmI8urX.js";
import "./command-primitives-runtime-_bozTfGD.js";
import "./command-status-KbcjH7xU.js";
import "./command-detection-CFkfCfyj.js";
import "./command-surface-CFcWzPhG.js";
import { i as resolveUnmentionedGroupInboundPolicy, l as shouldDebounceTextInbound, o as formatLocationText, r as classifyChannelInboundEvent, s as toLocationContext } from "./channel-inbound-Bl4qL4ZS.js";
import { a as DEFAULT_TIMING, i as DEFAULT_EMOJIS } from "./channel-feedback-CVLJbdV5.js";
import "./channel-mention-gating-UdYyUg8n.js";
import { n as createChannelIngressResolver, o as defineStableChannelIngressIdentity } from "./message-access-CeqV-XzC.js";
import "./channel-ingress-runtime-WZoA_t1N.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-Cr6y6rdp.js";
import "./models-provider-runtime-DA6nGT_Z.js";
import "./skill-commands-runtime-B5zmGdvc.js";
import "./native-command-config-runtime-VoJClY5P.js";
import { t as mergeTelegramAccountConfig } from "./account-config-Dztc81K9.js";
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-SZxT7H6n.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-C158QQ2a.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-CNDyIBub.js";
import { $ as resolveTelegramDmAllow, A as resolveTelegramCommandAuthorization, B as withResolvedTelegramForumFlag, C as buildTypingThreadParams, D as loadTelegramPairingStoreIfNeeded, E as isTelegramCommandsAllowFromConfigured, F as resolveTelegramMessageForumFlagHint, G as hasBotMention, H as buildSenderName, I as resolveTelegramReplyId, J as renderTelegramTextEntities, L as resolveTelegramStreamMode, M as resolveTelegramForumFlag, N as resolveTelegramForumThreadId, P as resolveTelegramGroupAllowFromContext, Q as expandTelegramAllowFromWithAccessGroups, R as resolveTelegramThreadSpec, S as buildTelegramThreadParams, T as extractTelegramForumFlag, U as extractTelegramLocation, V as buildSenderLabel, W as getTelegramTextParts, X as resolveTelegramPrimaryMedia, Z as resolveTelegramRichMessagePlaceholder, _ as buildTelegramGroupFrom, b as buildTelegramParentPeer, c as buildTelegramConversationContext, et as isSenderAllowed, g as buildGroupLabel, h as TelegramPairingStoreReadError, i as recordSentMessage, j as resolveTelegramDirectPeerId, k as resolveTelegramBotHasTopicsEnabled, l as buildTelegramReplyChain, m as resolveTelegramMessageCacheScope, nt as normalizeDmAllowFromWithStore, q as normalizeForwardedContext, rt as resolveTelegramEffectiveDmPolicy, tt as normalizeAllowFrom, u as createTelegramMessageCache, v as buildTelegramGroupPeerId, w as describeReplyTarget, x as buildTelegramRoutingTarget, y as buildTelegramInboundOriginTarget, z as shouldUseTelegramDmThreadSession } from "./sent-message-cache-BooN40ue.js";
...
import { s as renderTelegramHtmlText } from "./format-D1xgJGJZ.js";
import { t as loadTelegramSendModule } from "./send-runtime-D2JgclKX.js";
import { t as TELEGRAM_TEXT_CHUNK_LIMIT } from "./outbound-adapter-DcLaKE_u.js";
...
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-B-k4pJu7.js";
import { c as commitTelegramMessageDispatchReplay, f as releaseTelegramMessageDispatchReplay, l as createTelegramMessageDispatchReplayGuard, s as claimTelegramMessageDispatchReplay, u as forgetTelegramMessageDispatchReplay } from "./message-dispatch-dedupe-CNQC2KNA.js";
import { r as cacheSticker } from "./sticker-cache-store-CVlGg4cS.js";
import { r as createTelegramThreadBindingManager } from "./thread-bindings-CJUjFv5C.js";
import { n as getTopicName, o as resolveTopicNameCacheScope, s as updateTopicName } from "./topic-name-cache-C7HdiXmc.js";
import { t as describeStickerImage } from "./sticker-cache-BBicyYRM.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-BfWnHCGH.js";
import { A as recordOutboundMessageForPromptContext, B as Bot, F as resolveTelegramClientTimeoutSeconds, H as sequentialize, I as resolveTelegramOutboundClientTimeoutFloorSeconds, M as asTelegramClientFetch, N as createTelegramClientFetch, P as resolveTelegramClientTimeoutMinimumSeconds, R as withTelegramApiErrorLogging, V as apiThrottler, _ as TELEGRAM_RICH_TEXT_LIMIT, a as editMessageTelegram, j as buildInlineKeyboard, v as buildTelegramRichHtml, w as splitTelegramRichMarkdownChunks, y as buildTelegramRichMarkdown, z as getOrCreateAccountThrottler } from "./send-B-QsV5Qz.js";
import { t as beginTelegramInboundEventDeliveryCorrelation } from "./inbound-event-delivery-CNR-dgbp.js";
import { a as buildPluginTelegramMenuCommands, i as buildCappedTelegramMenuCommands, n as resolveTelegramExecApproval, o as syncTelegramMenuCommands, r as createTelegramDraftStream, t as defaultTelegramBotDeps } from "./bot-deps-Ced6dKOq.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-D90LPJnY.js";
	...
	const buildPromptContextForMessage = async (ctx, msg, replyChainNodes, options, mediaByMessageId) => {
		...
		return conversationContext.length > 0 ? [{
			...
			payload: {
				...
				messages: conversationContext.map((entry) => toPromptContextMessage(entry.node, { replyTarget: entry.isReplyTarget }, entry.node.messageId ? mediaByMessageId?.get(entry.node.messageId) : void 0))
			}
		}] : [];
	};
...
function renderTelegramProgressDraftPreview(text, lines, richMessages) {
	...
	const html = (heading?.trim() ? [`<b>${escapeTelegramProgressHtml(heading.trim())}</b>`, ...renderedLines] : renderedLines).join("<br>");
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts, retryDispatchErrors = false, suppressFailureFallback = false }) => {
	...
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-CBxUidbt.js")).defaultTelegramBotDeps;
