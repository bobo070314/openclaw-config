...
import { i as formatErrorMessage$1 } from "./errors-DNvW4XW_.js";
...
import { a as saveRemoteMedia, i as readRemoteMediaBuffer } from "./fetch-BW9kEN7m.js";
...
import "./runtime-api-DLV_c1zd.js";
import { c as validateUrbitBaseUrl, d as formatTargetHint, f as normalizeShip, h as resolveTlonOutboundTarget, m as parseTlonTarget, p as parseChannelNest, s as normalizeUrbitHostname, u as resolveTlonAccount } from "./setup-core-BRHVXNFs.js";
import { t as getTlonRuntime } from "./runtime-ln2gtCac.js";
import { t as tlonSetupWizard } from "./setup-surface-s4tBUnz7.js";
...
var require_dist_cjs$5 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const remoteProvider = async (init) => {
		...
		if (process.env[ENV_CMDS_RELATIVE_URI] || process.env[ENV_CMDS_FULL_URI]) {
			...
			const { fromHttp } = await import("./dist-cjs-Bp0J3E_X2.js").then((m) => /* @__PURE__ */ __toESM(m.default));
...
`);
		...
		async (awsIdentityProperties) => {
			...
			const { fromIni } = await import("./dist-cjs-Dh2ipDBw2.js").then((m) => /* @__PURE__ */ __toESM(m.default));
			return fromIni(init)(awsIdentityProperties);
		},
		async (awsIdentityProperties) => {
			init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromProcess");
			const { fromProcess } = await import("./dist-cjs-DJBb9-fe2.js").then((m) => /* @__PURE__ */ __toESM(m.default));
