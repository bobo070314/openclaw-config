...
import { n as loadInstalledPluginIndexInstallRecordsSync, t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-CkT3b8X-.js";
...
import { f as resolveGatewayRestartDeferralTimeoutMs, m as setGatewaySigusr1RestartPolicy, o as deferGatewayRestartUntilIdle, s as emitGatewayRestart } from "./restart-BHEJqkjr.js";
import { a as resetModelCatalogCache, n as loadModelCatalog } from "./model-catalog-C5hjklw2.js";
import { r as clearCurrentProviderAuthState } from "./model-provider-auth-state-DW_JYm-o.js";
import { i as warmCurrentProviderAuthStateOffMainThread } from "./model-provider-auth-CkTnaoiy.js";
...
import { a as refreshContextWindowCache } from "./context-jzOtrNWM.js";
...
import { r as disposeAllSessionMcpRuntimes } from "./agent-bundle-mcp-runtime-BcscePMD.js";
import "./agent-bundle-mcp-tools-CAlLtgQ_.js";
import { n as clearSecretsRuntimeSnapshot, o as getActiveSecretsRuntimeSnapshot } from "./runtime-state-C7vELydH.js";
import { r as resetDirectoryCache } from "./target-resolver-B2SNo4ZS.js";
...
import { v as resolveHooksConfig } from "./hooks-DtBQLMXT.js";
import { n as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-CgroQkWo.js";
import { a as diffConfigPaths, n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-BEGf5Kr-.js";
...
import { t as buildGatewayCronService } from "./server-cron-FMtfxqjb.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-B1uJx9iD.js";
import { t as startGatewayChannelHealthMonitor } from "./server-runtime-startup-services-BQWgFw3S.js";
import { i as startGatewayCronWithLogging } from "./server-runtime-services-CDS9uE4U.js";
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-DPbWxWMB.js"), import("./gmail-watcher-lifecycle-BjEvb_Ca.js")]);
