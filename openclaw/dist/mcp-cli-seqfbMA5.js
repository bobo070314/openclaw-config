...
import { r as extractFirstTextBlock } from "./chat-message-content-DacpWQXQ.js";
import { _ as buildMcpHttpFetch, g as runMcpOAuthLogin, h as readMcpOAuthCredentialsStatus, m as clearMcpOAuthCredentials, n as createSessionMcpRuntime, p as resolveMcpTransportConfig, v as withSameOriginMcpHttpHeaders, y as withoutMcpAuthorizationHeader } from "./agent-bundle-mcp-runtime-BcscePMD.js";
import { t as buildBundleMcpToolsFromCatalog } from "./agent-bundle-mcp-materialize-B37ytUfj.js";
import { a as updateConfiguredMcpServerTools, i as updateConfiguredMcpServer, n as setConfiguredMcpServer, o as parseConfigValue, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-B5rqtEto.js";
import { t as resolveGatewayAuthOptions } from "./gateway-secret-options-B6Q136xE.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-BZK2-t_V.js"),
			import("./client-DuJyC5P4.js"),
