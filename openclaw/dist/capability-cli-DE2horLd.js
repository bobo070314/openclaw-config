...
import { a as resolveAgentDir, c as resolveDefaultAgentId } from "./agent-scope-config-ChfGvhEr.js";
...
import { p as normalizeThinkLevel } from "./thinking-3cYUSC_N.js";
...
import { _ as randomIdempotencyKey, c as callGateway } from "./call-I2mAoaxp.js";
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-CE7tKlWm.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-CS3xdS-V.js";
import { c as loadAuthProfileStoreForRuntime, m as updateAuthProfileStoreWithLock } from "./store-DcJR3uqo.js";
import { D as registerMemoryEmbeddingProvider, T as listMemoryEmbeddingProviders } from "./registry-BmAQAf7L.js";
...
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-60FiczuZ.js";
import { n as loadModelCatalog } from "./model-catalog-C5hjklw2.js";
import { u as saveMediaBuffer } from "./store-C8gpb2Gk.js";
import { a as convertHeicToJpeg, s as getImageMetadata } from "./image-ops-D2XDf2Zy.js";
import { d as resolveApiKeyForProvider } from "./model-auth-GMzbnR3o.js";
...
import { t as buildExplicitSessionIdSessionKey } from "./session-5Ip-5ray.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-DdoeP7fs.js";
import { a as getCapabilityWebSearchCommandSecretTargets, c as getMemoryEmbeddingCommandSecretTargetIds, l as getModelsCommandSecretTargetIds, m as getTtsCommandSecretTargetIds, r as getCapabilityWebFetchCommandSecretTargets } from "./command-secret-targets-B2DBte9W.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-BegFbQId.js";
import { o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-CjJjVAva.js";
import { S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, d as listSpeechVoices, f as listTtsPersonas, g as resolveTtsConfig, k as textToSpeech, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, w as setTtsPersona } from "./tts-runtime-CgK0Rof4.js";
import "./tts-CnVlRJLm.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-jwX-r6Si.js";
import { a as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-D_OoDgld.js";
import { n as listEmbeddingProviders } from "./embedding-provider-runtime-N4CIQmxQ.js";
import { t as resolveMemorySearchConfig } from "./memory-search-DyUMBOmm.js";
import { n as listWebFetchProviders, r as resolveWebFetchDefinition, t as isWebFetchProviderConfigured } from "./runtime-s9bsx_Q_.js";
...
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-Bp42Kpc0.js";
import { o as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-_Z6PJpv7.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-9oGtCrE0.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-DihYX4EW.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-BKEzgVcq.js");
