...
import { m as resolveUserPath } from "./utils-BmpsSbZo.js";
...
import { r as hasConfiguredModelFallbacks, y as resolveSessionAgentIds } from "./agent-scope-CESPhp3L.js";
...
import { i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore } from "./store-DcJR3uqo.js";
...
import { a as getReplyPayloadMetadata, i as copyReplyPayloadMetadata, t as FAST_MODE_AUTO_PROGRESS_KIND } from "./reply-payload-DHGEQ5Iy.js";
import { o as resolveContextEngine, s as resolveContextEngineOwnerPluginId } from "./registry-BFS9LOHl.js";
import { u as resolveStorePath } from "./paths-BcGVZo_k.js";
import { i as isMarkdownCapableMessageChannel } from "./message-channel-CtiNqfW0.js";
import { O as updateSessionEntry } from "./session-accessor-ArmkJJUW.js";
import "./sessions-BoPlPkQh.js";
import { a as resolveProviderAuthProfileId } from "./provider-hook-runtime-kjUY4t_q.js";
import { y as prepareProviderRuntimeAuth } from "./provider-runtime-Li1kHuDF.js";
import "./auth-profiles-1uAhtKBU.js";
import { n as markAuthProfileSuccess } from "./profiles-BwfiFFgM.js";
import { r as resolveSubscriptionAuthModeForProfiles } from "./profile-list-JYs96RWi.js";
import { o as isProfileInCooldown } from "./usage-state-glPP7WfI.js";
import { i as resolveAuthProfileOrder, r as resolveAuthProfileEligibility } from "./order-BFHwZMUJ.js";
import { t as applyPreparedRuntimeAuthToModel } from "./provider-request-config-s_yn8lQ_.js";
...
import { a as markAuthProfileFailure, s as resolveProfilesUnavailableReason } from "./usage-d4Sh6AQP.js";
...
import { a as getApiKeyForModel, g as shouldPreferExplicitConfigApiKeyAuth, n as applyLocalNoAuthHeaderOverride, t as applyAuthHeaderOverride } from "./model-auth-GMzbnR3o.js";
import { n as formatFastModeAutoProgressText, u as resolveFastModeForElapsed } from "./fast-mode-BhVbWk_p.js";
import { n as formatBillingErrorMessage, y as isTimeoutErrorMessage } from "./sanitize-user-facing-text-DLYR-7y_.js";
import "./runs-pVtbFfgt.js";
...
import "./fast-mode-BhUUmslZ.js";
import { i as enqueueCommandInLane, s as getCommandLaneSnapshot } from "./command-queue-Cn3ZuyZZ.js";
import { D as parseImageSizeError, E as parseImageDimensionError, S as isRateLimitAssistantError, _ as isFailoverErrorMessage, c as formatAssistantErrorText, d as isAuthAssistantError, f as isBillingAssistantError, g as isFailoverAssistantError, m as isCompactionFailureError, n as classifyAssistantFailoverReason, r as classifyFailoverReason, s as extractObservedOverflowTokenCount, v as isGenericUnknownStreamErrorMessage, x as isLikelyContextOverflowError } from "./errors-BmvajW3H.js";
import { a as describeFailoverError, d as resolveFailoverStatus, i as coerceToFailoverError, t as FailoverError } from "./failover-error-3to6iVLf.js";
import { n as OPENCLAW_EMBEDDED_CONTEXT_ENGINE_HOST } from "./host-compat-BibWlia2.js";
import { A as shouldWarnEmbeddedRunStageSummary, B as shouldRetrySilentErrorAssistantTurn, C as createUsageAccumulator, D as EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE, F as resolveReasoningOnlyRetryInstruction, H as createEmbeddedRunReplayState, I as resolveReplayInvalidFlag, L as resolveRunLivenessState, M as resolveAttemptReplayMetadata, N as resolveEmptyResponseRetryInstruction, O as createEmbeddedRunStageTracker, P as resolveIncompleteTurnPayloadText, R as resolveSilentToolResultReplyPayload, S as scrubAnthropicRefusalMagic, U as observeReplayMetadata, V as shouldTreatEmptyAssistantReplyAsSilent, _ as resolveOverloadFailoverBackoffMs, a as RUNTIME_AUTH_REFRESH_MARGIN_MS, b as resolveReportedModelRef, c as buildErrorAgentMeta, d as isAssistantForModelRef, f as resolveActiveErrorContext, g as resolveNextSameModelRateLimitRetryCount, h as resolveMaxRunRetryIterations, i as selectAgentHarness, j as hasAttemptTerminalState, k as formatEmbeddedRunStageSummary, l as buildUsageAgentMetaFields, m as resolveFinalAssistantVisibleText, o as RUNTIME_AUTH_REFRESH_MIN_DELAY_MS, p as resolveFinalAssistantRawText, r as runAgentHarnessAttempt, s as RUNTIME_AUTH_REFRESH_RETRY_MS, u as createCompactionDiagId, v as resolveOverloadProfileRotationLimit, w as mergeUsageIntoAccumulator, x as resolveSameModelRateLimitRetryDelayMs, y as resolveRateLimitProfileRotationLimit, z as shouldRetryMissingAssistantTurn } from "./selection-BfRwHcjH.js";
import { c as runContextEngineMaintenance, f as buildContextEngineRuntimeSettings, l as waitForDeferredTurnMaintenanceForSession } from "./context-engine-lifecycle-CuZ0qH-C.js";
import { f as isStrictAgenticExecutionContractActive } from "./openclaw-tools-B0V1p3La.js";
import { m as hasOnlyAssistantReasoningContent } from "./openai-transport-stream-CP3KgIXd.js";
import { t as log$1 } from "./logger-Cc1RIqMU.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-CiTQy4GP.js";
import { d as retireSessionMcpRuntimeForSessionKey, u as retireSessionMcpRuntime } from "./agent-bundle-mcp-runtime-BcscePMD.js";
import "./agent-bundle-mcp-tools-CAlLtgQ_.js";
import { c as normalizeContextTokenBudget, i as shouldRotateCompactionTranscript, r as rotateTranscriptFileAfterCompaction } from "./attempt.model-diagnostic-events-BJy-nXyS.js";
import "./tool-split-9XLEpyjB.js";
import { n as resolveProcessToolScopeKey } from "./agent-tools-XUrUI5bQ.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-DbQGUIh0.js";
import { d as hasOutboundDeliveryEvidence, u as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-PPEx8SZk.js";
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-CVttd5qX.js";
import { i as pickFallbackThinkingLevel } from "./embedded-agent-helpers-CHJLXFE8.js";
import { c as resolveSessionSuspensionTarget, f as shouldSuppressRawErrorConsoleSuffix, h as shouldAllowCooldownProbeForReason, l as suspendSession, p as LiveSessionModelSwitchError, s as resolveSessionSuspensionReason, u as buildApiErrorObservationFields } from "./model-fallback-CTRdAq5q.js";
import { i as resolveStoredSessionKeyForSessionId, r as resolveSessionKeyForRequest } from "./session-5Ip-5ray.js";
import { n as resolveModelAsync } from "./model-moZOoKI1.js";
import { t as ensureContextEnginesInitialized } from "./init-Dfpmyvf2.js";
import { n as resolveEmbeddedCompactionTarget, r as listActiveProcessSessionReferences, t as buildEmbeddedCompactionRuntimeContext } from "./compaction-runtime-context-C1JqDsyg.js";
import { a as resolveLiveToolResultMaxChars, c as truncateOversizedToolResultsInSession, o as sessionLikelyHasOversizedToolResults } from "./tool-result-truncation-CFLypc-Q.js";
import { n as runAgentCleanupStep } from "./attempt.tool-run-context-DWNz4033.js";
import { c as resolveCompactionTimeoutMs, o as compactContextEngineWithSafetyTimeout, s as compactWithSafetyTimeout } from "./tool-result-middleware-DA6D7k8x.js";
import "./extra-params-cdUlN1qw.js";
import { m as resolveContextEngineCapabilities, r as forgetPromptBuildDrainCacheForRun } from "./attempt.prompt-helpers-Cuf8j_4K.js";
import { a as resolveContextWindowInfo, i as formatContextWindowWarningMessage, n as evaluateContextWindowGuard, r as formatContextWindowBlockMessage } from "./context-window-guard-CD8YKM1C.js";
import "./sandbox-info-DqMwIeTx.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-recovery-hint-BxTW3BoA.js";
import { c as captureCompactionCheckpointSnapshotAsync, g as resolveSessionCompactionCheckpointReason, h as resolveCompactionCheckpointTranscriptPosition, l as cleanupCompactionCheckpointSnapshot, m as readSessionLeafStateFromTranscriptAsync, n as asCompactionHookRunner, p as persistSessionCompactionCheckpoint, s as runPostCompactionSideEffects, t as readAgentModelContextTokens } from "./model-context-tokens-CjCn2EKc.js";
import { n as isRecoverableNativeHarnessBindingFailure, t as maybeCompactAgentHarnessSession } from "./compaction-BSgguriZ.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-DS7hml6X.js";
import { t as ensureRuntimePluginsLoaded } from "./runtime-plugins-C-kXoCx1.js";
import { t as DEFERRED_CONTEXT_ENGINE_COMPACTION_REASON } from "./compact-reasons-CQeEUOxn.js";
import { n as createAgentHarnessTaskRuntimeScope } from "./agent-harness-task-runtime-scope-CE_hJFbn.js";
import { t as resolveExternalCliAuthOverlayScopeFromSelection } from "./external-cli-auth-selection-BMV418-3.js";
import { n as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-CzmDv9nJ.js";
import { t as buildAgentRuntimeAuthPlan } from "./auth-aWP1VSI-.js";
import { r as buildAgentRuntimePlan } from "./build-qAzx5U8o.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-BoEDGsY9.js";
import { n as isExecLikeToolName, t as buildEmbeddedRunPayloads } from "./payloads-DMxgzxEO.js";
