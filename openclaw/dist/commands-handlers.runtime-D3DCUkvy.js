...
import { M as isBunRuntime } from "./argv-YFvW08kO.js";
...
import { m as resolveUserPath, r as clampInt } from "./utils-BmpsSbZo.js";
...
import "./clawhub-Djv2LNEB.js";
import { r as parseGitPluginSpec, t as installPluginFromGitSpec } from "./git-install-DjoV6sIo.js";
import { i as normalizeProviderId } from "./provider-id-Dq06Bcx6.js";
import { t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-CkT3b8X-.js";
import { c as resolveOfficialExternalPluginInstall, n as getOfficialExternalPluginCatalogEntryForPackage, s as resolveOfficialExternalPluginId } from "./official-external-plugin-catalog-tI628GsA.js";
...
import { a as resolveAgentDir } from "./agent-scope-config-ChfGvhEr.js";
import { r as logVerbose } from "./globals-Cjirhr4c.js";
import { E as validateConfigObjectWithPlugins, M as resetConfigOverrides, N as setConfigOverride, P as unsetConfigOverride, d as readConfigFileSnapshotForWrite, j as getConfigOverrides, u as readConfigFileSnapshot } from "./io-CwmOK6NP.js";
...
import "./installed-plugin-index-records-_onmiiMH.js";
import { _ as resolveResponseUsageMode, h as normalizeUsageDisplay, u as isSessionDefaultDirectiveValue } from "./thinking-3cYUSC_N.js";
import { n as assertConfigWriteAllowedInCurrentMode } from "./nix-mode-write-guard-BjYy-zVW.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath, t as getConfigValueAtPath } from "./config-paths-CbABIGDb.js";
import { t as setPluginEnabledInConfig } from "./toggle-config-mju9S84-.js";
import { t as parseDurationMs } from "./parse-duration-Da6doDTX.js";
import { a as transformConfigFileWithRetry } from "./config-CxwD7EO_.js";
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-CJWZei_v.js";
import { g as triggerOpenClawRestart, p as scheduleGatewaySigusr1Restart } from "./restart-BHEJqkjr.js";
import { o as normalizeChannelId } from "./registry-OWFseiD7.js";
import { n as getActivePluginChannelRegistry } from "./runtime-Bn9lQ3kL.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-eGNEjFJ2.js";
import { g as updateSessionStore, s as getSessionEntry, w as resolveGroupSessionKey } from "./store-CWhnH-Ye.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths-BcGVZo_k.js";
...
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-Ys7IxLOo.js";
import { i as normalizeMessageChannel } from "./message-channel-normalize-B2zqLi2s.js";
import { r as isInternalMessageChannel } from "./message-channel-CtiNqfW0.js";
...
import { s as migrateSessionEntries } from "./session-manager-C696L9Rp.js";
...
import { i as resolveTextCommand, r as normalizeCommandBody } from "./commands-registry-normalize-IpIeXL3a.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-aPROyEVZ.js";
import { r as stripInboundMetadata } from "./strip-inbound-meta-BI3m2RBP.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-D9EoaMod.js";
import { T as replyRunRegistry, f as resolveActiveEmbeddedRunSessionId } from "./run-state-B31lb2Ak.js";
import { i as formatEmbeddedAgentQueueFailureSummary, m as queueEmbeddedAgentMessageWithOutcomeAsync, s as isEmbeddedAgentRunActive } from "./runs-pVtbFfgt.js";
import { i as isSilentReplyPayloadText } from "./tokens-DD1fz8gG.js";
import { l as readSessionMessages } from "./session-utils.fs-TFao3OTs.js";
import { n as estimateTokensFromChars } from "./cjk-chars-BtjJDifS.js";
import { o as resolveContextTokensForModel } from "./context-jzOtrNWM.js";
import { t as resolveFastModeState } from "./fast-mode-BhUUmslZ.js";
import { n as formatUsd } from "./usage-format-BWR3v1SJ.js";
import { r as deriveSessionTitle } from "./session-utils-B4hOl7Zv.js";
...
import { r as parseSessionLabel } from "./openclaw-tools-B0V1p3La.js";
import { n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-ySypYTWn.js";
import { j as isRealConversationMessage } from "./attempt.model-diagnostic-events-BJy-nXyS.js";
import { c as resolveMainSessionAlias, s as resolveInternalSessionKey } from "./sessions-helpers-_M-yN8U5.js";
import { a as clearSessionQueues } from "./queue-Ctw9J5BS.js";
import { o as resolveReplyToMode } from "./reply-threading-JClWiPt0.js";
import { b as resolveBootstrapTotalMaxChars, v as resolveBootstrapMaxChars } from "./embedded-agent-helpers-CHJLXFE8.js";
import { n as routeReply } from "./route-reply-BvqNvbYv.js";
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, x as resolveExplicitConfigWriteTargetShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-5wam5y3m.js";
...
import { a as listTasksForSessionKeyForStatus, r as listTasksForAgentIdForStatus } from "./task-status-access-45A7JwmH.js";
import { r as matchPluginCommand, t as executePluginCommand } from "./commands-5-fRNyRA.js";
import "./commands-registry-CVJMMTFc.js";
import { n as classifyCompactionReason } from "./compact-reasons-CQeEUOxn.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-C_V3DNg9.js";
import { o as markCommandSessionMetadataChanged, r as handleGoalCommand } from "./commands-goal-fG-6MTiM.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-CGFaH9tf.js";
import { a as requireGatewayClientScope, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-B7MhnmDE.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-DUXOWff4.js";
...
import { i as stopSubagentsForRequester, n as formatAbortReplyText, r as resolveSessionEntryForKey, t as abortSessionRunTarget } from "./abort-DSOUCxgu.js";
import { n as formatTimeAgo } from "./format-relative-Bjc3l98W.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-CRGrNmFz.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-Bgc-ubwP.js";
import { t as handleCrestodianCommand } from "./commands-crestodian-S-n-uJWS.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-Xdjt6p1L.js";
import { t as resolveApprovalOverGateway } from "./approval-gateway-resolver-BzmB3utI.js";
import { n as parseActivationCommand } from "./group-activation-MKTJBUwi.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-D6rnsClI.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-CQyrSWjS.js";
import { i as resolveSkillCommandInvocation, t as listSkillCommandsForAgents } from "./chat-commands-520jUhKl.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-Djg1Uj8t.js";
import { t as extractBtwQuestion } from "./btw-command-McMuk4HY.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-wTaAtwnT.js";
import { r as handleModelsCommand } from "./commands-models-COlM4qCS.js";
import { r as createExecTool } from "./bash-tools-Bvyb7cWG.js";
import { t as runBtwSideQuestion } from "./btw-CDO5476N.js";
import { C as stopWithText, b as resolveAcpAction, d as COMMAND, x as resolveAcpHelpText } from "./shared-DmmNRUKw.js";
import { a as resolveHandledPrefix, c as resolveSubagentsAction, d as resolveCommandSurfaceChannel, l as stopWithText$1, o as resolveRequesterSessionKey, u as resolveChannelAccountId } from "./shared-0VdBzGi9.js";
import { t as buildToolsMessage } from "./status-BuHjDqWk.js";
import { t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-DI5GlGOE.js";
import { n as setConfiguredMcpServer, o as parseConfigValue, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-B5rqtEto.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-Dz-ZTrrv.js";
import { n as buildStatusReply, t as buildStatusPluginsReply } from "./commands-status-DqWHeBI1.js";
import { t as buildNpmInstallRecordFields } from "./npm-resolution-DgekIanC.js";
import { a as installPluginFromNpmSpec, o as installPluginFromPath } from "./install-DELQ8tgH.js";
import { a as resolveOfficialExternalNpmPackageTrust } from "./plugin-install-plan-Bn7N-CF9.js";
import { a as buildPluginDiagnosticsReport, c as formatPluginCompatibilityNotice, o as buildPluginInspectReport, t as buildAllPluginInspectReports } from "./status-sUXQ5AzV.js";
import { t as buildPluginRegistrySnapshotReport } from "./status-snapshot-COgENhGL.js";
import { r as createPluginInstallLogger, u as resolveFileNpmSpecToLocalPath } from "./plugins-command-helpers-BIl-cHhT.js";
import { a as resolveInstallConfigMutationPreflights, o as selectInstallMutationWriteOptions, r as persistPluginInstall } from "./plugins-install-persist-njvnEWy2.js";
import { n as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-ReLUevY5.js";
import { n as installPluginFromClawHub } from "./clawhub-BzaGcIWj.js";
import { a as loadSessionCostSummary, n as loadCostUsageSummary } from "./session-cost-usage-ZATPEJD1.js";
...
const lifecycleHandlersLoader = createLazyImportLoader(() => import("./lifecycle-BffUUBbm.js"));
const runtimeOptionHandlersLoader = createLazyImportLoader(() => import("./runtime-options-BF4kUZdz.js"));
const diagnosticHandlersLoader = createLazyImportLoader(() => import("./diagnostics-gA6HFgZp.js"));
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-C6fDtHs9.js");
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-hGizXibF.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-BqQG62YK.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-DrZ_lsG8.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-CfId0DaE.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-Dsh6WLgF.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-DW9qYgUG.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-BJ97WI8E.js"));
