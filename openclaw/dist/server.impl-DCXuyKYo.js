...
import { i as logAcceptedEnvOption, n as isTruthyEnvValue, r as isVitestRuntimeEnv } from "./env-DpEiW8Oq.js";
...
import { v as sleep } from "./utils-BmpsSbZo.js";
...
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-BTVUlTIB.js";
import { o as setCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-nGeSY76G.js";
import { t as clearPluginMetadataLifecycleCaches } from "./plugin-metadata-lifecycle-C3dWg4tn.js";
import { c as isDiagnosticsTimelineEnabled, s as emitDiagnosticsTimelineEvent } from "./plugin-metadata-snapshot-O_ETy0qj.js";
...
import { c as buildRateLimitIdentityKey, l as createAuthRateLimiter, o as AUTH_RATE_LIMIT_SCOPE_NODE_REAPPROVAL } from "./auth-rate-limit-DCy1FKcB.js";
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as withSerializedKeyedAttempt } from "./auth-BDsIZbhK.js";
import { n as resolveGatewayAuth } from "./auth-resolve-S1BMuCdt.js";
import { A as applyConfigOverrides, i as getRuntimeConfig, s as promoteConfigSnapshotToLastKnownGood, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-CwmOK6NP.js";
...
import { t as loadGatewayTlsRuntime$1 } from "./gateway-DJBMYd11.js";
...
import { h as setPreRestartDeferralCheck, m as setGatewaySigusr1RestartPolicy } from "./restart-BHEJqkjr.js";
import { n as readGatewayRestartHandoffSync } from "./restart-handoff-CsqPFHER.js";
import { b as releasePinnedPluginSessionExtensionRegistry, g as pinActivePluginSessionExtensionRegistry, h as pinActivePluginHttpRouteRegistry, m as pinActivePluginChannelRegistry, v as releasePinnedPluginChannelRegistry, y as releasePinnedPluginHttpRouteRegistry } from "./runtime-Bn9lQ3kL.js";
...
import { i as resolveMainSessionKey } from "./main-session-CW3WnlFi.js";
import { n as getLoadedChannelPluginEntryById, r as listLoadedChannelPlugins } from "./registry-loaded-Dof2fO_S.js";
import "./sessions-BoPlPkQh.js";
import { a as enqueueSystemEvent } from "./system-events-B4uVi8eM.js";
import { f as resolveActiveEmbeddedRunSessionId, l as getActiveEmbeddedRunCount } from "./run-state-B31lb2Ak.js";
import { C as stopDiagnosticHeartbeat, S as startDiagnosticHeartbeat } from "./diagnostic-BktGu8Bf.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-Dj7CYXPD.js";
import { o as resolveCronJobsStorePath } from "./store-KOfgF9QY.js";
import { r as getActiveCronJobCount } from "./active-jobs-DCucn-SJ.js";
import { u as getTotalQueueSize } from "./command-queue-Cn3ZuyZZ.js";
import { n as clearSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeConfigSnapshot } from "./runtime-state-C7vELydH.js";
import { s as setFallbackGatewayContextResolver } from "./server-plugins-CLZE4NgR.js";
...
import { c as recordGatewayRestartTraceDetail, d as resumeGatewayRestartTraceFromHandoff, i as finishGatewayRestartTrace, l as recordGatewayRestartTraceSpan, n as collectGatewayProcessMemoryUsageMb, u as resumeGatewayRestartTraceFromEnv } from "./restart-trace-B6aFUfmq.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-CXeWaPjD.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-wfuEoVGE.js";
...
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-CWfbQxL_.js";
import { t as createDefaultDeps } from "./deps-DcaRKxrN.js";
import { c as setDefaultSecurityHeaders, r as sendGatewayAuthFailure } from "./http-common-D35nV7l1.js";
import { t as GatewayLockError } from "./gateway-lock-BUCsNssB.js";
...
import { n as resolveAssistantIdentity } from "./assistant-identity-B6QQnU74.js";
...
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-D5EqAAI6.js";
import { t as resolveGatewayPluginConfig } from "./runtime-plugin-config-D0rqnZbt.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-B1uJx9iD.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-DRDDOrcI.js";
...
function createLazyGatewayCronState(params) {
	...
	const load = async () => {
		...
		loading ??= import("./server-cron-Dcw720HP.js").then(({ buildGatewayCronService }) => {
			loaded = {
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-Dl1nFlnA.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-B471pQxO.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-EjpKyDi_.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-DBzxkPaJ.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-DY4Wpjw1.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-Dx_t7kRS.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-CM7eYfmy.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-Dqo2QcMR.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-CLUjuZQ3.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-aViPNl65.js");
	return toolsInvokeHttpModulePromise;
}
function getPluginNodeCapabilityAuthModule() {
	pluginNodeCapabilityAuthModulePromise ??= import("./plugin-node-capability-auth-DPtb4986.js");
	return pluginNodeCapabilityAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-ChZMwkV4.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-AhVHvk_o.js");
...
const loadGatewayPluginsHttpModule = async () => await import("./plugins-http-CM1BGr1B.js");
	...
	try {
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-B3CvVF50.js");
...
const loadGatewayModelCatalogModule = async () => {
	gatewayModelCatalogModulePromise ??= import("./server-model-catalog-BOBBv4c8.js");
...
function loadGatewayStartupEarlyModule() {
	gatewayStartupEarlyModulePromise ??= import("./server-startup-early-Cz0WlOyq.js");
	return gatewayStartupEarlyModulePromise;
}
function loadGatewayStartupPostAttachModule() {
	gatewayStartupPostAttachModulePromise ??= import("./server-startup-post-attach-DQYw8qcI.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-DLxup1by.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-1fuCL8ZU.js");
...
const loadGatewayPluginBootstrapModule = async () => {
	gatewayPluginBootstrapModulePromise ??= import("./server-plugin-bootstrap-CoEk_wZl.js");
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-oc6FgV59.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-DlWBkM3G.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	const startupConfigModulePromise = import("./server-startup-config-O-A_bAjR.js");
	let startupPluginsModulePromise = null;
	const loadStartupPluginsModule = () => {
		startupPluginsModulePromise ??= import("./server-startup-plugins-ZdQH6LJv.js");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-CHiG3KlU.js");
	...
	const { createChannelManager } = await import("./server-channels-Bgg2IF3s.js");
	...
	const createCloseHandler = () => async (optsValue) => {
		...
		await createGatewayCloseHandler({
			...
			markMainSessionsAbortedForRestart: async ({ sessionKeys, sessionIds, activeRuns, reason, isActiveRun }) => {
				...
				const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-DuPwGiPI.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, { startGatewayRuntimeServices }] = await startupTrace.measure("runtime.post-early-imports", () => Promise.all([import("./server-runtime-subscriptions-DjtbFNdp.js"), import("./server-runtime-startup-services-Bs07L-pW.js")]));
		...
		const { execApprovalManager, pluginApprovalManager, extraHandlers, coreGatewayHandlers } = await startupTrace.measure("gateway.handlers", async () => {
			const [{ createGatewayAuxHandlers }, { coreGatewayHandlers: coreGatewayHandlersLocal }] = await Promise.all([import("./server-aux-handlers-CBaeP-Wh.js"), import("./server-methods-CdyHDVDE.js")]);
			return {
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-CxseF-7N.js"),
				loadGatewayPluginBootstrapModule(),
				import("./services-BVI1W54V.js")
			]);
		...
		const [{ attachGatewayWsHandlers }, { listPluginNodeCapabilities }] = await startupTrace.measure("gateway.ws-imports", () => Promise.all([import("./server-ws-runtime-DKUD3_yx.js"), import("./route-capability-Br-EZr5i.js")]));
		...
		const loadScheduledServicesModule = () => {
			scheduledServicesModulePromise ??= import("./server-runtime-services-ClOa4Cpm.js");
		...
		activateScheduledServicesWhenReady();
		const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-d99vbE44.js");
