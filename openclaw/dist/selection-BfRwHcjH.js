...
import { n as isTruthyEnvValue } from "./env-DpEiW8Oq.js";
import { i as redactSecrets } from "./redact-DOrFK54L.js";
import { i as asOptionalRecord, o as isRecord$1, r as asOptionalObjectRecord } from "./record-coerce-DHZ4bFlT.js";
...
import { b as truncateUtf16Safe, m as resolveUserPath } from "./utils-BmpsSbZo.js";
...
import { y as resolveSessionAgentIds } from "./agent-scope-CESPhp3L.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey, r as isCronRunSessionKey } from "./session-key-utils-C7uT9A4s.js";
import { a as resolveAgentDir, r as resolveAgentConfig } from "./agent-scope-config-ChfGvhEr.js";
import { r as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-nGeSY76G.js";
import { i as loadPluginMetadataSnapshot } from "./plugin-metadata-snapshot-O_ETy0qj.js";
...
import { n as resolveAgentHarnessPolicy } from "./harness-runtimes-ADbVRmUZ.js";
...
import { i as listRegisteredAgentHarnesses, r as getRegisteredAgentHarness } from "./registry-OLFwZt_S.js";
import { N as listRegisteredPluginAgentPromptGuidance } from "./command-registration-C-5_dGJ0.js";
import { b as createCodeModeNamespaceRuntime, x as describeCodeModeNamespacesForPrompt, y as createCodeModeApiVirtualFiles } from "./registry-BmAQAf7L.js";
import { p as listImportedRuntimePluginIds, s as getActivePluginRegistry } from "./runtime-Bn9lQ3kL.js";
...
import { s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-Bm5WihiA.js";
import { m as setReplyPayloadMetadata } from "./reply-payload-DHGEQ5Iy.js";
import { t as toCodeModeJsonSafe } from "./code-mode-json-CQ3LP5c6.js";
import { s as resolveContextEngineOwnerPluginId } from "./registry-BFS9LOHl.js";
import { r as MAX_IMAGE_BYTES } from "./constants-Mf57IYS0.js";
import { u as resolveStorePath } from "./paths-BcGVZo_k.js";
import { D as resolveQuotaSuspensionEntryMaintenance, j as parseSessionThreadInfoFast } from "./store-load-S40KNQ3r.js";
...
import { a as resolveSessionLockMaxHoldFromTimeout, s as resolveSessionWriteLockOptions, t as acquireSessionWriteLock } from "./session-write-lock-81JXiIgr.js";
import { r as isSessionWriteLockAcquireError } from "./session-write-lock-error-CYOzPsPk.js";
import { I as isTranscriptOnlyOpenClawAssistantMessage$1, O as updateSessionEntry, f as loadSessionEntry, u as listSessionEntries } from "./session-accessor-ArmkJJUW.js";
...
import { a as parseAssistantTextSignature, s as resolveAssistantMessagePhase, t as extractAssistantTextForPhase } from "./chat-message-content-DacpWQXQ.js";
import { d as resolveProviderRuntimePluginHandle } from "./provider-hook-runtime-kjUY4t_q.js";
import { M as resolveProviderTextTransforms, U as transformProviderSystemPrompt, j as resolveProviderSystemPromptContribution } from "./provider-runtime-Li1kHuDF.js";
import { n as parseBooleanValue } from "./boolean-CrriykWV.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-x_pI-J7c.js";
import { t as sanitizeForConsole } from "./console-sanitize-Bf1BpkZq.js";
import { o as normalizeProviderId$1 } from "./model-selection-normalize-BvNI1t-G.js";
...
import { a as sanitizeToolCallIdsForCloudCodeAssist, r as extractToolResultIds, t as extractToolCallsFromAssistant } from "./tool-call-id-B-ulYrj-.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing } from "./session-transcript-repair-CT9REL9K.js";
import { i as streamSimple } from "./stream-iBy3TeLb.js";
import { o as createAgentSession, tt as wrapToolDefinition } from "./sessions-BY13LxNc.js";
import { l as invalidateSessionFileRepairCache, t as SessionManager, u as repairSessionFileIfNeeded } from "./session-manager-C696L9Rp.js";
...
import { f as resolveModelAuthMode } from "./model-auth-GMzbnR3o.js";
import { m as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-KxGKSHoh.js";
...
import { U as isTerminalTaskStatus } from "./task-registry-z-EZ6Ymu.js";
import { C as streamWithPayloadPatch, D as scrubOverCapPlainTextToolCallMessage, E as normalizePlainTextToolCallStreamEvents, T as promoteStandalonePlainTextToolCallMessage, w as extractStandalonePlainTextToolCallText } from "./provider-stream-shared-Bs5t-g_E.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-BbLAEXko.js";
import { f as findFinalTagMatches, o as stripDowngradedToolCallText, u as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-BHMfGmSN.js";
import { C as parseExecApprovalResultText } from "./sanitize-user-facing-text-DLYR-7y_.js";
import { t as resolveAgentTimeoutMs } from "./timeout-Drw0_zOv.js";
import { C as resolveEmbeddedSessionFileKey, b as updateActiveEmbeddedRunSnapshot, d as markActiveEmbeddedRunAbandoned, r as clearActiveEmbeddedRun, v as setActiveEmbeddedRun, y as updateActiveEmbeddedRunSessionFile } from "./runs-pVtbFfgt.js";
import { a as isSilentReplyPrefixText, c as stripLeadingSilentToken, i as isSilentReplyPayloadText, n as SILENT_REPLY_TOKEN, o as isSilentReplyText, s as startsWithSilentToken } from "./tokens-DD1fz8gG.js";
...
import { l as formatUserFacingAssistantErrorText, p as isCloudCodeAssistFormatError, r as classifyFailoverReason } from "./errors-BmvajW3H.js";
...
import { c as isSignalTimeoutReason } from "./failover-error-3to6iVLf.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-CBQ2d2jT.js";
import { o as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-BMHg2GYg.js";
import { i as resolveInheritedToolPolicyForSession, n as resolveEffectiveToolPolicy, o as resolveSubagentToolPolicyForSession, r as resolveGroupToolPolicy } from "./agent-tools.policy-dbFz4uDm.js";
...
import { A as resolveChannelReactionGuidance, D as listChannelSupportedActions, F as consumeStructuredReplaySafeToolCall, M as getChannelAgentToolMeta, N as consumeAdjustedParamsForToolCall, O as resolveChannelMessageToolHints, P as consumePreExecutionBlockedToolCall, S as markCodeModeControlTool, u as recordStructuredReplayTrustForToolCall, v as CODE_MODE_EXEC_TOOL_NAME, x as isCodeModeControlTool, y as CODE_MODE_WAIT_TOOL_NAME } from "./agent-tools.before-tool-call-CDuA0_mC.js";
import { i as getPluginToolMeta } from "./tools-DWq4toVW.js";
import { l as jsonResult, n as ToolInputError, r as asToolParamsRecord } from "./common-DjVgHKFa.js";
import { r as resolveImageSanitizationLimits } from "./image-sanitization-CxLP0YN-.js";
import { r as isCliRuntimeAliasForProvider } from "./model-runtime-aliases-Bn41wS2z.js";
import { t as resolveSenderToolPolicy } from "./sender-tool-policy-DOIsa6t0.js";
...
import { o as normalizeHeartbeatToolResponse } from "./heartbeat-tool-response-DqL28SwH.js";
import { t as filterHeartbeatTranscriptArtifacts } from "./heartbeat-filter-2_xjQ2D1.js";
import { a as finalizeHarnessContextEngineTurn, c as runContextEngineMaintenance, d as runAgentEndSideEffects, f as buildContextEngineRuntimeSettings, n as bootstrapHarnessContextEngine, t as assembleHarnessContextEngine } from "./context-engine-lifecycle-CuZ0qH-C.js";
import { E as isEmbeddedMode, d as replaceWithEffectiveCronCreatorToolAllowlist, m as stripProviderPrefix, p as isStrictAgenticSupportedProviderModel } from "./openclaw-tools-B0V1p3La.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-BWKHPe8B.js";
import { t as getMachineDisplayName } from "./machine-name-DaF-eeRE.js";
import { _ as supportsModelTools, f as sanitizeTransportPayloadText, g as buildGuardedModelFetch, m as hasOnlyAssistantReasoningContent, u as mergeTransportHeaders } from "./openai-transport-stream-CP3KgIXd.js";
import { t as log$2 } from "./logger-Cc1RIqMU.js";
import { u as createCodexNativeWebSearchWrapper } from "./proxy-MkWZdNg8.js";
...
import { a as buildCodeSpanIndex, o as createInlineCodeState } from "./openai-completions-vbhA-xck.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-AbDhi5c3.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-CiTQy4GP.js";
import { c as resolveSkillsPromptForRun } from "./workspace-CI6OUdDA.js";
import { n as resolveSandboxSkillRuntimeInputs, r as resolveEmbeddedRunSkillEntries, t as mapSandboxSkillEntriesForPrompt } from "./sandbox-skills-qlRgoVYl.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-BHgwYG5d.js";
import { n as redactConfigObject } from "./redact-snapshot-ySypYTWn.js";
import { t as resolveCommitHash } from "./git-commit-DvoYfmyF.js";
import { t as resolveOsSummary } from "./os-summary-wIRXeThT.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-DT_OTx3F.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-DBXSYOjv.js";
import { t as isReasoningTagProvider } from "./provider-utils-DG3y4nTa.js";
import { t as createBundleLspToolRuntime } from "./agent-bundle-lsp-runtime-KXJ3c6zC.js";
import { a as getOrCreateSessionMcpRuntime } from "./agent-bundle-mcp-runtime-BcscePMD.js";
import { r as materializeBundleMcpToolsForRun } from "./agent-bundle-mcp-materialize-B37ytUfj.js";
import "./agent-bundle-mcp-tools-CAlLtgQ_.js";
import { B as assessLastAssistantMessage, C as normalizeAssistantReplayContent, D as getHistoryLimitFromSessionKey, E as buildEmbeddedMessageActionDiscoveryInput, F as isCacheTtlEligibleProvider, G as isZeroUsageEmptyStopAssistantTurn, H as dropThinkingBlocks, I as readLastCacheTtlTimestamp, K as consumeEmbeddedToolSendReceipt, L as logRuntimeToolSchemaQuarantine, O as limitHistoryTurns, R as guardSessionManager, S as createEmbeddedAgentResourceLoader, T as validateReplayTurns, U as stripThinkingBlocksFromMessage, V as dropReasoningFromHistory, W as wrapAnthropicStreamWithRecovery, _ as resolveEmbeddedAgentApiKey, b as prewarmSessionFile, d as collectCoreBuiltinToolNames, f as collectRegisteredToolNames, g as describeEmbeddedAgentStreamStrategy, h as buildEmbeddedSystemPrompt, i as shouldRotateCompactionTranscript, k as buildEmbeddedExtensionFactories, l as AGENT_RESERVED_TOOL_NAMES, m as applySystemPromptToSession, n as rotateTranscriptAfterCompaction, o as flushPendingToolResultsAfterIdle, p as toSessionToolAllowlist, q as createPreparedEmbeddedAgentSettingsManager, s as mapThinkingLevel, t as wrapStreamFnWithDiagnosticModelCallEvents, u as collectAllowedToolNames, v as resolveEmbeddedAgentBaseStreamFn, w as sanitizeSessionHistory, x as trackSessionManagerAccess, y as resolveEmbeddedAgentStreamFn, z as stripStaleAssistantUsageBeforeLatestCompaction } from "./attempt.model-diagnostic-events-BJy-nXyS.js";
import { a as resolveEffectiveCompactionMode, i as isSilentOverflowProneModel, n as applyAgentAutoCompactionGuard, r as applyAgentCompactionSettingsFromConfig } from "./agent-settings-CFVXYr9U.js";
import { a as toClientToolDefinitions, n as createClientToolNameConflictError, o as toToolDefinitions, r as findClientToolNameConflicts, t as splitSdkTools } from "./tool-split-9XLEpyjB.js";
import { C as isLocalModelLeanEnabled, S as filterLocalModelLeanTools, _ as estimateToolSchemaDirectoryToolNames, a as TOOL_SEARCH_CODE_MODE_TOOL_NAME, b as resolveToolSearchConfig, c as addClientToolsToToolCatalog, d as applyToolSchemaDirectoryCatalog, f as applyToolSearchCatalog, g as createToolSearchCatalogRef, h as collectUniqueCatalogToolNames, i as TOOL_DESCRIBE_RAW_TOOL_NAME, l as addClientToolsToToolSearchCatalog, m as clearToolSearchCatalog, n as resolveProcessToolScopeKey, o as TOOL_SEARCH_RAW_TOOL_NAME, p as buildToolSchemaDirectoryPrompt, r as TOOL_CALL_RAW_TOOL_NAME, s as ToolSearchRuntime, t as createOpenClawCodingTools, u as applyToolCatalogCompaction, v as projectToolSearchTargetTranscriptMessages, w as resolveLocalModelLeanPreserveToolNames, x as applyLocalModelLeanToolSearchDefaults, y as resolveToolSearchCatalogTool } from "./agent-tools-XUrUI5bQ.js";
import { o as REQUIRED_PARAM_GROUPS } from "./nodes-utils-rzDwGCc_.js";
import { o as optionalStringEnum } from "./typebox-DgqA_f8_.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-DbQGUIh0.js";
import { c as resolveMainSessionAlias, s as resolveInternalSessionKey } from "./sessions-helpers-_M-yN8U5.js";
import { i as generateSecureToken } from "./secure-random-Ds4AFLgz.js";
import { b as mediaUrlsFromGeneratedAttachments, c as hasCommittedMessagingToolDeliveryEvidence, m as normalizeAcceptedSessionSpawnResult, p as hasAcceptedSessionSpawn, u as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-PPEx8SZk.js";
import { t as sanitizeForPromptLiteral } from "./sanitize-for-prompt-ByaJGDhT.js";
import { b as resolveBootstrapTotalMaxChars, d as normalizeOpenAIResponsesToolCallIds, l as downgradeOpenAIFunctionCallReasoningPairs, n as validateAnthropicTurns, o as isMessagingToolDuplicateNormalized, r as validateGeminiTurns, s as normalizeTextForComparison, u as downgradeOpenAIReasoningBlocks, v as resolveBootstrapMaxChars, y as resolveBootstrapPromptTruncationWarningMode } from "./embedded-agent-helpers-CHJLXFE8.js";
import { M as formatToolAggregate } from "./streaming-Dgx_j8xT.js";
import { d as parseReplyDirectives } from "./payloads-C-1aoWCs.js";
import { d as buildTextObservationFields, f as shouldSuppressRawErrorConsoleSuffix, m as MissingAgentHarnessError, u as buildApiErrorObservationFields } from "./model-fallback-CTRdAq5q.js";
import { a as extractThinkingFromTaggedStream, c as inferToolMetaFromArgs, d as sanitizeAssistantVisibleStreamText, i as extractAssistantVisibleText, l as isAssistantMessage, n as extractAssistantText, o as extractThinkingFromTaggedText, r as extractAssistantThinking, t as THINKING_TAG_SCAN_RE, u as promoteThinkingTagsToBlocks } from "./embedded-agent-utils-BTlpSKRO.js";
...
import { t as registerProviderStreamForModel } from "./provider-stream-BLfYyLMF.js";
import { b as prependAgentSteeringPrompt, g as releasePendingAgentSteeringItems, t as ackPendingAgentSteeringItems, u as leasePendingAgentSteeringItems } from "./subagent-registry-DA-B4wTo.js";
import { n as buildSubagentList } from "./subagent-list-Clb6Jp_o.js";
import { a as listControlledSubagentRuns } from "./subagent-control-BiLzAkbW.js";
import { o as resolveSandboxContext } from "./sandbox-BsGTve-p.js";
import { r as listActiveProcessSessionReferences } from "./compaction-runtime-context-C1JqDsyg.js";
...
import { i as runAgentHarnessBeforeAgentFinalizeHook } from "./lifecycle-hook-helpers-v00PVIlh.js";
import { i as resolveAgentPromptSurfaceForSessionKey, n as appendModelIdentitySystemPrompt, r as buildModelIdentityPromptLine } from "./system-prompt-config-Bh38sOOB.js";
import { t as collectRuntimeChannelCapabilities } from "./runtime-capabilities-WzXzbVdI.js";
import { n as filterRuntimeCompatibleTools } from "./tool-schema-projection-C_uRkhtw.js";
import { n as normalizeAgentRuntimeTools, t as logAgentRuntimeToolDiagnostics } from "./tools-BjIlvREJ.js";
import { a as resolveLiveToolResultMaxChars, d as formatContextLimitTruncationNotice, l as truncateOversizedToolResultsInSessionManager, s as truncateOversizedToolResultsInMessages } from "./tool-result-truncation-CFLypc-Q.js";
import { n as rewriteTranscriptEntriesInSessionManager } from "./transcript-rewrite-D0zlAs7i.js";
...
import { a as estimateLlmBoundaryTokenPressure, c as shouldPreemptivelyCompactBeforePrompt, i as buildPrePromptContextBudgetStatus, l as collectReplaySafeToolNames, n as runAgentCleanupStep, r as PREEMPTIVE_OVERFLOW_ERROR_TEXT, s as formatPrePromptPrecheckLog, t as buildEmbeddedAttemptToolRunContext, u as isAgentToolReplaySafe } from "./attempt.tool-run-context-DWNz4033.js";
import { c as resolveCompactionTimeoutMs, d as shouldAllowProviderOwnedThinkingReplay, u as resolveTranscriptPolicy } from "./tool-result-middleware-DA6D7k8x.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-cdUlN1qw.js";
...
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-B3bzn5Be.js";
import { r as resolveEmbeddedSandboxInfoExecPolicy, t as buildEmbeddedSandboxInfo } from "./sandbox-info-DqMwIeTx.js";
import { a as shouldCreateBundleMcpRuntimeForAttempt, i as shouldCreateBundleLspRuntimeForAttempt, n as mergeForcedEmbeddedAttemptToolsAllow, r as resolveEmbeddedAttemptToolConstructionPlan, t as applyEmbeddedAttemptToolsAllow } from "./attempt-tool-construction-plan-C0hAZjzo.js";
import { i as listTasksForOwnerOrRequesterSessionKeyForStatus, t as findTaskByRunIdForStatus } from "./task-status-access-45A7JwmH.js";
...
import "./tool-loop-detection-DD6Aljx9.js";
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-BDz_X_Pu.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-cZHIw6Jd.js";
import { t as detectAndLoadPromptImages } from "./images-DEjgpeBO.js";
		...
		switch (params.request.method) {
			...
			case "namespace": {
				...
				value = await params.namespaceRuntime.invoke(namespaceId, pathLocal, Array.isArray(callArgs) ? callArgs : [], async (request) => {
					...
					return isRecord$1(called.result) && "details" in called.result ? called.result.details : called.result;
				});
				break;
			}
		}
...
* telemetry.
*/
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-FP7SLqiy.js"));
...
function normalizeMessagesForCurrentPromptBoundary(params) {
	...
	const boundaryOptions = params.timezone || params.includeTimestamp === false ? {
