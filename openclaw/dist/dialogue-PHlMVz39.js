import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-RzMU0V-i.js";
import { r as loadCrestodianOverview } from "./overview-D6HVbtsj.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-kACzmyTn.js")).planCrestodianCommand)({
		input,
		overview
	});
