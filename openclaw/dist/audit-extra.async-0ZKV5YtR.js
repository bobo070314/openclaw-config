...
function loadSkillsModule() {
	skillsModulePromise ??= import("./workspace-aPPjHB_t.js");
...
function loadAgentScopeModule() {
	agentScopeModulePromise ??= import("./agent-scope-BxpxzPcu.js");
	return agentScopeModulePromise;
}
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-sHrFCDEU.js");
...
function loadSkillScannerModule() {
	skillScannerModulePromise ??= import("./scanner-H7NSlQ_S.js");
	return skillScannerModulePromise;
}
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-CKmk8t25.js");
...
async function loadSandboxBrowserSecurityHashEpoch() {
	sandboxConstantsModulePromise ??= import("./constants-B16J6s27.js");
