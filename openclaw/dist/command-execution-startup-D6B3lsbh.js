...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-CLuLpfWa.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-Do3vhMU8.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-RK9GVTyU.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-DvPyAddf.js");
	if (params.argv) {
