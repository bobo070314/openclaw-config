...
import { s as upsertAuthProfileWithLock } from "./profiles-BwfiFFgM.js";
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-D-17n3br.js";
import "./workspace-KxGKSHoh.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-lvbT_mTR.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-MdcZ3zId.js";
import { n as t } from "./i18n-C0k1rM_n.js";
import { n as openUrl } from "./browser-open-Cr3JjAtA.js";
import { r as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-BY69nc-d.js";
import { t as isRemoteEnvironment } from "./remote-env-UQ1pRGc-.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-CSWiIJ7P.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-C6UZk9qy.js");
		...
		const { ensureCopilotRuntimePluginForModelSelection } = await import("./copilot-runtime-plugin-install-BiP6Cqi4.js");
