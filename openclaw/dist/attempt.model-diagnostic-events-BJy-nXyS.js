...
import { d as redactToolPayloadTextWithConfig, o as redactSensitiveFieldValueWithConfig, r as isSensitiveFieldKey } from "./redact-DOrFK54L.js";
...
import { i as formatErrorMessage, t as collectErrorGraphCandidates } from "./errors-DNvW4XW_.js";
import { n as isAbortError } from "./unhandled-rejections-DPc1gLbc.js";
...
import { i as resolveEffectivePluginActivationState, r as normalizePluginsConfigWithResolver } from "./manifest-registry-DPC1sVNm.js";
import "./agent-scope-CESPhp3L.js";
import { i as resolveAgentContextLimits } from "./agent-scope-config-ChfGvhEr.js";
import { r as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-nGeSY76G.js";
import { i as loadPluginMetadataSnapshot, n as isPluginMetadataSnapshotCompatible } from "./plugin-metadata-snapshot-O_ETy0qj.js";
...
import { P as getCompactionProvider } from "./registry-BmAQAf7L.js";
import { l as fireAndForgetBoundedHook, t as getGlobalHookRunner } from "./hook-runner-global-Bm5WihiA.js";
import { F as isCacheEnabled, I as resolveCacheTtlMs, N as createExpiringMapCache } from "./store-load-S40KNQ3r.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-bo5V8PHW.js";
import "./version-Bsehiavt.js";
import { I as isTranscriptOnlyOpenClawAssistantMessage$1, L as isTranscriptOnlyOpenClawAssistantModel, R as redactTranscriptMessage } from "./session-accessor-ArmkJJUW.js";
import { C as resolveProviderCacheTtlEligibility, W as validateProviderReplayTurnsWithPlugin, z as sanitizeProviderReplayHistoryWithPlugin } from "./provider-runtime-Li1kHuDF.js";
...
import { a as sanitizeToolCallIdsForCloudCodeAssist, n as extractToolResultId, t as extractToolCallsFromAssistant } from "./tool-call-id-B-ulYrj-.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing, n as repairToolUseResultPairing, r as sanitizeToolCallInputs, t as makeMissingToolResult } from "./session-transcript-repair-CT9REL9K.js";
import { i as streamSimple, o as getApiProvider } from "./stream-iBy3TeLb.js";
import { it as SettingsManager, s as DefaultResourceLoader } from "./sessions-BY13LxNc.js";
import { t as STREAM_ERROR_FALLBACK_TEXT } from "./stream-message-shared-CdbBqwfX.js";
import { n as SUMMARIZATION_OVERHEAD_TOKENS } from "./compaction-planning-C7Ri_F3c.js";
import { o as markDiagnosticRunProgress } from "./diagnostic-run-activity-dlxgTFfd.js";
import { i as isSilentReplyPayloadText, o as isSilentReplyText } from "./tokens-DD1fz8gG.js";
import { S as stripInternalMetadataForDisplay } from "./session-utils.fs-TFao3OTs.js";
...
import { l as isTimeoutError } from "./failover-error-3to6iVLf.js";
...
import { I as peekAdjustedParamsForToolCall, i as finalizeToolTerminalPresentation } from "./agent-tools.before-tool-call-CDuA0_mC.js";
...
import { d as stripHeartbeatToken } from "./heartbeat-CJqWnUZ5.js";
import { h as isReasoningOnlyLengthAssistantTurn } from "./openai-transport-stream-CP3KgIXd.js";
import { t as log$3 } from "./logger-Cc1RIqMU.js";
import { c as isAnthropicModelRef, s as isAnthropicFamilyCacheTtlEligible } from "./proxy-MkWZdNg8.js";
import { a as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-ewprF4Mn.js";
import { b as loadEmbeddedAgentMcpConfig } from "./agent-bundle-mcp-runtime-BcscePMD.js";
import { a as resolveEffectiveCompactionMode, r as applyAgentCompactionSettingsFromConfig } from "./agent-settings-CFVXYr9U.js";
import { r as wrapUntrustedPromptDataBlock } from "./sanitize-for-prompt-ByaJGDhT.js";
import { p as mergePreparedUserTurnMessageForRuntime } from "./queue-Ctw9J5BS.js";
import { c as sanitizeSessionMessagesImages, d as normalizeOpenAIResponsesToolCallIds, l as downgradeOpenAIFunctionCallReasoningPairs, n as validateAnthropicTurns, r as validateGeminiTurns, u as downgradeOpenAIReasoningBlocks, x as sanitizeGoogleTurnOrdering } from "./embedded-agent-helpers-CHJLXFE8.js";
import { r as createBoundaryAwareStreamFnForModel } from "./provider-stream-BLfYyLMF.js";
import { n as createAnthropicVertexStreamFnForModel } from "./simple-completion-transport-DdXlFlEr.js";
import { t as collectTextContentBlocks } from "./content-blocks-DRK0dze4.js";
import { v as isToolResultError } from "./embedded-agent-message-tool-source-reply-BNDmht0w.js";
import { t as buildConfiguredAgentSystemPrompt } from "./system-prompt-config-Bh38sOOB.js";
import { a as resolveLiveToolResultMaxChars, d as formatContextLimitTruncationNotice, t as DEFAULT_MAX_LIVE_TOOL_RESULT_CHARS, u as truncateToolResultMessage } from "./tool-result-truncation-CFLypc-Q.js";
import { a as setRawSessionAppendMessage, c as readTranscriptFileState, i as getRawSessionAppendMessage, l as writeTranscriptFileAtomic, o as TranscriptFileState } from "./transcript-rewrite-D0zlAs7i.js";
import { a as resolveUserTimezone, t as formatDateStamp } from "./date-time-CcWivhrg.js";
import { r as recordPersistedRuntimeToolSchemaQuarantine, t as clearRecoveredPersistedRuntimeToolSchemaQuarantines } from "./tool-schema-quarantine-health-BI5YTdDm.js";
import { a as computeAdaptiveChunkRatioWithWorker, d as shouldAllowProviderOwnedThinkingReplay, i as buildHistoryPrunePlanWithWorker, l as providerRequiresSignedThinking, n as resolveContextWindowTokens$1, r as summarizeInStages, t as createAgentToolResultMiddlewareRunner, u as resolveTranscriptPolicy } from "./tool-result-middleware-DA6D7k8x.js";
import { o as isGooglePromptCacheEligible } from "./extra-params-cdUlN1qw.js";
...
function buildSuccessorEntries(params) {
	...
	const duplicateUserMessageIds = collectDuplicateUserMessageEntryIdsForCompaction(branch.filter((entry) => !summarizedBranchIds.has(entry.id)));
...
//#endregion
export { hasMeaningfulConversationContent as A, assessLastAssistantMessage as B, normalizeAssistantReplayContent as C, getHistoryLimitFromSessionKey as D, buildEmbeddedMessageActionDiscoveryInput as E, isCacheTtlEligibleProvider as F, isZeroUsageEmptyStopAssistantTurn as G, dropThinkingBlocks as H, readLastCacheTtlTimestamp as I, consumeEmbeddedToolSendReceipt as K, logRuntimeToolSchemaQuarantine as L, readPostCompactionContext as M, consumeCompactionSafeguardCancelReason as N, limitHistoryTurns as O, setCompactionSafeguardCancelReason as P, guardSessionManager as R, createEmbeddedAgentResourceLoader as S, validateReplayTurns as T, stripThinkingBlocksFromMessage as U, dropReasoningFromHistory as V, wrapAnthropicStreamWithRecovery as W, resolveEmbeddedAgentApiKey as _, dedupeDuplicateUserMessagesForCompaction as a, prewarmSessionFile as b, normalizeContextTokenBudget as c, collectCoreBuiltinToolNames as d, collectRegisteredToolNames as f, describeEmbeddedAgentStreamStrategy as g, buildEmbeddedSystemPrompt as h, shouldRotateCompactionTranscript as i, isRealConversationMessage as j, buildEmbeddedExtensionFactories as k, AGENT_RESERVED_TOOL_NAMES as l, applySystemPromptToSession as m, rotateTranscriptAfterCompaction as n, flushPendingToolResultsAfterIdle as o, toSessionToolAllowlist as p, createPreparedEmbeddedAgentSettingsManager as q, rotateTranscriptFileAfterCompaction as r, mapThinkingLevel as s, wrapStreamFnWithDiagnosticModelCallEvents as t, collectAllowedToolNames as u, resolveEmbeddedAgentBaseStreamFn as v, sanitizeSessionHistory as w, trackSessionManagerAccess as x, resolveEmbeddedAgentStreamFn as y, stripStaleAssistantUsageBeforeLatestCompaction as z };
