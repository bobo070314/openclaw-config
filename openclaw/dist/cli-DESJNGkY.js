...
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update--peKDjoV.js";
import { n as matrixSetupAdapter } from "./setup-core-mmoqIn0y.js";
import { t as withResolvedActionClient } from "./client-vVYrnOZt.js";
import { r as resolveMatrixAuthContext } from "./config-RiR4C_DO.js";
...
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-DNlV5kQb.js";
...
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-BQo56NyM.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-MiLdvn44.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-D6350BoJ.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-BEAhJQyi.js");
