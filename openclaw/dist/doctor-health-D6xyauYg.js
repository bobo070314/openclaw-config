...
async function doctorCommand(runtime, options = {}) {
	...
	const { createDoctorPrompter } = await import("./doctor-prompter-CW7awTa6.js");
	const { printWizardHeader } = await import("./onboard-helpers-CaUKBdIp.js");
	...
	const { maybeOfferUpdateBeforeDoctor } = await import("./doctor-update-COiRov9T.js");
	...
	const { maybeRepairUiProtocolFreshness } = await import("./doctor-ui-e3csi-BW.js");
	const { noteSourceInstallIssues } = await import("./doctor-install-Chm31XUZ.js");
	const { noteStalePluginRuntimeSymlinks } = await import("./plugin-runtime-symlinks-Ce0KeyAn.js");
	const { noteStartupOptimizationHints } = await import("./doctor-platform-notes-A-Md97fz.js");
	await maybeRepairUiProtocolFreshness(effectiveRuntime, prompter);
	noteSourceInstallIssues(root);
	await noteStalePluginRuntimeSymlinks(root);
	noteStartupOptimizationHints();
	const { loadAndMaybeMigrateDoctorConfig } = await import("./doctor-config-flow-DFFTMfNX.js");
	...
	const { runDoctorHealthContributions } = await import("./doctor-health-contributions-X7PQBLmd.js");
