...
import { b as resolveModelRefFromString, i as buildModelAliasIndex, u as inferUniqueProviderFromConfiguredModels } from "./model-selection-shared-DXdzMPOG.js";
...
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-ZyA1uyNu.js";
import { n as isMinimaxVlmProvider, t as isMinimaxVlmModel } from "./minimax-vlm-Co_D-CT4.js";
...
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-DdoeP7fs.js";
import { a as resolveModelEntries, s as resolveScopeDecision } from "./resolve-CHFYLkHe.js";
import { n as resolveOpenAiAudioAuthModelApi } from "./openai-audio-api-BEkNYRPi.js";
import { S as normalizeAttachments, _ as fileExists, a as runCliEntry, b as selectAttachments, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaAttachmentCache, y as isMediaUnderstandingSkipError } from "./runner.entries-DxOu5P-g.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-BQZlAOIC.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-Cbeftk9T.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-CMxFFxzV.js");
