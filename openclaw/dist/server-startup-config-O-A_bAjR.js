...
import { A as applyConfigOverrides, f as readConfigFileSnapshotWithPluginMetadata } from "./io-CwmOK6NP.js";
...
import { n as formatPluginPackagingRuntimeOutputRecoveryHint, t as formatInvalidConfigRecoveryHint } from "./config-recovery-hints-CfZXUgMZ.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-3CSAR1D4.js";
import { o as getActiveSecretsRuntimeSnapshot, s as getLiveSecretsRuntimeAuthStores, t as activateSecretsRuntimeSnapshotState, u as setPreparedSecretsRuntimeSnapshotRefreshContext } from "./runtime-state-C7vELydH.js";
import { n as evaluateGatewayAuthSurfaceStates, t as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-gateway-auth-surfaces-CDRNoRwf.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-dtNWepEF.js";
import { a as prepareSecretsRuntimeFastPathSnapshot, o as resolveRefreshAgentDirs } from "./runtime-fast-path-DDNujK1o.js";
...
function createRuntimeSecretsActivator(params) {
	...
	const loadSecretsRuntime = () => {
		secretsRuntimePromise ??= import("./runtime-RzoK3Wbh.js");
		return secretsRuntimePromise;
	};
	const loadAuthProfiles = () => {
		authProfilesPromise ??= import("./auth-profiles-YpkjbjxZ.js");
