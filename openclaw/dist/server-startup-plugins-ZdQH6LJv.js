...
import { r as collectUnregisteredConfiguredMemoryEmbeddingProviders } from "./gateway-startup-plugin-ids-BI4XebPa.js";
...
import { j as listRegisteredEmbeddingProviders } from "./registry-BmAQAf7L.js";
import { D as createEmptyPluginRegistry, E as setActivePluginRegistry, s as getActivePluginRegistry } from "./runtime-Bn9lQ3kL.js";
import "./channel-plugin-ids-CIBKJXBv.js";
import { n as loadPluginLookUpTable } from "./plugin-lookup-table-C1JInnzY.js";
import { l as initSubagentRegistry } from "./subagent-registry-DA-B4wTo.js";
import { t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-rvKxXBIl.js";
import { n as listGatewayMethods } from "./server-methods-list-DRDDOrcI.js";
...
async function prepareGatewayPluginBootstrap(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		const { runChannelPluginStartupMaintenance } = await import("./lifecycle-startup-CaoLbX0Z.js");
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-BGLb1vcK.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-CoEk_wZl.js");
