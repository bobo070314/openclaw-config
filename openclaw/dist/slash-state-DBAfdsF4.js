...
import { i as deliverTextOrMediaReply, m as resolveSendableOutboundReplyParts, u as isReasoningReplyPayload } from "./reply-payload-CBQ2d2jT.js";
...
import { a as normalizeMattermostAllowList, t as authorizeMattermostCommandInvocation } from "./monitor-auth-Cx_bfiyf.js";
...
function createMattermostReplyDeliveryBarrier(params) {
	...
	return await deliverTextOrMediaReply({
		...
		sendText: async (chunk) => {
			await params.sendMessage(params.to, chunk, {
				...
				...params.onDmChannelResolution ? { onDmChannelResolution: params.onDmChannelResolution } : {}
			});
		},
...
async function resolveTargetChannelId(params) {
	...
	const resolution = createMattermostDirectChannelWithRetry(createMattermostClient({
		baseUrl: params.baseUrl,
