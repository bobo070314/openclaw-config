...
import { b as truncateUtf16Safe, y as sliceUtf16Safe } from "./utils-BmpsSbZo.js";
...
import { n as CHAT_CHANNEL_ORDER } from "./ids-D1Qs3JV3.js";
import { i as hasLegacyAutoFallbackWithoutOrigin, m as resolveAutoFallbackPrimaryProbe, p as resolveAgentSkillsFilter, t as clearAutoFallbackPrimaryProbeSelection, v as resolveSessionAgentId, w as hasSessionAutoModelFallbackProvenance } from "./agent-scope-CESPhp3L.js";
import { a as isSubagentSessionKey, c as parseAgentSessionKey, n as isAcpSessionKey } from "./session-key-utils-C7uT9A4s.js";
import { d as normalizeMainKey, i as buildAgentMainSessionKey, u as normalizeAgentId } from "./session-key-BsbwBJwv.js";
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir, r as resolveAgentConfig, t as listAgentEntries } from "./agent-scope-config-ChfGvhEr.js";
import { t as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-default-DhGzPxbH.js";
import { l as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-O_ETy0qj.js";
...
import { d as normalizeElevatedLevel, f as normalizeReasoningLevel, g as normalizeVerboseLevel, m as normalizeTraceLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel, t as formatThinkingLevels, u as isSessionDefaultDirectiveValue } from "./thinking-3cYUSC_N.js";
import "./config-CxwD7EO_.js";
import { a as normalizeAnyChannelId } from "./registry-OWFseiD7.js";
import { o as resetRegisteredAgentHarnessSessions } from "./registry-OLFwZt_S.js";
import { t as getGlobalHookRunner, u as fireAndForgetHook } from "./hook-runner-global-Bm5WihiA.js";
import { d as markCommandReplyForDelivery } from "./reply-payload-DHGEQ5Iy.js";
...
import { b as deriveSessionMetaPatch, w as resolveGroupSessionKey } from "./store-CWhnH-Ye.js";
import { a as normalizeDeliveryChannelRoute, n as deliveryContextFromSession, o as normalizeDeliveryContext, r as deliveryContextKey, s as normalizeSessionDeliveryFields } from "./delivery-context.shared-BjCF5MAj.js";
import "./message-channel-constants-Z0pS5ykd.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-BcGVZo_k.js";
import { E as resolveMaintenanceConfigFromInput, V as resolveSessionStoreEntry, j as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-S40KNQ3r.js";
import { t as getLoadedChannelPluginById } from "./registry-loaded-Dof2fO_S.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-CK5ins3w2.js";
...
import { g as persistSessionRolloverLifecycle, z as resolveAndPersistSessionFile } from "./session-accessor-ArmkJJUW.js";
import { l as resolveSessionLifecycleTimestamps, o as hasTerminalMainSessionTranscriptNewerThanRegistry } from "./sessions-BoPlPkQh.js";
...
import { b as resolveModelRefFromString } from "./model-selection-shared-DXdzMPOG.js";
...
import { s as getMediaDir } from "./store-C8gpb2Gk.js";
import { d as ensureAgentWorkspace, m as isWorkspaceBootstrapPending } from "./workspace-KxGKSHoh.js";
...
import { r as normalizeCommandBody } from "./commands-registry-normalize-IpIeXL3a.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-aPROyEVZ.js";
...
import { n as isInternalSourceReplyChannel } from "./source-reply-delivery-mode-WUrUYZQd.js";
import { a as enqueueSystemEvent } from "./system-events-B4uVi8eM.js";
import { t as resolveAgentTimeoutMs } from "./timeout-Drw0_zOv.js";
import { D as resolveActiveReplyRunThreadId, E as resolveActiveReplyRunSessionId, S as isReplyRunStreamingForSessionId, _ as abortReplyRunBySessionId, k as waitForReplyRunEndBySessionId, p as REPLY_RUN_IDLE_SETTLE_TIMEOUT_MS, x as isReplyRunActiveForSessionId } from "./run-state-B31lb2Ak.js";
import { a as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as isSilentReplyText } from "./tokens-DD1fz8gG.js";
...
import { l as getQueueSize, r as clearCommandLane } from "./command-queue-Cn3ZuyZZ.js";
...
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-DsSZ9hKY.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-DPWbhdfw.js";
import { w as normalizeExecTarget } from "./exec-approvals-zVFNVwl1.js";
import { n as runAgentHarnessBeforeMessageWriteHook } from "./hook-helpers-CENBGDuz.js";
import { a as HEARTBEAT_TRANSCRIPT_PROMPT, d as stripHeartbeatToken } from "./heartbeat-CJqWnUZ5.js";
...
import { u as retireSessionMcpRuntime } from "./agent-bundle-mcp-runtime-BcscePMD.js";
import "./agent-bundle-mcp-tools-CAlLtgQ_.js";
import "./delivery-context-A6UjJv7M.js";
import { c as resolveIngressWorkspaceOverrideForSpawnedRun } from "./subagent-spawn-plan-BXrUwsl9.js";
import { i as generateSecureToken } from "./secure-random-Ds4AFLgz.js";
import { _ as skipDirectiveArgPrefix, d as buildPersistedUserTurnMediaInputsFromFields, f as createUserTurnTranscriptRecorder, g as extractQueueDirective, h as resolvePersistedUserTurnText, t as resolveQueueSettings, v as takeDirectiveToken } from "./queue-Ctw9J5BS.js";
...
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-CXFUJZDk.js";
import { r as getCliSessionBinding } from "./cli-session-SXvjcghv.js";
...
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-DqMwIeTx.js";
import { t as resolveBootstrapMode } from "./bootstrap-mode-Dp9_flb7.js";
import { t as resolveChannelModelOverride } from "./model-overrides-CSw9Qfvu.js";
import { a as resolveCurrentTurnImages, n as resolveEffectiveReplyRoute, r as createReplyTimingTracker, s as resolveSilentReplySettings, t as isSystemEventProvider } from "./effective-reply-route-Dwb-qp9R.js";
...
import { c as takeCommandSessionMetadataChangesFromTargets } from "./commands-goal-fG-6MTiM.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-CGFaH9tf.js";
import { t as parseSoftResetCommand } from "./commands-reset-mode-CyVYz7U7.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-DUXOWff4.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy } from "./typing-policy-DFy1gWr0.js";
import { t as resolveRoutedDeliveryThreadId } from "./routed-delivery-thread-BeZVs1v-.js";
import { n as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-BHFUrpM3.js";
...
import { n as shouldUseFromAsSenderFallback } from "./command-auth-DskH_Lgk.js";
...
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-Dt5-4c39.js";
import { a as buildSessionStartHookPayload, i as buildSessionEndHookPayload, r as noteActiveSessionForShutdown, t as forgetActiveSessionForShutdown } from "./active-sessions-shutdown-tracker-B0Sb_aoa.js";
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection-BxQNCvdr.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-BrLC2D45.js";
...
import { t as resolveDefaultModel } from "./directive-handling.defaults-hBDaMIi8.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-CYoRn_Ch.js";
import { n as buildCommandContext, t as isResetAuthorizedForContext } from "./reset-authorization-BZMm55GJ.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-DotlWy9J.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-X037aCOr.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-DjCHXj1I.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-CPRkbmbz.js";
...
import { i as resolveSkillCommandInvocation, r as listReservedChatSlashCommandNames } from "./chat-commands-520jUhKl.js";
import { n as resolvePreparedReplyQueueState } from "./get-reply-run-queue-B5rkMyAY.js";
import { n as resolveTypingMode, r as resolveActiveRunQueueAction } from "./typing-mode-CrGNd_SA.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-Djg1Uj8t.js";
import { t as drainFormattedSystemEvents } from "./session-system-events-CuJt5VTk.js";
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-B_KptzFz.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-CROkabDG.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-BZ3oAILS.js"));
...
function buildGroupChatContext(params) {
	...
	else lines.push("Your text replies are automatically sent to this group chat. For ordinary text, do not use the message tool to send to this same group; just reply normally. Use message(action=send) only when you need to send files, images, or other attachments to this same group/topic.");
...
const skillToolDispatchRuntimeLoader = createLazyImportLoader(() => import("./tool-dispatch-Bx8MjDy9.js"));
...
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-BrbT1hMO.js"));
...
const sessionAccessorRuntimeLoader = createLazyImportLoader(() => import("./session-accessor-0gydOiHM.js"));
...
function loadDeliverRuntime() {
	messageRuntimePromise ??= import("./runtime-wQIoJuV9.js");
...
async function initSessionState(params) {
	...
	if (isNewSession) {
		...
		sessionEntry.totalTokens = inheritedParentContext ? void 0 : 0;
		...
		if (opts?.isHeartbeat) {
			if (classifyHeartbeatPendingFinalDelivery(text, resolveHeartbeatAckMaxChars(cfg, agentId)).shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionEntry } = await import("./session-accessor-0gydOiHM.js");
