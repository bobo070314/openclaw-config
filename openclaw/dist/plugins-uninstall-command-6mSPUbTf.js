...
import { a as tracePluginLifecyclePhaseAsync, i as tracePluginLifecyclePhase } from "./discovery-DLXdaPcU.js";
...
async function runPluginUninstallCommand(id, opts = {}, runtime = defaultRuntime) {
	...
	const { loadInstalledPluginIndexInstallRecords, removePluginInstallRecordFromRecords, withoutPluginInstallRecords, withPluginInstallRecords } = await import("./installed-plugin-index-records-BILx22sh.js");
	const { buildPluginSnapshotReport } = await import("./status-DjyjEUWD.js");
	const { applyPluginUninstallDirectoryRemoval, formatUninstallActionLabels, formatUninstallSlotResetPreview, planPluginUninstall, resolveUninstallChannelConfigKeys, UNINSTALL_ACTION_LABELS } = await import("./uninstall-Bfps3EM3.js");
	const { commitPluginInstallRecordsWithConfig } = await import("./plugins-install-record-commit-DjSAtU5O.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-CDLv4T_I.js");
	const { resolvePluginUninstallId } = await import("./plugins-uninstall-selection-AqMIlO11.js");
	const { PromptInputClosedError, promptYesNo } = await import("./prompt-s_dCUY4i.js");
