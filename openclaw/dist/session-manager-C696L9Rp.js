...
async function tryIncrementalSessionRepair(params) {
	...
	const repairedToolResults = insertMissingCodeModeToolResults(repairedEntries.entries, params.cached.toolResultIds);
	if (repairedToolResults.insertedToolResults > 0) return;
