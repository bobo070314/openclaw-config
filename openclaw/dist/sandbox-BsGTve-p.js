...
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-Bv-_-1Si.js";
import { c as DEFAULT_USER_FILENAME, d as ensureAgentWorkspace, i as DEFAULT_IDENTITY_FILENAME, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-KxGKSHoh.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT, w as SANDBOX_STATE_DIR, x as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, y as SANDBOX_BROWSER_IMAGE_CONTRACT_EPOCH } from "./constants-DZq6dV_0.js";
import { n as isToolAllowed } from "./tool-policy-ZbtvCHDi.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-G5Hy34Dh.js";
...
async function syncSandboxSkillsToWorkspace(params) {
	try {
		const [{ syncSkillsToWorkspace }, { getRemoteSkillEligibility }, { canExecRequestNode }] = await Promise.all([
			import("./workspace-aPPjHB_t.js"),
			import("./remote-BTzRL3Fg.js"),
			import("./exec-defaults-BHWfQL44.js")
		]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-CFGTMAFV.js")).maybePruneSandboxes(cfg);
