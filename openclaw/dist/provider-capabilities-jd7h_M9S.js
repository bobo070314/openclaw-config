...
import { n as isToolAllowed } from "./tool-policy-ZbtvCHDi.js";
import { M as getChannelAgentToolMeta, N as consumeAdjustedParamsForToolCall, P as consumePreExecutionBlockedToolCall, c as isToolWrappedWithBeforeToolCallHook, h as wrapToolWithBeforeToolCallHook, i as finalizeToolTerminalPresentation, m as setBeforeToolCallDiagnosticsEnabled, p as runBeforeToolCallHook } from "./agent-tools.before-tool-call-CDuA0_mC.js";
import { i as getPluginToolMeta } from "./tools-DWq4toVW.js";
import { t as callGatewayTool } from "./gateway-wg3rzLzQ.js";
import { t as runAgentHarnessAfterToolCallHook } from "./hook-helpers-CENBGDuz.js";
...
import "./sandbox-Bn8wTkoM.js";
import "./string-coerce-runtime-BtLK_KtO.js";
import { a as isMessagingToolSendAction, r as isMessagingTool } from "./embedded-agent-messaging-DrnnQY0n.js";
import { _ as sanitizeToolResult, c as extractMessagingToolSendResult, f as extractToolResultMediaArtifact, m as filterToolResultMediaUrls, s as extractMessagingToolSend, v as isToolResultError } from "./embedded-agent-message-tool-source-reply-BNDmht0w.js";
import { i as isReplaySafeToolCall } from "./tool-mutation-BioMabQh.js";
import { t as filterProviderNormalizableTools } from "./tool-schema-projection-C_uRkhtw.js";
import { n as normalizeAgentRuntimeTools } from "./tools-BjIlvREJ.js";
import { t as buildEmbeddedAttemptToolRunContext } from "./attempt.tool-run-context-DWNz4033.js";
import { t as createAgentToolResultMiddlewareRunner } from "./tool-result-middleware-DA6D7k8x.js";
...
import { c as createCodexAppServerToolResultExtensionRunner } from "./agent-harness-runtime-DmXrkZSs.js";
import { c as resolveNativeHookRelayDeferredToolApproval, n as hasNativeHookRelayInvocation, o as registerNativeHookRelay, r as invokeNativeHookRelay } from "./native-hook-relay-BqNuR7H8.js";
import { n as reviewExecRequestWithConfiguredModel, t as buildExecAutoReviewInputForShellCommand } from "./agent-harness-exec-review-runtime-BMlW7_NA.js";
import "./diagnostic-runtime-BCe2Aywp.js";
import { n as isJsonObject } from "./protocol-dh-ETiNd.js";
import { C as isForcedPrivateQaCodexRuntime, S as filterCodexDynamicTools, _ as resolveCodexWebSearchPlan, w as normalizeCodexDynamicToolName, x as sanitizeInlineImageDataUrl, y as invalidInlineImageText } from "./thread-lifecycle-CS3WckiY.js";
import { c as isTrustedCodexModelBackedOpenAIProvider, u as readCodexPluginConfig } from "./config-G1_5MZYv.js";
import { a as formatCodexDisplayText } from "./app-server-policy-rP3GCKtP.js";
import { u as releaseLeasedSharedCodexAppServerClient } from "./shared-client-CJxqB-20.js";
import { i as resolveCodexNativeExecutionPolicy } from "./sandbox-guard-BziMEgr0.js";
