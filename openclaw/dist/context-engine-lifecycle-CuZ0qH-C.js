...
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, l as setDetachedTaskDeliveryStatusByRunId, n as completeTaskRunByRunId, r as createQueuedTaskRun, u as startTaskRunByRunId } from "./detached-task-runtime-DHgH7X7j.js";
import { f as isGatewayDraining, i as enqueueCommandInLane, n as GatewayDrainingError } from "./command-queue-Cn3ZuyZZ.js";
import { n as OPENCLAW_EMBEDDED_CONTEXT_ENGINE_HOST } from "./host-compat-BibWlia2.js";
import { u as findActiveSessionTask } from "./openclaw-tools-B0V1p3La.js";
import { t as log$1 } from "./logger-Cc1RIqMU.js";
import { c as updateTaskNotifyPolicyForOwner, i as findTaskByRunIdForOwner, n as cancelTaskByIdForOwner } from "./task-owner-access-DPiyFkyk.js";
import { r as runAgentHarnessAgentEndHook, t as awaitAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-v00PVIlh.js";
import { n as rewriteTranscriptEntriesInSessionManager, t as rewriteTranscriptEntriesInRuntimeTranscript } from "./transcript-rewrite-D0zlAs7i.js";
import { m as resolveContextEngineCapabilities, n as buildAfterTurnRuntimeContextFromUsage, t as buildAfterTurnRuntimeContext } from "./attempt.prompt-helpers-Cuf8j_4K.js";
...
async function runCoreAgentEndSideEffects(params) {
	try {
		const { runSkillResearchAutoCapture } = await import("./autocapture-CgLNH45C.js");
