...
const providerIndexCatalogLoader = createLazyImportLoader(() => import("./list.provider-index-catalog-CPssD2oo.js"));
...
async function planAllModelListSources(params) {
	...
	const manifestCatalog = await import("./list.manifest-catalog-wu1o3jKz.js");
	...
	const providerCatalog = await import("./list.provider-catalog-CnmnvzSm.js");
