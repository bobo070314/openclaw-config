...
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-RiR4C_DO.js";
...
async function loadMatrixCreateClientDeps() {
	matrixCreateClientDepsPromise ??= import("./create-client-eSwdkHUw.js").then((runtime) => ({ createMatrixClient: runtime.createMatrixClient }));
