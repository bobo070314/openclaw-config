...
import { t as applyConfigEnvVars } from "./config-env-vars-CwiGXAPn.js";
...
import { a as readConfigIncludeFileWithGuards, s as resolveConfigIncludes } from "./includes-COgfUhyp.js";
...
import { a as isGatewayConnectAssemblyError, n as GatewayClient, u as loadDeviceAuthToken } from "./client-3vtaGf-F.js";
import { r as loadOrCreateDeviceIdentity } from "./device-identity-S-9fx48D.js";
import { t as loadGatewayTlsRuntime } from "./gateway-DJBMYd11.js";
...
import { n as resolveGatewayCredentialsWithSecretInputs } from "./credentials-secret-inputs-GwS18g8L.js";
import { t as canSkipGatewayConfigLoad } from "./explicit-connection-policy-B80Vt5Ya.js";
...
async function readGatewayDispatchConfigWithShellEnvFallback(options = {}) {
	...
	const { loadShellEnvFallback, resolveShellEnvFallbackTimeoutMs, shouldDeferShellEnvFallback, shouldEnableShellEnvFallback } = await import("./shell-env-D9AOJTAH.js");
...
const defaultGetRuntimeConfig = async () => (await import("./io-t6re4Xxv.js")).getRuntimeConfig();
