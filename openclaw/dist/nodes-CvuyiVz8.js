...
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-DwgJv42r.js";
...
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo } from "./remote-DJcAMeUJ.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-CQtFV9Fn.js";
import { a as normalizeDeclaredNodeCommands, n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-i3oM6xGs.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-CmLaCjBA.js";
import { a as getPairedDevice, c as listApprovedPairedDeviceRoles, l as listDevicePairing, p as removePairedDeviceRole } from "./device-pairing-C4Uu7tKB.js";
import { i as buildSystemRunApprovalBinding, l as toSystemRunApprovalMismatchError, o as matchSystemRunApprovalBinding, r as resolveSystemRunCommandRequest, s as missingSystemRunApprovalBinding } from "./system-run-command-BV01c3oL.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-CE95ko20.js";
import { c as sendApnsBackgroundWake, d as shouldClearStoredApnsRegistration, f as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as resolveApnsAuthConfigFromEnv, s as sendApnsAlert, t as clearApnsRegistrationIfCurrent } from "./push-apns-ConYkF8S.js";
...
import { n as getKnownNode, r as listKnownNodes, t as createKnownNodeCatalog } from "./node-catalog-B0CAQw0U.js";
import { u as resolveApprovalRequestRecipientConnIds } from "./approval-shared-CvJTjR4a.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DMlOWbJt.js");
