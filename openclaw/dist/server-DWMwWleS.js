...
import { m as resolveUserPath, s as ensureDir } from "./utils-BmpsSbZo.js";
...
import { a as isA2uiPath, i as injectCanvasLiveReload, n as CANVAS_HOST_PATH } from "./a2ui-shared-BjqQ2tdx.js";
import { n as normalizeUrlPath, r as resolveFileWithinRoot } from "./a2ui-qejh76JF.js";
	...
	const server = http.createServer((req, res) => {
		...
		(async () => {
			if (req.url && isA2uiPath(new URL(req.url, "http://localhost").pathname)) {
				const { handleA2uiHttpRequest } = await import("./a2ui-pWyxCcLY.js");
