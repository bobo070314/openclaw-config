...
import { g as resolveSecretInputRef } from "./types.secrets-BHLVnd7g.js";
import { t as createSubsystemLogger } from "./subsystem-BTVUlTIB.js";
import { a as resolveSecretRefValue } from "./resolve-BVr8MotQ.js";
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-CvH_tnL6.js";
import { t as assertExpectedResolvedSecretValue } from "./secret-value-D1M8xevB.js";
import { r as createResolverContext } from "./runtime-shared-DkOcw6V4.js";
import { i as setPathExistingStrict, n as getPath } from "./path-utils-BMoAjY_I.js";
import { r as discoverConfigSecretTargetsByIds } from "./target-registry-BEVFToEa.js";
...
import { t as resolveChannelApprovalAdapter } from "./plugins-Ys7IxLOo.js";
...
import { i as getActiveSecretsRuntimeEnv, o as getActiveSecretsRuntimeSnapshot } from "./runtime-state-C7vELydH.js";
import { n as collectCommandSecretAssignmentsFromSnapshot, t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-Cepfo234.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-C3vkB0Qx.js";
import { t as resolveRuntimeWebTools } from "./runtime-web-tools-CbAVZRHJ.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-2L3i0Aha.js";
import { d as formatExecApprovalExpiresIn } from "./exec-approval-reply-BtzijiyX.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-32Mdz-D1.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-DDsiklz_.js";
import { l as listDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-C4Uu7tKB.js";
import { a as diffConfigPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-BEGf5Kr-.js";
import { d as shouldClearStoredApnsRegistration, f as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalAlert, o as resolveApnsAuthConfigFromEnv, r as loadApnsRegistrations, t as clearApnsRegistrationIfCurrent, u as sendApnsExecApprovalResolvedWake } from "./push-apns-ConYkF8S.js";
...
async function activateSecretsRuntimeSnapshot(snapshot) {
	(await import("./runtime-RzoK3Wbh.js")).activateSecretsRuntimeSnapshot(snapshot);
}
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-C5X-K_oG.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-BAnuKPqx.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-CgZXoeod.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
