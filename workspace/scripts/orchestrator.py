...
from meta_agent import evolve_hardcases
...
def main():
    ...
    # Step 4: Self-evolution — system learns from its own eval
    print("\n[STEP 4/4] Meta-agent evolution...")
    evolved = evolve_hardcases()
    if evolved:
        print("  ✅ New hardcase injected. System now slightly smarter.")
    else:
        print("  ⏭️  No evolution needed.")
